 ...
 * and must belong to a Survey.
 * 
 *
 * @hibernate.class table="tl_lasurv11_attachment"
 *
 */
public class SurveyAttachment implements Cloneable{
	private static final Logger log = Logger.getLogger(SurveyAttachment.class);
...
//  **********************************************************
    public Object clone(){
		...
		try {
			obj = super.clone();
			((SurveyAttachment)obj).setUid(null);
		} catch (CloneNotSupportedException e) {
			log.error("When clone " + SurveyAttachment.class + " failed");
		}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof SurveyAttachment))
			return false;

		final SurveyAttachment genericEntity = (SurveyAttachment) o;
