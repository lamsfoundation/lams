...
public class SurveySessionDAOHibernate extends LAMSBaseDAO implements SurveySessionDAO {
    ...
    private static final String FIND_BY_SESSION_ID = "from " + SurveySession.class.getName()
	    + " as p where p.sessionId=?";
    private static final String FIND_BY_CONTENT_ID = "from " + SurveySession.class.getName()
	    + " as p where p.survey.contentId=?";
