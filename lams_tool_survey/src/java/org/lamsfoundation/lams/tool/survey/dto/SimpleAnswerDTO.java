...
public class SimpleAnswerDTO extends SurveyQuestion {
    ...
    private static Logger logger = Logger.getLogger(SimpleAnswerDTO.class.getName());

    public SimpleAnswerDTO(SurveyQuestion question) {
	try {
