...
<lams:head>
	...
	<script type="text/javascript">
		...
		function deleteAttachment(uuid) {
			document.WikiAuthoringForm.method.value = 'deleteAttachment';
			document.WikiAuthoringForm.deleteFileUuid.value = uuid;
			document.WikiAuthoringForm.submit();
		}        
		
		function doUpload() {
			document.WikiAuthoringForm.method.value = 'upload';
			document.WikiAuthoringForm.submit();
		}        
     </script>
</lams:head>
	...
	<div id="page">
		<html:form action="/authoring" styleId="authoringForm" target="_self"
			...
			<div id="content">
				...
				<lams:help toolSignature="<%=WikiConstants.TOOL_SIGNATURE%>"
					module="authoring" />
				<!--  Set up tabs  -->
				...
				<lams:AuthoringButton formID="authoringForm"
					...
					contentFolderID="${WikiAuthoringForm.contentFolderID}" />
			</div>
			<div id="footer" />
		</html:form>
	</div>
