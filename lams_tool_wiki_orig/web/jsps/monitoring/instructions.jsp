...
<table cellpadding="0">
	...
	<tr>
		...
		<td>
			<c:out value="${wikiBean.wiki.onlineInstructions}" escapeXml="false" />
		</td>
	</tr>
	<tr>
		<td colspan="2">
			<div id="onlinefile">
				<ul>
					<c:forEach var="file" items="${wikiBean.onlineFileList}">
						<li>
	...
	<tr>
		...
		<td>
			<c:out value="${wikiBean.wiki.offlineInstructions}" escapeXml="false" />
		</td>
	</tr>
	<tr>
		<td colspan="2">
			<div id="offlinefile">
				<ul>
					<c:forEach var="file" items="${wikiBean.offlineFileList}">
						<li>
							<c:out value="${file.fileName}" />
							<c:set var="viewURL">
								<html:rewrite page="/download/?uuid=${file.fileUuid}&preferDownload=false" />
