alter table tl_lawiki10_attachment drop foreign key FK_NEW_1983840333_389AD9A2FE939F2A;
alter table tl_lawiki10_attachment drop foreign key FK_NEW_1983840333_389AD9A2131CE31E;
alter table tl_lawiki10_wiki drop foreign key FK_NEW_1983840333_87917942E42F4351;
alter table tl_lawiki10_wiki_user drop foreign key FK_NEW_1983840333_7B83A4A85F0116B6;
alter table tl_lawiki10_message drop foreign key FK_NEW_1983840333_4A6067E89357B45B;
alter table tl_lawiki10_message drop foreign key FK_NEW_1983840333_4A6067E897F0DB46;
alter table tl_lawiki10_message drop foreign key FK_NEW_1983840333_4A6067E8E42F4351;
alter table tl_lawiki10_message drop foreign key FK_NEW_1983840333_4A6067E8131CE31E;
alter table tl_lawiki10_message drop foreign key FK_NEW_1983840333_4A6067E8647A7264;
alter table tl_lawiki10_message drop foreign key FK_NEW_1983840333_4A6067E824089E4D;
alter table tl_lawiki10_message_seq drop foreign key FK_NEW_1983840333_D2C71F88FE939F2A;
alter table tl_lawiki10_message_seq drop foreign key FK_NEW_1983840333_D2C71F8845213B4D;
alter table tl_lawiki10_tool_session drop foreign key FK_NEW_1983840333_5A04D7AE131CE31E;
...
create table tl_lawiki10_report (uid bigint not null auto_increment, comment text, release_date datetime, mark float, primary key (uid));
create table tl_lawiki10_tool_session (uid bigint not null auto_increment, version integer not null, session_end_date datetime, session_start_date datetime, status integer, wiki_uid bigint, session_id bigint, session_name varchar(250), mark_released bit, primary key (uid));
