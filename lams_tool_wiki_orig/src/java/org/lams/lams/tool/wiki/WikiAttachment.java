...
/**
 * <p>This class represents a file that is uploaded to the wiki tool.
 ...
 * tl_lawiki10_attachment table. The file uploaded, will be of two types: online or offline.
 * </p>
 * @hibernate.class table="tl_lawiki10_attachment"
 * @author mtruong
 */
public class WikiAttachment implements Serializable, Cloneable {
	...
	private static Logger log = Logger.getLogger(WikiAttachment.class);
    ...
    /** minimal constructor */
    public WikiAttachment(WikiContent wikiContent,
            					 String filename,
            					 boolean isOnline)
    {
    ...
    public Object clone(){
		...
		try {
			...
			log.error("Clone " + WikiAttachment.class + " not supported");
		}
		return obj;
	}    
     ...
     * 
     * @hibernate.column 
     * 		name="wiki_content_uid"
     * 
     * @return Returns the wikiContent.
     */
    ...
    /** Are two WikiAttachments equal? Checks attachmentId, filename,
     * uuid, version id and online/offline status. Does not check the related
     * content object.
     */
    public boolean equals(Object other) {
        if ( (this == other ) ) return true;
        if ( !(other instanceof WikiAttachment) ) return false;
        WikiAttachment castOther = (WikiAttachment) other;
