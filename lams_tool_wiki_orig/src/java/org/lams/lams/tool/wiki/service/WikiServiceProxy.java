...
public class WikiServiceProxy {
	...
	private static Object getWikiDomainService(ServletContext servletContext)
	{
	 ...
	 /*
     * Return the wiki version of tool session manager implementation. 
    ...
    /*
     * Return the wiki version of tool content manager implementation. 
     * It will delegate to the Spring helper method to retrieve the proper 
     * bean from Spring bean factory.
     * @param servletContext the servletContext for current application
     * @return wiki service object. */
