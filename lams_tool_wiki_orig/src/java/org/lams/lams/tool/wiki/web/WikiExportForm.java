 ...
 * ----------------XDoclet Tags--------------------
 * 
 * @struts:form name="WikiExportForm" type="org.lams.lams.tool.wiki.web.WikiExportForm"
 *
 * ----------------XDoclet Tags--------------------
 */

public class WikiExportForm extends ActionForm {
    ...
    public void populateForm(WikiContent content)
    {
