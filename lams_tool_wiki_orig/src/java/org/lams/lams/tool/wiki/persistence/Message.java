 ...
 * @author conradb
 *
 * @hibernate.class table="tl_lawiki10_message"
 *
 */
public class Message implements Cloneable{
	...
	private WikiToolSession toolSession;
	private Wiki wiki;
	private WikiUser createdBy;
	private WikiUser modifiedBy;
	private Set attachments;
	private WikiReport report;
...
//  **********************************************************
	public static Message newInstance(Message fromMsg,WikiToolContentHandler toolContentHandler){
	...
	/**
	 * <em>This method DOES NOT deep clone <code>Wiki</code> to avoid dead loop in clone.</em>
	 */
  	public Object clone(){
  		...
  		try{
  			...
  			//don't  deep clone wiki to avoid dead loop in clone
//  			if(parent != null){
...
//  			}
//  			if(toolSession != null){
//  				msg.toolSession = (WikiToolSession) toolSession.clone();
//  			}
//  			if(createdBy != null){
//  				msg.createdBy = (WikiUser) createdBy.clone();
//  			}
//  			if(modifiedBy != null)
//  				msg.modifiedBy = (WikiUser) modifiedBy.clone();
  			//clone attachment
  			if(attachments != null){
...
//  **********************************************************
     ...
     */
    public void setModifiedBy(WikiUser modifiedBy) {
    ...
    /**
      ...
      *	class="org.lams.lams.tool.wiki.persistence.WikiToolSession"
      *	              column="wiki_session_uid"
      *
      */
     public WikiToolSession getToolSession() {
         return toolSession;
     }
     ...
     */
    public void setToolSession(WikiToolSession session) {
     ...
     * 			class="org.lams.lams.tool.wiki.persistence.Attachment"
     *
     */
	 ...
	 * @return
	 */
	public WikiReport getReport() {
		return report;
	}
	public void setReport(WikiReport report) {
		this.report = report;
	}
     ...
     * @hibernate.collection-one-to-many class="org.lams.lams.tool.wiki.persistence.Message"
     *
     */
