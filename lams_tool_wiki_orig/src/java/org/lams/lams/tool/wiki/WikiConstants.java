...
public class WikiConstants
{
    ...
    public final static String TOOL_SIGNATURE="lawiki10";
    ...
    // ---------------------------------------------------------------------------
    // Lookup Dispatch Action Keys (used in WikiAuthoringAction class, WikiLearnerAction),
