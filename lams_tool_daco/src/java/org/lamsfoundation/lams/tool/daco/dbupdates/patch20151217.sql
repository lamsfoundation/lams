...
ALTER IGNORE TABLE tl_ladaco10_answer_options DROP FOREIGN KEY tl_ladaco10_answer_options_ibfk_1;
...
ALTER IGNORE TABLE tl_ladaco10_contents DROP FOREIGN KEY DacoToUser;
...
ALTER IGNORE TABLE tl_ladaco10_questions DROP FOREIGN KEY QuestionToDaco;
...
ALTER IGNORE TABLE tl_ladaco10_questions DROP FOREIGN KEY QuestionToUser;
...
ALTER IGNORE TABLE tl_ladaco10_questions DROP FOREIGN KEY tl_ladaco10_questions_ibfk_1;
...
ALTER IGNORE TABLE tl_ladaco10_sessions DROP FOREIGN KEY SessionToDaco;
ALTER TABLE tl_ladaco10_sessions ADD CONSTRAINT SessionToDaco FOREIGN KEY (`content_uid`)
REFERENCES `tl_ladaco10_contents` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_ladaco10_users DROP FOREIGN KEY UserToSession;
ALTER TABLE tl_ladaco10_users ADD CONSTRAINT UserToSession FOREIGN KEY (`session_uid`)
REFERENCES `tl_ladaco10_sessions` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;
							  

ALTER IGNORE TABLE tl_ladaco10_answers DROP FOREIGN KEY AnswerToUser;
ALTER TABLE tl_ladaco10_answers ADD CONSTRAINT AnswerToUser FOREIGN KEY (`user_uid`)
REFERENCES `tl_ladaco10_users` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_ladaco10_answers DROP FOREIGN KEY AnswerToQuestion;
