...
//    protected String saveOrUpdateRecord(@ModelAttribute("recordForm")RecordForm recordForm , HttpServletRequest request) {
//	String sessionMapID = request.getParameter(DacoConstants.ATTR_SESSION_MAP_ID);
//	SessionMap sessionMap = (SessionMap) request.getSession().getAttribute(sessionMapID);
...
//	if (!errorMap.isEmpty()) {
//	    this.addErrors(request, errorMap);
...
//	    errorMap.add("GLOBAL", messageService.getMessage(DacoConstants.ERROR_MSG_RECORD_NOTENOUGH, new Object[] {daco.getMinRecords()}));
//	}
//	return errorMap;
//    }
//
...
//    }
//
//    protected MultiValueMap<String, String> validateRecordForm(Daco daco, RecordForm recordForm, Set<DacoQuestion> questionList,
//	    int recordCount) {
//	MultiValueMap<String, String> errorMap = new LinkedMultiValueMap<>();
//	Short maxRecords = daco.getMaxRecords();
//	if (maxRecords != null && maxRecords > 0 && recordCount > maxRecords) {
//	    errorMap.add("GLOBAL",
//		    messageService.getMessage(DacoConstants.ERROR_MSG_RECORD_TOOMUCH, new Object[] {daco.getMaxRecords()}));
//	}
//
//	Iterator<DacoQuestion> questionIterator = questionList.iterator();
//	DacoQuestion question = null;
...
//			errorMap.add("GLOBAL",
//				    messageService.getMessage(DacoConstants.ERROR_MSG_RECORD_BLANK, new Object[] {questionNumber}));
//
//		    }
//		    answerNumber++;
//		    break;
...
//			if (words > max) {
//			    errorMap.add("GLOBAL",
//				    messageService.getMessage(DacoConstants.ERROR_MSG_RECORD_TEXTAREA_LONG, new Object[] {questionNumber, max}));
//			}
//		    }
//		}
//		    answerNumber++;
...
//					DacoConstants.ERROR_MSG_RECORD_NUMBER_MIN, new Object[] {questionNumber, min}));
//			    } else if (max != null && number > max) {
//				errorMap.add("GLOBAL",
//					    messageService.getMessage(
//					DacoConstants.ERROR_MSG_RECORD_NUMBER_MAX, new Object[] {questionNumber, max}));
//			    }
//			} catch (NumberFormatException e) {
//			    errorMap.add("GLOBAL",
//				    messageService.getMessage(DacoConstants.ERROR_MSG_RECORD_NUMBER_FLOAT, new Object[] {questionNumber}));
//			}
//		    }
//		}
//		    answerNumber++;
...
//			    errorMap.add("GLOBAL",
//				    messageService.getMessage(DacoConstants.ERROR_MSG_RECORD_DATE_YEAR_BLANK, new Object[] {questionNumber}));
//			} else {
//			    try {
...
//			    errorMap.add("GLOBAL",
//				    messageService.getMessage(DacoConstants.ERROR_MSG_RECORD_DATE_MONTH_BLANK, new Object[] {questionNumber}));
//			} else {
//			    try {
...
//				    errorMap.add("GLOBAL",
//					    messageService.getMessage(
//					    DacoConstants.ERROR_MSG_RECORD_DATE_MONTH_LIMIT, new Object[] {questionNumber}));
//				} else {
//				    monthValid = true;
//				}
//			    } catch (NumberFormatException e) {
//				errorMap.add("GLOBAL",
//					    messageService.getMessage(
//					DacoConstants.ERROR_MSG_RECORD_DATE_MONTH_INT, new Object[] {questionNumber}));
//			    }
//			}
//
//			if (StringUtils.isBlank(day)) {
//			    errorMap.add("GLOBAL",
//				    messageService.getMessage(DacoConstants.ERROR_MSG_RECORD_DATE_DAY_BLANK, new Object[] {questionNumber}));
//			} else if (monthValid) {
//			    try {
//
...
//				    errorMap.add("GLOBAL",
//					    messageService.getMessage(
//					    DacoConstants.ERROR_MSG_RECORD_DATE_DAY_LIMIT, new Object[] {questionNumber, maxDays}));
//				}
//			    } catch (NumberFormatException e) {
//				errorMap.add("GLOBAL",
//					    messageService.getMessage(DacoConstants.ERROR_MSG_RECORD_DATE_DAY_INT, new Object[] {questionNumber}));
//			    }
//			}
//		    }
//		}
...
//			if (question.isRequired()) {
//			    errorMap.add(ActionMessages.GLOBAL_MESSAGE,
...
//			} else {
//			    FileValidatorUtil.validateFileSize(file, true, errorMap);
//			}
//		    }
//		    fileNumber++;
//		}
...
//			    errorMap.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage(
