...
<html:form action="/authoring/saveOrUpdateQuestion" method="post" styleId="dacoQuestionForm">
	...
	<h2 class="no-space-left"><fmt:message key="label.authoring.basic.textfield" /></h2>
	<div><fmt:message key="label.authoring.basic.textfield.help" /></div>
	...
	<div class="field-name"><fmt:message key="label.authoring.basic.max.char" /></div>
...
<lams:ImgButtonWrapper>
	<a href="#" onclick="javascript:submitDacoQuestion()" class="button-add-item"><fmt:message
		key="label.authoring.basic.textfield.add" /> </a>
