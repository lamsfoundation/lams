...
<html:form action="/authoring/saveOrUpdateQuestion" method="post" styleId="dacoQuestionForm">
	...
	<h2 class="no-space-left"><fmt:message key="label.authoring.basic.textarea" /></h2>
<div><fmt:message key="label.authoring.basic.textarea.help" /></div>
	
	<div class="field-name space-top"><fmt:message key="label.authoring.basic.description" /></div>

	<c:set var="formBean" value="<%=request.getAttribute(org.apache.struts.taglib.html.Constants.BEAN_KEY)%>" />
	<c:set var="sessionMap" value="${sessionScope[formBean.sessionMapID]}" />
	<lams:FCKEditor id="description" value="${formBean.description}"
	...
	<div class="space-bottom-top"><a id="toggleAdditionalOptionsAreaLink" href="javascript:toggleAdditionalOptionsArea()"><fmt:message
		key="label.authoring.basic.additionaloptions.show" /> </a><br /></div>

	<div id="additionalOptionsArea" style="display:none;">

	<div class="field-name"><fmt:message key="label.authoring.basic.max.word" /></div>
	<html:text styleId="max" property="max" size="10" />
	<div class="space-top">
	<html:checkbox property="questionRequired" styleId="questionRequired"
		styleClass="noBorder">
