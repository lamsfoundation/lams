 ...
 * 
 * @hibernate.class table="tl_labbb10_attachment"
 * 
 */

public class BbbAttachment implements java.io.Serializable, Cloneable {

    private static final long serialVersionUID = 47452859888067500L;

    private static final Logger logger = Logger.getLogger(BbbAttachment.class);
    ...
    public BbbAttachment() {

    }

    public BbbAttachment(Long fileVersionId, String fileType, String fileName, Long fileUuid, Date createDate) {
    ...
    /**
     * @hibernate.many-to-one not-null="true" foreign-key="fk_labbb10_bbb_attachment_to_bbb"
	...
	if (this == o)
	    return true;
	if (!(o instanceof BbbAttachment))
	    return false;

	final BbbAttachment genericEntity = (BbbAttachment) o;
	...
	try {
	    obj = super.clone();
	    ((BbbAttachment) obj).setUid(null);
	} catch (CloneNotSupportedException e) {
	    logger.error("Failed to clone " + BbbAttachment.class);
	}
