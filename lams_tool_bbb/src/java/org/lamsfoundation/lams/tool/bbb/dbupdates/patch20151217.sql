...
ALTER IGNORE TABLE tl_labbb10_session DROP FOREIGN KEY fk_labbb10_bbb_session_to_bbb;
...
ALTER IGNORE TABLE tl_labbb10_user DROP FOREIGN KEY fk_labbb10_bbb_user_to_bbb_session;
