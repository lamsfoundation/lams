...
<html>
	<lams:head>
		<title><c:out value="${dimdimDTO.title}" escapeXml="false" />
		</title>
	...
	<body class="stripes">
			...
			<h1>
				<c:out value="${dimdimDTO.title}" escapeXml="false" />
			</h1>

				<p>
					<c:out value="${dimdimDTO.instructions}" escapeXml="false" />
				</p>

				<c:if test='${mode == "teacher"}'>
					<div id="sessionContents">
						<ul>
							<c:forEach var="session" items="${dimdimDTO.sessionDTOs}">
								<li>
