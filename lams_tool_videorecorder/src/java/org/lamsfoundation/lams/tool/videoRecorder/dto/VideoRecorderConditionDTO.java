...
public class VideoRecorderConditionDTO extends TextSearchConditionDTO {
    public VideoRecorderConditionDTO(TextSearchCondition condition, Integer toolActivityUIID) {
	super(condition, toolActivityUIID);
    }

    @Override
    public VideoRecorderCondition getCondition() {
	return new VideoRecorderCondition(this);
    }
}
