...
public class AuthoringAction extends LamsDispatchAction {
	...
	ToolSessionManager toolSessionManager = VideoRecorderServiceProxy
		.getVideoRecorderSessionManager(this.getServlet().getServletContext());
	...
	VideoRecorder videoRecorder = videoRecorderService
		.getVideoRecorderByContentId((Long) map.get(AuthoringAction.KEY_TOOL_CONTENT_ID));
     ...
     * @param mode
     */
    private SessionMap<String, Object> createSessionMap(VideoRecorder videoRecorder, ToolAccessMode mode,
	    String contentFolderID, Long toolContentID) {
	...
	SortedSet<VideoRecorderCondition> set = new TreeSet<VideoRecorderCondition>(
