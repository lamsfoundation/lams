...
ALTER TABLE tl_lavidr10_session DROP FOREIGN KEY FK_NEW_75587508_B7C198E2FC940906;
...
ALTER TABLE tl_lavidr10_user DROP FOREIGN KEY FK_NEW_75587508_CB8A58FFA3B0FADF;
