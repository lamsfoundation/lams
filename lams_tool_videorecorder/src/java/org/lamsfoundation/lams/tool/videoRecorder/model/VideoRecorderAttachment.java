 ...
 * 
 * @hibernate.class table="tl_lavidr10_attachment"
 * 
 */

public class VideoRecorderAttachment implements java.io.Serializable, Cloneable {
	...
	private static final Logger log = Logger.getLogger(VideoRecorderAttachment.class);
	...
	/** default constructor */
	public VideoRecorderAttachment() {
	}

	/** Constructor setting up all the properties except for videoRecorder one*/
	public VideoRecorderAttachment(Long fileVersionId, String fileType, String fileName,	Long fileUuid, Date createDate) {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof VideoRecorderAttachment))
			return false;

		final VideoRecorderAttachment genericEntity = (VideoRecorderAttachment) o;
	...
	public Object clone() {
		...
		try {
			obj = super.clone();
			((VideoRecorderAttachment) obj).setUid(null);
		} catch (CloneNotSupportedException e) {
			log.error("Failed to clone " + VideoRecorderAttachment.class);
		}
