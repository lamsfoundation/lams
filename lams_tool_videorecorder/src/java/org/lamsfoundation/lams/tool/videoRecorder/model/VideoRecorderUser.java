 ...
 *
 * @hibernate.class table="tl_lavidr10_user"
 */

public class VideoRecorderUser implements java.io.Serializable {
    ...
    /** default constructor */
    public VideoRecorderUser() {
    }

    public VideoRecorderUser(UserDTO user, VideoRecorderSession videoRecorderSession) {
    ...
    /** full constructor */
    public VideoRecorderUser(Long userId, String lastName, String firstName,
     ...
     * @hibernate.column name="videoRecorder_session_uid"
     * 
     */
	...
	if (!(other instanceof VideoRecorderUser)) {
	    return false;
	}
	VideoRecorderUser castOther = (VideoRecorderUser) other;
