...
/**
 * DAO for accessing the VideoRecorder objects - interface defining methods to be implemented by the Hibernate or other
 * implementation.
 */
public interface IVideoRecorderDAO extends IBaseDAO {

    VideoRecorder getByContentId(Long toolContentId);
