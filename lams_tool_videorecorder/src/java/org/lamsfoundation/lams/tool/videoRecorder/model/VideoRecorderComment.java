...
public class VideoRecorderComment implements java.io.Serializable {
	...
	/** full constructor */
	public VideoRecorderComment(String text, VideoRecorderRecording recording, VideoRecorderUser createBy, Date createDate, VideoRecorderSession videoRecorderSession) {
