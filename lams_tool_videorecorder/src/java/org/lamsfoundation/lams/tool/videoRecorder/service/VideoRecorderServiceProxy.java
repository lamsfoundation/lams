...
public class VideoRecorderServiceProxy {
	...
	return (IVideoRecorderService) VideoRecorderServiceProxy.getVideoRecorderDomainService(servletContext);
    }

    private static Object getVideoRecorderDomainService(ServletContext servletContext) {
	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(servletContext);
	return wac.getBean("videoRecorderService");
    }

    /*
     * Return the videoRecorder tool version of tool session manager implementation.
	...
	return (ToolSessionManager) VideoRecorderServiceProxy.getVideoRecorderDomainService(servletContext);
    }

    /*
     * Return the videoRecorder tool version of tool content manager implementation.
     * It will delegate to the Spring helper method to retrieve the proper
     * bean from Spring bean factory.
     * 
     * @param servletContext the servletContext for current application
	...
	return (ToolContentManager) VideoRecorderServiceProxy.getVideoRecorderDomainService(servletContext);
    }
