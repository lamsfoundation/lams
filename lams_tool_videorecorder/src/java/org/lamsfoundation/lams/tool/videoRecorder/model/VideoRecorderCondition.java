...
public class VideoRecorderCondition extends TextSearchCondition {
    ...
    public VideoRecorderCondition(Long conditionId, Integer conditionUIID, Integer orderId, String name, String displayName,
    ...
    @Override
    public Object clone() {
	return new VideoRecorderCondition(null, null, orderId, name, displayName, allWords, phrase, anyWords, excludedWords);
    }
	...
	return new VideoRecorderCondition(null, newConditionUIID, orderId, name, displayName, allWords, phrase, anyWords,
		excludedWords);
    }
