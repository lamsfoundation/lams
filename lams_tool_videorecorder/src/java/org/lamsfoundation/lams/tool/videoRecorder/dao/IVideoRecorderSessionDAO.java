...
/**
 * DAO for accessing the VideoRecorderSession objects - interface defining
...
public interface IVideoRecorderSessionDAO extends IBaseDAO {
    ...
    void saveOrUpdate(VideoRecorderSession session);

    VideoRecorderSession getBySessionId(Long toolSessionId);
