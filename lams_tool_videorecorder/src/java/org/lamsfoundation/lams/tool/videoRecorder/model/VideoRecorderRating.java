...
public class VideoRecorderRating implements java.io.Serializable {
	...
	/** full constructor */
	public VideoRecorderRating(float rating, VideoRecorderRecording recording, VideoRecorderUser createBy, Date createDate, VideoRecorderSession videoRecorderSession) {
