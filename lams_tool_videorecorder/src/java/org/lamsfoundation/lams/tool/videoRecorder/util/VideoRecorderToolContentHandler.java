 ...
 */
public class VideoRecorderToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "videoRecorderworkspace";

    public static String repositoryUser = "videoRecorder";
     ...
     * 
     */
    public VideoRecorderToolContentHandler() {
	super();
    }
