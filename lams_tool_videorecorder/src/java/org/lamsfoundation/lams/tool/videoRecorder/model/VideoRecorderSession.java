...
public class VideoRecorderSession implements java.io.Serializable {
    ...
    /** full constructor */
    public VideoRecorderSession(Date sessionEndDate, Date sessionStartDate, Integer status, Long sessionId,
	    String sessionName, String contentFolderId, VideoRecorder videoRecorder, Set videoRecorderUsers) {
