...
<%@ page import="org.lamsfoundation.lams.tool.videoRecorder.util.VideoRecorderConstants"%>
...
<div id="header">
	...
	<script type="text/javascript">
		var initialTabId = "${videoRecorderDTO.currentTab}";
	</script>
</div>

<div id="content">
	<lams:help toolSignature="<%= VideoRecorderConstants.TOOL_SIGNATURE %>" module="monitoring"/>
