		...
		<div class="form-group roffset10 loffset10">
			...
			<c:if test="${hasRatingLimits}">
				<div>
					...
					<select property="${formContentPrefix}minimumRates" idd="minimum-rates" onmouseup="validateRatingLimits(true);" 
					...
					<select property="${formContentPrefix}maximumRates" idd="maximum-rates" onmouseup="validateRatingLimits(false);" 
							class="form-control form-control-inline">
						<option value="0">
