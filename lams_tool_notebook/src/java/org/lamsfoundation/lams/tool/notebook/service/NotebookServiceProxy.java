...
public class NotebookServiceProxy {
	...
	return (INotebookService) NotebookServiceProxy.getNotebookDomainService(servletContext);
    }
    ...
    /*
     * Return the notebook tool version of tool session manager implementation.
	...
	return (ToolSessionManager) NotebookServiceProxy.getNotebookDomainService(servletContext);
    }

    /*
     * Return the notebook tool version of tool content manager implementation.
     * It will delegate to the Spring helper method to retrieve the proper
     * bean from Spring bean factory.
     * 
     * @param servletContext the servletContext for current application
	...
	return (ToolContentManager) NotebookServiceProxy.getNotebookDomainService(servletContext);
    }
