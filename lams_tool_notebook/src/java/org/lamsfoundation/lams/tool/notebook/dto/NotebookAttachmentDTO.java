...
public class NotebookAttachmentDTO implements Comparable {

	public NotebookAttachmentDTO(NotebookAttachment att) {
	...
	public int compareTo(Object o) {
		NotebookAttachmentDTO toAttachment = (NotebookAttachmentDTO) o;
		int returnValue = this.createDate.compareTo(((NotebookAttachmentDTO) o)
				.getCreateDate());
