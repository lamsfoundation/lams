 ...
 */
public class NotebookToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "notebookworkspace";

    public static String repositoryUser = "notebook";
     ...
     * 
     */
    public NotebookToolContentHandler() {
	super();
    }
