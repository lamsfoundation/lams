 ...
 * 
 * @hibernate.class table="tl_lantbk11_attachment"
 * 
 */

public class NotebookAttachment implements java.io.Serializable, Cloneable {
	...
	private static final Logger log = Logger.getLogger(NotebookAttachment.class);
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof NotebookAttachment))
			return false;

		final NotebookAttachment genericEntity = (NotebookAttachment) o;
	...
	public Object clone() {
		...
		try {
			obj = super.clone();
			((NotebookAttachment) obj).setUid(null);
		} catch (CloneNotSupportedException e) {
			log.error("Failed to clone " + NotebookAttachment.class);
		}
