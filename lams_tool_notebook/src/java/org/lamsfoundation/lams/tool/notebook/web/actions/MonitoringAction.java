...
public class MonitoringAction extends LamsDispatchAction {
	...
	if ( sidx != null ) {
		...
		sorting = sord != null && sord.equals(NotebookConstants.ASC) ? NotebookConstants.SORT_BY_USERNAME_ASC : NotebookConstants.SORT_BY_USERNAME_DESC;
	    else if ( sidx.equals(NotebookConstants.PARAM_MODIFIED_DATE) ) 
		sorting = sord != null && sord.equals(NotebookConstants.ASC) ? NotebookConstants.SORT_BY_DATE_ASC : NotebookConstants.SORT_BY_DATE_DESC;
	    else if ( sidx.equals(NotebookConstants.PARAM_COMMENT_SORT) ) 
		sorting = sord != null && sord.equals(NotebookConstants.ASC) ? NotebookConstants.SORT_BY_COMMENT_ASC : NotebookConstants.SORT_BY_COMMENT_DESC;
	}
	...
	List<Object[]> users = notebookService.getUsersForTablesorter(toolSessionId, page > 0 ? page-1 : 0, size, sorting, searchString);
	...
	for (Object[] userAndReflection : users) {
	    ...
	    responseRow.put(NotebookConstants.PARAM_NAME, StringEscapeUtils.escapeHtml(user.getLastName() + " " + user.getFirstName()));
