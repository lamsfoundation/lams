alter table tl_lantbk11_attachment drop foreign key FK2464A040C50BB56A;
alter table tl_lantbk11_session drop foreign key FK447CD899C50BB56A;
alter table tl_lantbk11_user drop foreign key FKEA7B0CA888E2F833;
