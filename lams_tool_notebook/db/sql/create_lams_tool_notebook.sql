...
INSERT INTO tl_lantbk11_notebook (title,instructions,online_instructions,offline_instructions,tool_content_id,run_offline,lock_on_finished,content_in_use,define_later) 
VALUES("LAMS Notebook","Notebook Instruction","Online instructions","Offline instructions",${default_content_id},0,0,0,0);
