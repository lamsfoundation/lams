...
<body id="body">
	<lams:errors/>
	<form:form enctype="multipart/form-data" action="saveOrUpdatePedagogicalPlannerForm.do" modelAttribute="pedagogicalPlannerForm" id="pedagogicalPlannerForm" method="post">
				...
				<c:forEach var="itemIndex"  begin="1" end="${pedagogicalPlannerForm.itemCount}">
					<tr>
						<td>
							...
							<form:input id="title${itemIndex-1}" cssClass="item" size="90" path="title[${itemIndex-1}]"/>
							<c:choose>
