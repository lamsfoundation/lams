...
public class OAuthClient {
     ...
     *             the HTTP response status code was not 200 (OK)
     */
    public void getRequestToken(OAuthAccessor accessor, String httpMethod, Collection<? extends Map.Entry> parameters)
	    throws IOException, OAuthException, URISyntaxException {
	...
	OAuthMessage response = invoke(accessor, httpMethod, accessor.consumer.serviceProvider.requestTokenURL,
		parameters);
	...
	OAuthMessage response = invoke(accessor, httpMethod, accessor.consumer.serviceProvider.accessTokenURL,
		parameters);
	response.requireParameters(OAuth.OAUTH_TOKEN, OAuth.OAUTH_TOKEN_SECRET);
     ...
     *             the HTTP response status code was not 200 (OK)
     */
    public OAuthMessage invoke(OAuthAccessor accessor, String url, Collection<? extends Map.Entry> parameters)
	    throws IOException, OAuthException, URISyntaxException {
	...
	AUTHORIZATION_HEADER(net.oauth.ParameterStyle.AUTHORIZATION_HEADER), BODY(
		net.oauth.ParameterStyle.BODY), QUERY_STRING(net.oauth.ParameterStyle.QUERY_STRING);
