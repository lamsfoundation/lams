...
public abstract class OAuthSignatureMethod {
	...
	return OAuth.percentEncode(message.method.toUpperCase()) + '&'
		+ OAuth.percentEncode(OAuthSignatureMethod.normalizeUrl(url)) + '&'
		+ OAuth.percentEncode(OAuthSignatureMethod.normalizeParameters(parameters));
    }
	...
	OAuthSignatureMethod.registerMethodClass("HMAC-SHA1" + _ACCESSOR, HMAC_SHA1.class);
	OAuthSignatureMethod.registerMethodClass("PLAINTEXT" + _ACCESSOR, PLAINTEXT.class);
    }
