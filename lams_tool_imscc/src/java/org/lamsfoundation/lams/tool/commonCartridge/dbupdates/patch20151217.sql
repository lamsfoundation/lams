...
ALTER IGNORE TABLE tl_laimsc11_commoncartridge DROP FOREIGN KEY FK_NEW_1279208528_89093BF758092FB;
...
ALTER IGNORE TABLE tl_laimsc11_commoncartridge_item DROP FOREIGN KEY FK_NEW_1279208528_F52D1F9330E79035;
...
ALTER IGNORE TABLE tl_laimsc11_commoncartridge_item DROP FOREIGN KEY FK_NEW_1279208528_F52D1F93758092FB;
ALTER TABLE tl_laimsc11_commoncartridge_item ADD CONSTRAINT FK_NEW_1279208528_F52D1F93758092FB FOREIGN KEY (`create_by`)
REFERENCES `tl_laimsc11_user` (`uid`) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_laimsc11_commoncartridge_item DROP FOREIGN KEY FK_NEW_1279208528_F52D1F93EC0D3147;
...
ALTER IGNORE TABLE tl_laimsc11_item_instruction DROP FOREIGN KEY FK_NEW_1279208528_A5665013980570ED;
...
ALTER IGNORE TABLE tl_laimsc11_item_log DROP FOREIGN KEY FK_NEW_1279208528_693580A438BF8DFE;
ALTER TABLE tl_laimsc11_item_log ADD CONSTRAINT FK_NEW_1279208528_693580A438BF8DFE FOREIGN KEY (`commonCartridge_item_uid`)
REFERENCES `tl_laimsc11_commoncartridge_item` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_laimsc11_item_log DROP FOREIGN KEY FK_NEW_1279208528_693580A441F9365D;
...
ALTER IGNORE TABLE tl_laimsc11_session DROP FOREIGN KEY FK_NEW_1279208528_24AA78C530E79035;
ALTER TABLE tl_laimsc11_session ADD CONSTRAINT FK_NEW_1279208528_24AA78C530E79035 FOREIGN KEY (`commonCartridge_uid`)
REFERENCES `tl_laimsc11_commoncartridge` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_laimsc11_user DROP FOREIGN KEY FK_NEW_1279208528_30113BFCEC0D3147;
ALTER TABLE tl_laimsc11_user ADD CONSTRAINT FK_NEW_1279208528_30113BFCEC0D3147 FOREIGN KEY (`session_uid`)
REFERENCES `tl_laimsc11_session` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_laimsc11_user DROP FOREIGN KEY FK_NEW_1279208528_30113BFC309ED320;
