 ...
 * and must belong to a CommonCartridge.
 * 
 *
 * @hibernate.class table="tl_laimsc11_attachment"
 *
 */
public class CommonCartridgeAttachment implements Cloneable{
	private static final Logger log = Logger.getLogger(CommonCartridgeAttachment.class);
    ...
    public CommonCartridgeAttachment(){
...
//  **********************************************************
    public Object clone(){
		...
		try {
			obj = super.clone();
			((CommonCartridgeAttachment)obj).setUid(null);
		} catch (CloneNotSupportedException e) {
			log.error("When clone " + CommonCartridgeAttachment.class + " failed");
		}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof CommonCartridgeAttachment))
			return false;

		final CommonCartridgeAttachment genericEntity = (CommonCartridgeAttachment) o;
