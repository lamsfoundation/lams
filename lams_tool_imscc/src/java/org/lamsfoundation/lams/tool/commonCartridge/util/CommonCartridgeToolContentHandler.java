 ...
 * @author Andrey Balan
 */
public class CommonCartridgeToolContentHandler extends ToolContentHandler {

    private static String repositoryWorkspaceName = "sharedcommonCartridgeworkspace";
    private static String repositoryUser = "sharedcommonCartridge";
     ...
     *
     */
    public CommonCartridgeToolContentHandler() {
	super();
    }
