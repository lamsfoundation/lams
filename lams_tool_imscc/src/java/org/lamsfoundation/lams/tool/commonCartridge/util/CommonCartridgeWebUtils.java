 ...
 *
 */
public class CommonCartridgeWebUtils {
	...
	if (!url.matches("^" + CommonCartridgeConstants.ALLOW_PROTOCOL_REFIX + ".*")) {
	    url = CommonCartridgeConstants.DEFUALT_PROTOCOL_REFIX + url;
	}
