...
public class CommonCartridgeServiceProxy
{
    ...
    {
        return (ICommonCartridgeService)getCommonCartridgeDomainService(servletContext);
    }
    
    public static final ToolSessionManager getSessionManager(ServletContext servletContext)
    {
        return (ToolSessionManager)getCommonCartridgeDomainService(servletContext);
    }
    
    public static final ToolContentManager getContentManager(ServletContext servletContext)
    {
        return (ToolContentManager)getCommonCartridgeDomainService(servletContext);
    }
