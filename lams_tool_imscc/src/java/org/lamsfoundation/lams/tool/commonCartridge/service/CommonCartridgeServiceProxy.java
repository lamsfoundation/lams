...
public class CommonCartridgeServiceProxy {
     ...
     * @return Shared commonCartridge service object.
     */
    public static final ICommonCartridgeService getCommonCartridgeService(ServletContext servletContext) {
	return (ICommonCartridgeService) CommonCartridgeServiceProxy.getCommonCartridgeDomainService(servletContext);
    }

    public static final ToolSessionManager getSessionManager(ServletContext servletContext) {
	return (ToolSessionManager) CommonCartridgeServiceProxy.getCommonCartridgeDomainService(servletContext);
    }

    public static final ToolContentManager getContentManager(ServletContext servletContext) {
	return (ToolContentManager) CommonCartridgeServiceProxy.getCommonCartridgeDomainService(servletContext);
    }

    private static Object getCommonCartridgeDomainService(ServletContext servletContext) {
