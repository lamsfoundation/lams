...
public class ScribeSession implements java.io.Serializable {
	...
	private Set scribeUsers = new HashSet(0);
	...
	/** full constructor */
	public ScribeSession(Date sessionEndDate, Date sessionStartDate,
			Integer status, Long sessionId, String sessionName, Scribe scribe,
			Set scribeUsers) {
