...
ALTER IGNORE TABLE tl_lascrb11_heading DROP FOREIGN KEY FK428A22FFB3FA1495;
...
ALTER IGNORE TABLE tl_lascrb11_report_entry DROP FOREIGN KEY FK5439FACA1C266FAE;
...
ALTER IGNORE TABLE tl_lascrb11_report_entry DROP FOREIGN KEY FK5439FACAEA50D086;
...
ALTER IGNORE TABLE tl_lascrb11_session DROP FOREIGN KEY FK89732793B3FA1495;
ALTER TABLE tl_lascrb11_session ADD CONSTRAINT FK89732793B3FA1495 FOREIGN KEY (`scribe_uid`)
REFERENCES `tl_lascrb11_scribe` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_lascrb11_session DROP FOREIGN KEY FK89732793E46919FF;
...
ALTER IGNORE TABLE tl_lascrb11_user DROP FOREIGN KEY FK187DAFEE1C266FAE;
