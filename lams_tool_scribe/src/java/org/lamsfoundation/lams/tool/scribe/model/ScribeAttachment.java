 ...
 * 
 * @hibernate.class table="tl_lascrb11_attachment"
 * 
 */

public class ScribeAttachment implements java.io.Serializable, Cloneable {
	...
	private static final Logger log = Logger.getLogger(ScribeAttachment.class);
	...
	/** default constructor */
	public ScribeAttachment() {
	}

	/** full constructor */
	public ScribeAttachment(Long fileVersionId, String fileType, String fileName,
			Long fileUuid, Date createDate, Scribe scribe) {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof ScribeAttachment))
			return false;

		final ScribeAttachment genericEntity = (ScribeAttachment) o;
	...
	public Object clone() {
		...
		try {
			obj = super.clone();
			((ScribeAttachment) obj).setUid(null);
		} catch (CloneNotSupportedException e) {
			log.error("Failed to clone " + ScribeAttachment.class);
		}
