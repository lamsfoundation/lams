...
/**
 * DAO for accessing the ScribeUser objects - interface defining
...
public interface IScribeUserDAO extends IBaseDAO {
     ...
     * @return
     */
    ScribeUser getByUserIdAndSessionId(Long userId, Long toolSessionId);
     ...
     * @return
     */
    ScribeUser getByLoginNameAndSessionId(String loginName, Long toolSessionId);
