...
<html:form action="/authoring" styleId="authoringForm" method="post">
	...
	<html:hidden property="headingIndex" />
		...
		<html:submit styleClass="button space-left" titleKey="basic.title"></html:submit>
		<html:button property="Cancel" value="Cancel" styleClass="button" onclick="window.top.hideMessage();"></html:button>
</html:form>
