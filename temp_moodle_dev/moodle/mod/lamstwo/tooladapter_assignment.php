<?php
 	 ...
 	 */
 	    ...
 	    include_once('../assignment/lib.php');
 	    ...
 	    switch ($method) {
 	        case 'clone':
 	            $newcmid = assignment_clone_instance($cmid, $sectionid, $courseid);
 	            echo $newcmid;
 	            break;
 	        case 'import':
 	            $newcmid = assignment_import_instance($_FILES['upload_file']['tmp_name'], $user->id, $courseid, $sectionid);
 	            echo $newcmid;
 	            break;
 	        case 'export':
 	            assignment_export_instance($cmid);
 	            break;
 	        case 'export_portfolio':
 	            $text = assignment_export_portfolio($cmid, $user->id);
 	            echo $text;
 	            break;
 	        case 'output':
 	            $output = assignment_get_tool_output($cmid, $user->id);
 	            echo $output;
 	            break;
 	        default:
 	    }
