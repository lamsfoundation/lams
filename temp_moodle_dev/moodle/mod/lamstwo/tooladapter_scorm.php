<?php
 	...
 	/**
 	 * This page is a Moodle scorm tool adapter interface for LAMS to call.  It
 	 ...
 	 */
 	    ...
 	    switch ($method) {
 	        case 'clone':
 	            $newcmid = scorm_clone_instance($cmid, $sectionid, $courseid);
 	            echo $newcmid;
 	            break;
 	        case 'import':
 	            $newcmid = scorm_import_instance($_FILES['upload_file']['tmp_name'], $user->id, $courseid, $sectionid);
 	            echo $newcmid;
 	            break;
 	        case 'export':
 	            scorm_export_instance($cmid);
 	            break;
 	        case 'export_portfolio':
 	            $text = scorm_export_portfolio($cmid, $user->id);
 	            echo $text;
 	            break;
 	        case 'output':
 	            $output = scorm_get_tool_output($cmid, $user->id);
 	            echo $output;
 	            break;
 	        default:
 	    }
