...
//-------------------------------------------------------------------------------
        ...
        $this->standard_hidden_coursemodule_elements();//m $this->standard_coursemodule_elements($features);
//-------------------------------------------------------------------------------
        $this->add_action_buttons(false, 'Save', false);//m $this->add_action_buttons();
    }
