...
public class CloudConstants {
    ...
    public static final String PARAM_STUDENT_LIST = "studentList";
    ...
    public static final String ATTR_SEQUENCE_NAME = "sequenceName";
    public static final String ATTR_SEQUENCE_LOCATION = "sequenceLocation";
    
    // error message keys
    public static final String ERROR_MSG_WRONG_URL_SEQUENCE_NAME = "error.wrong.url.sequence.name";    
    public static final String ERROR_MSG_WRONG_URL_SEQUENCE_LOCATION = "error.wrong.url.sequence.location";
