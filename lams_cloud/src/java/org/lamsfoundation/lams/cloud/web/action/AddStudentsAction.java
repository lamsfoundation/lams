 ...
 * 
 * ----------------XDoclet Tags-------------------- 
 * @struts.action path="/addStudents" name="studentForm" parameter="dispatch"
 *                scope="request" validate="false" 
 *                
 * @struts.action-forward name = "addstudents" path = "/addstudents.jsp"
 * @struts.action-forward name = "studentlist" path = "/studentlist.jsp"
 * 
...
//    	initServices();
    	...
    	request.setAttribute(CloudConstants.PARAM_STUDENT_LIST, null);
	...
	return mapping.findForward(ADD_STUDENTS);
    }
     ...
     */
    private ActionForward saveStudent(ActionMapping mapping, ActionForm form, HttpServletRequest request,
...
//	request.setAttribute(ImageGalleryConstants.ATTR_SESSION_MAP_ID, itemForm.getSessionMapID());
	...
	return mapping.findForward(STUDENT_LIST);
    }
