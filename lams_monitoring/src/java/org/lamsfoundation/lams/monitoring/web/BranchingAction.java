...
* </UL>
* 
* Due to how XDoclet works, we have to have a separate subclass of BranchingAction
* for each branching type, and include the XDoclet tags in the subclasses.
*
...
public class BranchingAction extends LamsDispatchAction {
   ...
   /**
     ...
     */
    public ActionForward viewBranching(ActionMapping mapping,
                                  ActionForm form,
                                  HttpServletRequest request,
                                  HttpServletResponse response) throws IOException,
                                                                          ServletException
