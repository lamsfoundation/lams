...
public class SequenceAction extends LamsDispatchAction {
   ...
   /**
    ...
    /**
     * Display the view screen - to be used if we ever want direct access to the screen rather than export portfolio version.
     */
    public ActionForward viewSequence(ActionMapping mapping,
                                  ActionForm form,
                                  HttpServletRequest request,
                                  HttpServletResponse response) throws IOException,
                                                                          ServletException
