...
/**
 * Export portfolio page for the sequence. Only the teacher gets portfolio pages for gates - learners
 * do not see a page in their portfolio. This page just lists the learners in a branch.
 *
 * @web:servlet name="sequenceExportPortfolio"
 * @web:servlet-mapping url-pattern="/sequenceExportPortfolio"
 * 
 */
public class SequenceExportPortfolioServlet extends AbstractExportPortfolioServlet {

    private final String FILENAME = "sequence.html";
