          ...
          <tr> 
            <td valign="top"> <div align="center"> 
                ...
                <table width="90%" border="0" cellspacing="0" cellpadding="0" summary="This table is being used for layout purposes only"> 
                  ...
                  <tr><td>&nbsp; </td></tr> 
                  <tr> 
                    <td height="31"> <div class="heading"><fmt:message key="label.report.question"/></div></td> 
                  </tr> 
                  <tr><td class="body">&nbsp;</td></tr> 
                  <tr>
                  	<td class="body">
                      <!--end of question and candidate answer table-->
                  	</td>
                  </tr> 
				  ...
				  <!--row of survey question and answers-->
            	  <tr> 
					  <td class="body">
					  test
					  </td>
			      </tr>				  
				  <!--end of survey question and answers row -->
                </table> 
                <!-- end of report table--> 
              </div></td> 
          </tr> 
