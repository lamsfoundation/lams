	...
	<lams:Page title="${title}" type="monitoring">
		<div class="full-screen-content-div">
			<div class="full-screen-flex-div">
				...
				<div id="buttonsDiv">
					<a href="#" class="btn btn-primary fixed-button-width setup" onclick="javascript:start()"><fmt:message key="label.start"/></a>
					<a href="#" class="btn btn-primary fixed-button-width timer" id="pause" onclick="javascript:pause()"><fmt:message key="label.stop"/></a>
					<a href="#" class="btn btn-primary fixed-button-width timer" id="resume" onclick="javascript:resume()" ><fmt:message key="label.resume"/></a>
					...
					<a href="#" class="btn btn-danger loffset10 fixed-button-width pull-right" id="close" onclick="javascript:window.close()"><fmt:message key="button.close"/></a>
