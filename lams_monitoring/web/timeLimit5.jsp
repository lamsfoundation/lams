...
var relativeTimeLimit = ${param.relativeTimeLimit},
	...
	absoluteTimeLimitFinish = ${empty param.absoluteTimeLimitFinish ? 'null' : param.absoluteTimeLimitFinish};
		...
		<table id="time-limit-table" class="table align-middle">
			...
			<tr>
				...
				<td class="text-center">
					...
					<div id="absolute-time-limit-disabled" class="text-danger ${absoluteTimeLimitEnabled ? 'd-none' : ''}">
						<fmt:message key="label.monitoring.time.limit.disabled"/>
					</div>
				</td>
				<td class="text-center">
					<button id="absolute-time-limit-start" class="btn btn-success ${absoluteTimeLimitEnabled ? 'd-none' : ''}"
							onClick="updateTimeLimit('absolute', true)" disabled>
						<fmt:message key="label.monitoring.time.limit.start"/>
					</button>
					<button id="absolute-time-limit-cancel" class="btn btn-danger ${absoluteTimeLimitEnabled ? '' : 'd-none'}"
