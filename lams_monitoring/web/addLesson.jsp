...
<% String clientVersion = Configuration.get(ConfigurationKeys.MONITOR_CLIENT_VERSION); %>
		...
		<noscript>
		  	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
					...
					<param name="movie" value="<lams:LAMSURL/>/monitoring/CloudWizard.swf?<c:out value="${wizard_flashvars}" escapeXml="false" />" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#869ca7" />
					<param name="allowScriptAccess" value="sameDomain" />
					<embed src="<lams:LAMSURL/>/monitoring/CloudWizard.swf" quality="high" bgcolor="#869ca7"
						width="100%" height="100%" name="CloudWizard" align="middle"
						play="true"
						loop="false"
						quality="high"
						allowScriptAccess="sameDomain"
