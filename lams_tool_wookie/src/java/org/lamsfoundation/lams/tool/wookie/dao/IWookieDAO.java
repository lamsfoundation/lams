...
/**
 * DAO for accessing the Wookie objects - interface defining methods to be implemented by the Hibernate or other
 * implementation.
 */
public interface IWookieDAO extends IBaseDAO {
