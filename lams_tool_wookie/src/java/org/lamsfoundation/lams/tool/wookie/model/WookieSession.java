...
public class WookieSession implements java.io.Serializable {
	...
	/** full constructor */
	public WookieSession(Date sessionEndDate, Date sessionStartDate,
			Integer status, Long sessionId, String sessionName, Wookie wookie,
			Set<WookieUser> wookieUsers) {
