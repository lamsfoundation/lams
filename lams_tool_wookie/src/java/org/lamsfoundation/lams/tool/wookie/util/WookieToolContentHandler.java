 ...
 */
public class WookieToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "wookieworkspace";

    public static String repositoryUser = "wookie";
     ...
     * 
     */
    public WookieToolContentHandler() {
	super();
    }
