...
public class WookieAttachmentDTO implements Comparable<Object> {

	public WookieAttachmentDTO(WookieAttachment att) {
	...
	public int compareTo(Object o) {
		WookieAttachmentDTO toAttachment = (WookieAttachmentDTO) o;
		int returnValue = this.createDate.compareTo(((WookieAttachmentDTO) o)
				.getCreateDate());
