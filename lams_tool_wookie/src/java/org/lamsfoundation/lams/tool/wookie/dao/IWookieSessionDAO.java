...
/**
 * DAO for accessing the WookieSession objects - interface defining
 * methods to be implemented by the Hibernate or other implementation.
 */
public interface IWookieSessionDAO extends IBaseDAO {

    void saveOrUpdate(WookieSession session);

    WookieSession getBySessionId(Long toolSessionId);
