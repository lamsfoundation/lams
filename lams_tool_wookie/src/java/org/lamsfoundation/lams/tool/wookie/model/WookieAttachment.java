 ...
 * 
 * @hibernate.class table="tl_lawook10_attachment"
 * 
 */

public class WookieAttachment implements java.io.Serializable, Cloneable {
    ...
    private static final Logger log = Logger.getLogger(WookieAttachment.class);
    ...
    /** default constructor */
    public WookieAttachment() {
    }

    /** Constructor setting up all the properties except for wookie one */
    public WookieAttachment(Long fileVersionId, String fileType, String fileName, Long fileUuid, Date createDate) {
	...
	if (this == o)
	    return true;
	if (!(o instanceof WookieAttachment))
	    return false;

	final WookieAttachment genericEntity = (WookieAttachment) o;
	...
	try {
	    obj = super.clone();
	    ((WookieAttachment) obj).setUid(null);
	} catch (CloneNotSupportedException e) {
	    log.error("Failed to clone " + WookieAttachment.class);
	}
