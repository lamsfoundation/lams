...
<!-- Common Javascript functions for LAMS -->
	...
	<table class="forms">
		...
		<tr>
			<td colspan="2">
				<lams:SetEditor id="onlineInstruction" small="true" text="${formBean.forum.onlineInstructions}" key="label.authoring.online.instruction" />
			</td>
		</tr>
		<tr>
			<td colspan="2">
		...
		<tr>
			<td colspan="2">
			<lams:SetEditor id="offlineInstruction" small="true"  text="${formBean.forum.offlineInstructions}" key="label.authoring.offline.instruction"/>
			</td>
		</tr>
		<tr>
			<td colspan="2">
