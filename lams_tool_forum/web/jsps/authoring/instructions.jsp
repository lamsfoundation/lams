...
<table cellpadding="0">
	...
	<c:if test="${not empty forumForm.onlineFileList}">
		<tr>
			<td>
				<div id="onlinefile">
					<ul>
	...
	<tr>
		<td>
			...
			<a href="#" onclick="doSubmit('${uploadonline}')" class="button"> <fmt:message key="label.authoring.upload.online.button" /> </a>
		</td>
	</tr>
</table>
...
<table>
	...
	<tr>
		<td>
			<lams:SetEditor id="forum.offlineInstructions" small="true" text="${forumForm.forum.offlineInstructions}" key="label.authoring.offline.instruction" alt="true" />
		</td>
	</tr>
	<c:if test="${not empty forumForm.offlineFileList}">
		<tr>
			<td>
				<div id="offlinefile">
					<ul>
	...
	<tr>
		<td>
			...
			<a href="#" onclick="doSubmit('${uploadoffline}')" class="button"> <fmt:message key="label.authoring.upload.offline.button" /> </a>
		</td>
	</tr>
</table>
