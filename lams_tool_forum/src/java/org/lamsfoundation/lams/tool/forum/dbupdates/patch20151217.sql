...
ALTER IGNORE TABLE tl_lafrum11_attachment DROP FOREIGN KEY FK389AD9A2131CE31E;
...
ALTER IGNORE TABLE tl_lafrum11_attachment DROP FOREIGN KEY FK389AD9A2FE939F2A;
...
ALTER IGNORE TABLE tl_lafrum11_forum DROP FOREIGN KEY FK87917942E42F4351;
...
ALTER IGNORE TABLE tl_lafrum11_message_rating DROP FOREIGN KEY FK_tl_lafrum11_message_rating_1;
...
ALTER IGNORE TABLE tl_lafrum11_tool_session DROP FOREIGN KEY FK5A04D7AE131CE31E;
ALTER TABLE tl_lafrum11_tool_session ADD CONSTRAINT FK5A04D7AE131CE31E FOREIGN KEY (`forum_uid`)
REFERENCES `tl_lafrum11_forum` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_lafrum11_timestamp DROP FOREIGN KEY ForumUserFK;
ALTER TABLE tl_lafrum11_timestamp ADD CONSTRAINT ForumUserFK FOREIGN KEY (`forum_user_uid`)
REFERENCES `tl_lafrum11_forum_user` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_lafrum11_timestamp DROP FOREIGN KEY MessageFK;
ALTER TABLE tl_lafrum11_timestamp ADD CONSTRAINT MessageFK FOREIGN KEY (`message_uid`)
REFERENCES `tl_lafrum11_message` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_lafrum11_forum_user DROP FOREIGN KEY FK7B83A4A85F0116B6;
