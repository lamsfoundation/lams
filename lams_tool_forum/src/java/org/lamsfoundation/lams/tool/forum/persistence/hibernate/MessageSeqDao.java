...
public class MessageSeqDao extends LAMSBaseDAO implements IMessageSeqDAO {
	...
	Query queryObject = getSession().createQuery(SQL_QUERY_FIND_NEXT_THREAD_TOP).setParameter(0, rootTopicId)
		.setParameter(1, previousThreadMessageId).setMaxResults(1);
     ...
     * 
     * @see
     * org.lamsfoundation.lams.tool.forum.persistence.hibernate.IMessageSeqDAO#save(org.lamsfoundation.lams.tool.forum.
     * persistence.MessageSeq)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.lamsfoundation.lams.tool.forum.persistence.hibernate.IMessageSeqDAO#getNumOfPostsByTopic(java.lang.Long,
     * java.lang.Long)
     */
    @Override
     ...
     * 
     * @see
     * org.lamsfoundation.lams.tool.forum.persistence.hibernate.IMessageSeqDAO#getNumOfPostsNewerThan(java.lang.Long,
     * java.util.Date)
     */
    @Override
