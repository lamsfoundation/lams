...
public class AttachmentTest extends TestCase {
   protected void setUp() throws Exception {
    ...
    public void testCreateAndDeleteForum() throws FactoryException {
        ...
        instructions.setData("instructions byte array".getBytes());
        ...
        assertEquals("persisted and reloaded byte array should be equal", "instructions byte array", new String(instructions.getData()));
