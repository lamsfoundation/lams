...
ALTER IGNORE TABLE tl_lamc11_options_content DROP FOREIGN KEY FK_tl_lamc11_options_content_1;
...
ALTER IGNORE TABLE tl_lamc11_que_content DROP FOREIGN KEY FK_tl_lamc11_que_content_1;
...
ALTER IGNORE TABLE tl_lamc11_que_usr DROP FOREIGN KEY FK_tl_lamc11_que_usr_1;
...
ALTER IGNORE TABLE tl_lamc11_session DROP FOREIGN KEY FK_lamc11_session1;
...
ALTER IGNORE TABLE tl_lamc11_session DROP FOREIGN KEY FK_tl_lamc_session_1;
ALTER TABLE tl_lamc11_session ADD CONSTRAINT FK_tl_lamc_session_1 FOREIGN KEY (`mc_content_id`)
REFERENCES `tl_lamc11_content` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_lamc11_usr_attempt DROP FOREIGN KEY FK_tl_lamc11_usr_attempt_2;
ALTER TABLE tl_lamc11_usr_attempt ADD CONSTRAINT FK_tl_lamc11_usr_attempt_2 FOREIGN KEY (`mc_que_content_id`)
REFERENCES `tl_lamc11_que_content` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_lamc11_usr_attempt DROP FOREIGN KEY FK_tl_lamc11_usr_attempt_3;
...
ALTER IGNORE TABLE tl_lamc11_usr_attempt DROP FOREIGN KEY FK_tl_lamc11_usr_attempt_4;
