...
public class McOptionsContentDAO extends LAMSBaseDAO implements IMcOptionsContentDAO {
    @Override
    public List<QbOption> findOptionsByQueId(Long questionUid) {
	return ((McQueContent) find(McQueContent.class, questionUid)).getQbQuestion().getQbOptions();
    }
	...
	if (questionUid != null) {
	    List<QbOption> options = ((McQueContent) find(McQueContent.class, questionUid)).getQbQuestion()
		    .getQbOptions();
