 ...
 */
public class SpreadsheetToolContentHandler extends ToolContentHandler {

    private static String repositoryWorkspaceName = "sharedspreadsheetworkspace";
    private static String repositoryUser = "sharedspreadsheet";
    //sharedspreadsheet
     ...
     *
     */
    public SpreadsheetToolContentHandler() {
	super();
    }
