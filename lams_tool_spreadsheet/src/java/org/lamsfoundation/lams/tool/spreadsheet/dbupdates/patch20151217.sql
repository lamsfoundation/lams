...
ALTER IGNORE TABLE tl_lasprd10_session DROP FOREIGN KEY FK_NEW_2065267438_24AA78C530E79035;
...
ALTER IGNORE TABLE tl_lasprd10_spreadsheet DROP FOREIGN KEY FK_NEW_2065267438_89093BF758092FB;
...
ALTER IGNORE TABLE tl_lasprd10_user DROP FOREIGN KEY FK_NEW_2065267438_30113BFC309ED320;
ALTER TABLE tl_lasprd10_user ADD CONSTRAINT FK_NEW_2065267438_30113BFC309ED320 FOREIGN KEY (`spreadsheet_uid`)
REFERENCES `tl_lasprd10_spreadsheet` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_lasprd10_user DROP FOREIGN KEY FK_NEW_2065267438_30113BFCEC0D3147;
...
ALTER IGNORE TABLE tl_lasprd10_user DROP FOREIGN KEY FK_NEW_2065267438_693580A441F9365D;
