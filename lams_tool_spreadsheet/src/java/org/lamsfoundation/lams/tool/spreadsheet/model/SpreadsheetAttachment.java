 ...
 * and must belong to a Spreadsheet.
 * 
 *
 * @hibernate.class table="tl_lasprd10_attachment"
 *
 */
public class SpreadsheetAttachment implements Cloneable{
	private static final Logger log = Logger.getLogger(SpreadsheetAttachment.class);
...
//  **********************************************************
    public Object clone(){
		...
		try {
			obj = super.clone();
			((SpreadsheetAttachment)obj).setUid(null);
		} catch (CloneNotSupportedException e) {
			log.error("When clone " + SpreadsheetAttachment.class + " failed");
		}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof SpreadsheetAttachment))
			return false;

		final SpreadsheetAttachment genericEntity = (SpreadsheetAttachment) o;
