 ...
 *         </p>
 */
public class SpreadsheetServiceProxy {
    /**
     ...
     * @return Shared spreadsheet service object.
     */
    public static final ISpreadsheetService getSpreadsheetService(ServletContext servletContext) {
	return (ISpreadsheetService) SpreadsheetServiceProxy.getSpreadsheetDomainService(servletContext);
    }

    public static final ToolSessionManager getSessionManager(ServletContext servletContext) {
	return (ToolSessionManager) SpreadsheetServiceProxy.getSpreadsheetDomainService(servletContext);
    }

    public static final ToolContentManager getContentManager(ServletContext servletContext) {
	return (ToolContentManager) SpreadsheetServiceProxy.getSpreadsheetDomainService(servletContext);
    }

    private static Object getSpreadsheetDomainService(ServletContext servletContext) {
	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(servletContext);
	return wac.getBean(SpreadsheetConstants.RESOURCE_SERVICE);
    }
