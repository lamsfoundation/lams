...
public class ExportServlet extends AbstractExportPortfolioServlet {
    ...
    public void learner(HttpServletRequest request, HttpServletResponse response, String directoryName,
	    Cookie[] cookies, HashMap sessionMap) throws SpreadsheetApplicationException {
...
//				handler.saveFile(summary.getFileUuid(), FileUtil.getFullPath(directoryName, summary.getAttachmentLocalUrl()));
	...
	NotebookEntry notebookEntry = service.getEntry(spreadsheetUser.getSession().getSessionId(),
		CoreNotebookConstants.NOTEBOOK_TOOL, SpreadsheetConstants.TOOL_SIGNATURE,
		spreadsheetUser.getUserId().intValue());
