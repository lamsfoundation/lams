...
create table tl_lasprd10_user_modified_spreadsheet (uid bigint, user_modified_spreadsheet text, mark_id bigint, primary key (uid));
...
create table tl_lasprd10_user (uid bigint not null auto_increment, user_id bigint, last_name varchar(255), first_name varchar(255), login_name varchar(255), session_uid bigint, spreadsheet_uid bigint, session_finished bit, user_modified_spreadsheet_uid bigint, primary key (uid));
...
alter table tl_lasprd10_user add index FK_NEW_2065267438_63195BC941F9365D (user_modified_spreadsheet_uid), add constraint FK_NEW_2065267438_63195BC941F9365D foreign key (user_modified_spreadsheet_uid) references tl_lasprd10_user_modified_spreadsheet (uid);
