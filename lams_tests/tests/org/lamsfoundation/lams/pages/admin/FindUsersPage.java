...
public class FindUsersPage extends AbstractPage {

	@FindBy(linkText= "Manage courses")
	private WebElement manageCoursesLink;
	
	
	public FindUsersPage(WebDriver driver) {
		super(driver);
		
	}
	
	public CourseManagementPage manageCourses() {
		manageCoursesLink.click();
