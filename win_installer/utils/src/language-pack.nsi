...
!define UTILS ".."
!define BASE_DIR "${UTILS}\.."
!define BASE_PROJECT_DIR "${BASE_DIR}\.."
!define DOCUMENTS "${UTILS}\documents"
!define BUILD "${BASE_DIR}\build"
!define SQL "sql"
!define ANT "ant"
...
# installer settings
!define MUI_ICON "${UTILS}\graphics\lams2.ico"
...
Function copyProjects
    ...
    file /a  "${BASE_PROJECT_DIR}\lams_contentrepository\conf\language\*"
...
Function copyFlashxml
    ...
    file /a /r /x "CVS" "${BASE_PROJECT_DIR}\lams_central\web\flashxml\*"
    detailprint "DONE!"  
FunctionEnd
