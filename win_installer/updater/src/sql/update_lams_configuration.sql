...
update lams_configuration set config_value='@DICTIONARY_DATE@' where config_key='DictionaryDateCreated';
update lams_configuration set config_value='@SERVER_VERSION@' where config_key='LearnerClientVersion' OR config_key='ServerVersionNumber' OR config_key='MonitorClientVersion' OR config_key='AuthoringClientVersion';
...
update lams_user set password=sha1('@LAMS_PASS@') where login='test4';
