...
<table cellspacing="0">
	...
	<tr>
		<td colspan="3">
			...
			<div style="padding-left: 20px;">
				<c:out value="${scratchie.onlineInstructions}" escapeXml="false" />
			</div>
		</td>
	</tr>
	
	<c:if test="${not empty scratchie.onlineFileList}">
		<tr>
	...
	<c:forEach var="file" items="${scratchie.onlineFileList}">
		<tr >
	...
	<tr>
		<td colspan="3">
			...
			<div style="padding-left: 20px;">
				<c:out value="${scratchie.offlineInstructions}" escapeXml="false" />
			</div>
		</td>
	</tr>
	
	<c:if test="${not empty scratchie.offlineFileList}">
		<tr>
			<td  colspan="3" class="field-name-alternative-color">
				<fmt:message key="monitoring.label.attachments" />
			</td>
	...
	<c:forEach var="file" items="${scratchie.offlineFileList}">
		<tr >
			<td width="7%" style="padding-left: 30px;">			
				<c:out value="${file.fileName}" />
			</td>
