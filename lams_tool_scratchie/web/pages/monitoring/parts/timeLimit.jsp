...
<c:set var="absoluteTimeLimitEnabled" value="${not empty scratchie.absoluteTimeLimit}" />
<c:set var="relativeTimeLimitEnabled" value="${scratchie.relativeTimeLimit != 0}" />
...
<div class="panel panel-default ${isTbl ? 'voffset20' : ''}" >
       <c:choose>
		...
		<table id="time-limit-table" class="table">
			...
			<tr>
				<td>
					<span id="relative-time-limit-value">${scratchie.relativeTimeLimit}</span>&nbsp;
