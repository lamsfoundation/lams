        ...
        <div class="radio form-inline">
            <label for="timeLimitNone">
                <input type="radio" name="timeLimit" value="none" id="timeLimitNone"
                    ${authoringForm.scratchie.relativeTimeLimit eq 0 and authoringForm.scratchie.absoluteTimeLimit eq 0 ? 'checked' : ''}
                />
        ...
        <div class="radio form-inline">
            <label for="timeLimitRelative">
                <input type="radio" id="timeLimitRelative" name="timeLimit" value="relative"
                    ${authoringForm.scratchie.relativeTimeLimit > 0 ? 'checked' : ''} />
            ...
            <form:input path="scratchie.relativeTimeLimit" type="number" min="0" max="999" size="3"
        ...
        <div class="radio form-inline">
            <label for="timeLimitAbsolute">
                <input type="radio" id="timeLimitAbsolute" name="timeLimit" value="absolute"
                    ${authoringForm.scratchie.absoluteTimeLimit > 0 ? 'checked' : ''} />
            ...
            <form:input path="scratchie.absoluteTimeLimit" type="number" min="0" max="999" size="3"
