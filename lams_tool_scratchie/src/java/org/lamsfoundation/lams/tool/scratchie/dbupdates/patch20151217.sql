...
ALTER IGNORE TABLE tl_lascrt11_scratchie_answer DROP FOREIGN KEY FK_scratchie_answer_1;
...
ALTER IGNORE TABLE tl_lascrt11_scratchie_item DROP FOREIGN KEY FK_NEW_610529188_F52D1F9330E79035;
...
ALTER IGNORE TABLE tl_lascrt11_scratchie_item DROP FOREIGN KEY FK_NEW_610529188_F52D1F93EC0D3147;
...
ALTER IGNORE TABLE tl_lascrt11_session DROP FOREIGN KEY FK_lalead11_session1;
...
ALTER IGNORE TABLE tl_lascrt11_session DROP FOREIGN KEY FK_NEW_610529188_24AA78C530E79035;
ALTER TABLE tl_lascrt11_session ADD CONSTRAINT FK_NEW_610529188_24AA78C530E79035 FOREIGN KEY (`scratchie_uid`)
REFERENCES `tl_lascrt11_scratchie` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_lascrt11_user DROP FOREIGN KEY FK_NEW_610529188_30113BFCEC0D3147;
ALTER TABLE tl_lascrt11_user ADD CONSTRAINT FK_NEW_610529188_30113BFCEC0D3147 FOREIGN KEY (`session_uid`)
REFERENCES `tl_lascrt11_session` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

							 
ALTER IGNORE TABLE tl_lascrt11_answer_log DROP FOREIGN KEY sessionIdIndex;
...
ALTER IGNORE TABLE tl_lascrt11_answer_log DROP FOREIGN KEY FK_NEW_610529188_693580A438BF8DFE;
...
ALTER IGNORE TABLE tl_lascrt11_burning_question DROP FOREIGN KEY sessionIdIndex2;
ALTER TABLE tl_lascrt11_burning_question ADD CONSTRAINT sessionIdIndex2 FOREIGN KEY (`session_id`)
REFERENCES `tl_lascrt11_session` (`session_id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_lascrt11_burning_question DROP FOREIGN KEY FK_NEW_610529188_693580A438BF8DF2;
