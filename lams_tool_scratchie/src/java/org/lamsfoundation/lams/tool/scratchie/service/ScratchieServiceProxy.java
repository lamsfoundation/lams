...
public class ScratchieServiceProxy {
	...
	return (IScratchieService) ScratchieServiceProxy.getScratchieDomainService(servletContext);
    }

    public static final ToolSessionManager getSessionManager(ServletContext servletContext) {
	return (ToolSessionManager) ScratchieServiceProxy.getScratchieDomainService(servletContext);
    }

    public static final ToolContentManager getContentManager(ServletContext servletContext) {
	return (ToolContentManager) ScratchieServiceProxy.getScratchieDomainService(servletContext);
    }
