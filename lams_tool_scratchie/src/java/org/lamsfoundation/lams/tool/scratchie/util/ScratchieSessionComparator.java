...
/**
 * ScratchieSession comparator.
 */
public class ScratchieSessionComparator implements Comparator<ScratchieSession> {

    private static AlphanumComparator alphanumComparator = new AlphanumComparator();

    @Override
    public int compare(ScratchieSession session1, ScratchieSession session2) {
