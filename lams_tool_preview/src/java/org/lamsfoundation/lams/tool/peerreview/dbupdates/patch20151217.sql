...
ALTER IGNORE TABLE tl_laprev11_peerreview DROP FOREIGN KEY FK_NEW_1661738138_89093BF758092FB;
...
ALTER IGNORE TABLE tl_laprev11_session DROP FOREIGN KEY FK_NEW_1661738138_24AA78C530E79035;
...
ALTER IGNORE TABLE tl_laprev11_user DROP FOREIGN KEY FK_NEW_1661738138_30113BFC309ED320;
ALTER TABLE tl_laprev11_user ADD CONSTRAINT FK_NEW_1661738138_30113BFC309ED320 FOREIGN KEY (`peerreview_uid`)
REFERENCES `tl_laprev11_peerreview` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_laprev11_user DROP FOREIGN KEY FK_NEW_1661738138_30113BFCEC0D3147;
