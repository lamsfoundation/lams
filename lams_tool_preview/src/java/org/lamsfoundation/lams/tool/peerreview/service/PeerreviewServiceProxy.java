 ...
 * @author Andrey Balan
 */
public class PeerreviewServiceProxy {
    /**
     ...
     * @return Peerreview service object.
     */
    public static final IPeerreviewService getPeerreviewService(ServletContext servletContext) {
	return (IPeerreviewService) PeerreviewServiceProxy.getPeerreviewDomainService(servletContext);
    }

    public static final ToolSessionManager getSessionManager(ServletContext servletContext) {
	return (ToolSessionManager) PeerreviewServiceProxy.getPeerreviewDomainService(servletContext);
    }

    public static final ToolContentManager getContentManager(ServletContext servletContext) {
	return (ToolContentManager) PeerreviewServiceProxy.getPeerreviewDomainService(servletContext);
    }

    private static Object getPeerreviewDomainService(ServletContext servletContext) {
	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(servletContext);
	return wac.getBean(PeerreviewConstants.PEERREVIEW_SERVICE);
    }
