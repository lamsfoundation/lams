...
public class PeerreviewApplicationException extends Exception {
    ...
    public PeerreviewApplicationException(String message, Throwable cause) {
	super(message, cause);

    }

    public PeerreviewApplicationException(String message) {
	super(message);

    }

    public PeerreviewApplicationException(Throwable cause) {
	super(cause);
