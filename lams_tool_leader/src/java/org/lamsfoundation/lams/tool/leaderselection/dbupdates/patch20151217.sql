...
ALTER IGNORE TABLE tl_lalead11_session DROP FOREIGN KEY FK_lalead11_1;
...
ALTER IGNORE TABLE tl_lalead11_session DROP FOREIGN KEY FK_NEW_1316293302_B7C198E2FC940906;
...
ALTER IGNORE TABLE tl_lalead11_user DROP FOREIGN KEY FK_NEW_1316293302_CB8A58FFA3B0FADF;
