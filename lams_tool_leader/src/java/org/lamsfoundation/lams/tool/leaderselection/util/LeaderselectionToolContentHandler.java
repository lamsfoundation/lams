 ...
 */
public class LeaderselectionToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "leaderselectionworkspace";

    public static String repositoryUser = "leaderselection";
     ...
     * 
     */
    public LeaderselectionToolContentHandler() {
	super();
    }
