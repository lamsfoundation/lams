...
public interface ICoreLearnerService extends ILearnerService {
	 ...
	 * @param lessonId lesson id
	 * @param groupingActivityId the activity that create grouping.
	 * @param groupId id of the group chosen by the learner
	 * @param learnerId the learner who triggers the grouping.
	 ...
	 * @param groupingId id of the grouping activity
	 * @return the maximum number of learners per group;<code>null</code> if the requirement for equal number of learners in groups was not set
	 */
