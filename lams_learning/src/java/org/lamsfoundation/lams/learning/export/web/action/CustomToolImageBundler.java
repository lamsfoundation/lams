...
public class CustomToolImageBundler extends Bundler
{
	 ...
	 * @throws Exception
	 */
	public void bundle(HttpServletRequest request, Cookie[] cookies, String outputDirectory, String toolImageUrlDir, String[] fileNames) throws Exception
	{
	 ...
	 * @throws IOException
	 */
	private void bundleViaHTTP(HttpServletRequest request, Cookie[] cookies, String outputDirectory, String toolImageUrlDir, String[] fileNames) 
