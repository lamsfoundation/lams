...
if (exception != null ) {
%>
<c:set var="errorMessage"><%=exception.getMessage()%></c:set>
<c:set var="errorName"><%=exception.getClass().getName()%></c:set>
<%
...
%>
<c:set var="errorStack"><%=stack%></c:set>
<%
} else if ((Exception) request.getAttribute("javax.servlet.error.exception") != null) {
%>
<c:set var="errorMessage"><%=((Exception) request.getAttribute("javax.servlet.error.exception")).getMessage()%></c:set>
<c:set var="errorName"><%=((Exception) request.getAttribute("javax.servlet.error.exception")).getMessage().getClass().getName()%></c:set>
<%
		java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream();
		java.io.PrintStream os = new java.io.PrintStream(bos);
