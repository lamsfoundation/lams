 ...
 */
public class MdlChoiceToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "mdlChoiceworkspace";

    public static String repositoryUser = "mdlChoice";
     ...
     * 
     */
    public MdlChoiceToolContentHandler() {
	super();
    }
