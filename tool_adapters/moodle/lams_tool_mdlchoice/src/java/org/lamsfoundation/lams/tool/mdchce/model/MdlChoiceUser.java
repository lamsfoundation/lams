 ...
 * 
 * @hibernate.class table="tl_mdchce10_user"
 */

public class MdlChoiceUser implements java.io.Serializable {
    ...
    private MdlChoiceSession mdlChoiceSession;
    ...
    /** default constructor */
    public MdlChoiceUser() {
    }

    public MdlChoiceUser(UserDTO user, MdlChoiceSession mdlChoiceSession) {
	this.userId = new Long(user.getUserID().intValue());
	this.firstName = user.getFirstName();
	this.lastName = user.getLastName();
	this.loginName = user.getLogin();
	this.mdlChoiceSession = mdlChoiceSession;
	this.finishedActivity = false;
    }

    /** full constructor */
    public MdlChoiceUser(Long userId, String lastName, String firstName, MdlChoiceSession mdlChoiceSession) {
	this.userId = userId;
     ...
     * @hibernate.column name="mdlchoice_session_uid"
     * 
     */
    public MdlChoiceSession getMdlChoiceSession() {
	return this.mdlChoiceSession;
    }

    public void setMdlChoiceSession(MdlChoiceSession mdlChoiceSession) {
	this.mdlChoiceSession = mdlChoiceSession;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlChoiceUser))
	    return false;
	MdlChoiceUser castOther = (MdlChoiceUser) other;
