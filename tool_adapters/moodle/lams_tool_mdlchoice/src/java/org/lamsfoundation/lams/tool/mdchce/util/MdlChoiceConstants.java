...
public interface MdlChoiceConstants {
    public static final String TOOL_SIGNATURE = "mdchce10";

    // MdlChoice session status
    ...
    public static final String RELATIVE_SERVLET_URL = "mod/lamstwo/tooladapter_choice.php";
}
