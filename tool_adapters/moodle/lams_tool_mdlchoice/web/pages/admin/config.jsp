...
<html>
	...
	<body class="stripes">
			...
			<html:form action="/mdchce10admin" styleId="mdchce10AdminForm" method="post" enctype="multipart/form-data">
				...
				<h3>
 	 				...
 	 				<logic:iterate name="mdchce10AdminForm" property="mappableServers" id="mappableServer">
