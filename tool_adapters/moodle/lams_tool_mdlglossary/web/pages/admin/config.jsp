...
<html>
	...
	<body class="stripes">
			...
			<html:form action="/mdglos10admin" styleId="mdglos10AdminForm" method="post" enctype="multipart/form-data">
                ...
                <logic:iterate name="mdglos10AdminForm" property="mappableServers" id="mappableServer">
