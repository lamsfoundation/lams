 ...
 * 
 * @hibernate.class table="tl_mdglos10_user"
 */

public class MdlGlossaryUser implements java.io.Serializable {
    ...
    private MdlGlossarySession mdlGlossarySession;
    ...
    /** default constructor */
    public MdlGlossaryUser() {
    }

    public MdlGlossaryUser(UserDTO user, MdlGlossarySession mdlGlossarySession) {
	this.userId = new Long(user.getUserID().intValue());
	this.firstName = user.getFirstName();
	this.lastName = user.getLastName();
	this.loginName = user.getLogin();
	this.mdlGlossarySession = mdlGlossarySession;
	this.finishedActivity = false;
    }

    /** full constructor */
    public MdlGlossaryUser(Long userId, String lastName, String firstName, MdlGlossarySession mdlGlossarySession) {
	this.userId = userId;
     ...
     * @hibernate.column name="mdlglossary_session_uid"
     * 
     */
    public MdlGlossarySession getMdlGlossarySession() {
	return this.mdlGlossarySession;
    }

    public void setMdlGlossarySession(MdlGlossarySession mdlGlossarySession) {
	this.mdlGlossarySession = mdlGlossarySession;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlGlossaryUser))
	    return false;
	MdlGlossaryUser castOther = (MdlGlossaryUser) other;
