 ...
 */
public class MdlGlossaryToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "mdlGlossaryworkspace";

    public static String repositoryUser = "mdlGlossary";
     ...
     * 
     */
    public MdlGlossaryToolContentHandler() {
	super();
    }
