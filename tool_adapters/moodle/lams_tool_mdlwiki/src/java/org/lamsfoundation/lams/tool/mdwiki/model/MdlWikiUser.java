 ...
 * 
 * @hibernate.class table="tl_mdwiki10_user"
 */

public class MdlWikiUser implements java.io.Serializable {
    ...
    private MdlWikiSession mdlWikiSession;
    ...
    public MdlWikiUser(UserDTO user, MdlWikiSession mdlWikiSession) {
	this.userId = new Long(user.getUserID().intValue());
	this.firstName = user.getFirstName();
	this.lastName = user.getLastName();
	this.loginName = user.getLogin();
	this.mdlWikiSession = mdlWikiSession;
	this.finishedActivity = false;
    }

    /** full constructor */
    public MdlWikiUser(Long userId, String lastName, String firstName, MdlWikiSession mdlWikiSession) {
	this.userId = userId;
     ...
     * @hibernate.column name="mdlwiki_session_uid"
     * 
     */
    public MdlWikiSession getMdlWikiSession() {
	return this.mdlWikiSession;
    }

    public void setMdlWikiSession(MdlWikiSession mdlWikiSession) {
	this.mdlWikiSession = mdlWikiSession;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlWikiUser))
	    return false;
	MdlWikiUser castOther = (MdlWikiUser) other;
