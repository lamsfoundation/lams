...
package org.lamsfoundation.lams.tool.mdwiki.model;
...
/**
 * @hibernate.class table="tl_mdwiki10_mdlwiki"
 */

public class MdlWiki implements java.io.Serializable, Cloneable {
    ...
    static Logger log = Logger.getLogger(MdlWiki.class.getName());
    ...
    private Set<MdlWikiSession> mdlWikiSessions;
    ...
    public MdlWiki(Long uid, Date createDate, Date updateDate, boolean defineLater, boolean runOffline,
	    boolean contentInUse, Long toolContentId, Long extToolContentId, String extUsername, String extCourseId,
	    String extSection, Set<MdlWikiSession> mdlWikiSessions, IToolContentHandler toolContentHandler) {
	super();
	this.uid = uid;
	...
	this.mdlWikiSessions = mdlWikiSessions;
     ...
     * @hibernate.collection-key column="mdlwiki_uid"
     * @hibernate.collection-one-to-many class="org.lamsfoundation.lams.tool.mdwiki.model.MdlWikiSession"
     * 
     */
    public Set<MdlWikiSession> getMdlWikiSessions() {
	return mdlWikiSessions;
    }

    public void setMdlWikiSessions(Set<MdlWikiSession> mdlWikiSessions) {
	this.mdlWikiSessions = mdlWikiSessions;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlWiki))
	    return false;
	MdlWiki castOther = (MdlWiki) other;
    ...
    public static MdlWiki newInstance(MdlWiki fromContent, Long toContentId,
	    IToolContentHandler mdlWikiToolContentHandler) {
	MdlWiki toContent = new MdlWiki();
	fromContent.toolContentHandler = mdlWikiToolContentHandler;
	toContent = (MdlWiki) fromContent.clone();
	...
	MdlWiki mdlWiki = null;
	try {
	    mdlWiki = (MdlWiki) super.clone();
	    mdlWiki.setUid(null);
	    mdlWiki.mdlWikiSessions = new HashSet<MdlWikiSession>();

	} catch (CloneNotSupportedException cnse) {
	    log.error("Error cloning " + MdlWiki.class);
	}
	return mdlWiki;
    }
