...
public interface MdlWikiConstants {
    public static final String TOOL_SIGNATURE = "mdwiki10";

    // MdlWiki session status
    ...
    public static final String RELATIVE_SERVLET_URL = "mod/lamstwo/tooladapter_wiki.php";
}
