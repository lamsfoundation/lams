...
<html>
	...
	<body class="stripes">
			...
			<html:form action="/mdscrm10admin" styleId="mdscrm10AdminForm" method="post" enctype="multipart/form-data">
				...
				<html:hidden property="dispatch" value="saveContent" />
	                ...
	                <logic:iterate name="mdscrm10AdminForm" property="mappableServers" id="mappableServer">
