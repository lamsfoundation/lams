...
package org.lamsfoundation.lams.tool.mdscrm.model;
...
/**
 * @hibernate.class table="tl_mdscrm10_mdlscorm"
 */

public class MdlScorm implements java.io.Serializable, Cloneable {
    ...
    static Logger log = Logger.getLogger(MdlScormService.class.getName());
    ...
    private Set<MdlScormSession> mdlScormSessions;
    ...
    public MdlScorm(Long uid, Date createDate, Date updateDate, boolean defineLater, boolean runOffline,
	    boolean contentInUse, Long toolContentId, Long extToolContentId, String extUsername, String extCourseId,
	    String extSection, Set<MdlScormSession> mdlScormSessions, IToolContentHandler toolContentHandler) {
	super();
	this.uid = uid;
	...
	this.mdlScormSessions = mdlScormSessions;
     ...
     * @hibernate.collection-one-to-many class="org.lamsfoundation.lams.tool.mdscrm.model.MdlScormSession"
     * 
     */
    public Set<MdlScormSession> getMdlScormSessions() {
	return mdlScormSessions;
    }

    public void setMdlScormSessions(Set<MdlScormSession> mdlScormSessions) {
	this.mdlScormSessions = mdlScormSessions;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlScorm))
	    return false;
	MdlScorm castOther = (MdlScorm) other;
    ...
    public static MdlScorm newInstance(MdlScorm fromContent, Long toContentId,
	    IToolContentHandler mdlScormToolContentHandler) {
	MdlScorm toContent = new MdlScorm();
	fromContent.toolContentHandler = mdlScormToolContentHandler;
	toContent = (MdlScorm) fromContent.clone();
	...
	MdlScorm mdlScorm = null;
	try {
	    mdlScorm = (MdlScorm) super.clone();
	    mdlScorm.setUid(null);
	    mdlScorm.mdlScormSessions = new HashSet<MdlScormSession>();

	} catch (CloneNotSupportedException cnse) {
	    log.error("Error cloning " + MdlScorm.class);
	}
	return mdlScorm;
    }
