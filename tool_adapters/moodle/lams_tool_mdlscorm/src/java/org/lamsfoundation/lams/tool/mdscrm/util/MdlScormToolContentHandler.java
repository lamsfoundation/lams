 ...
 */
public class MdlScormToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "mdlScormworkspace";

    public static String repositoryUser = "mdlScorm";
     ...
     * 
     */
    public MdlScormToolContentHandler() {
	super();
    }
