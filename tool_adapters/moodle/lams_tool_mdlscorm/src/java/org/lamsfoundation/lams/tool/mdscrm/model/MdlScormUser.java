 ...
 * 
 * @hibernate.class table="tl_mdscrm10_user"
 */

public class MdlScormUser implements java.io.Serializable {
    ...
    private MdlScormSession mdlScormSession;
    ...
    public MdlScormUser(UserDTO user, MdlScormSession mdlScormSession) {
	this.userId = new Long(user.getUserID().intValue());
	this.firstName = user.getFirstName();
	this.lastName = user.getLastName();
	this.loginName = user.getLogin();
	this.mdlScormSession = mdlScormSession;
	this.finishedActivity = false;
    }

    /** full constructor */
    public MdlScormUser(Long userId, String lastName, String firstName, MdlScormSession mdlScormSession) {
	this.userId = userId;
     ...
     * @hibernate.column name="mdlscorm_session_uid"
     * 
     */
    public MdlScormSession getMdlScormSession() {
	return this.mdlScormSession;
    }

    public void setMdlScormSession(MdlScormSession mdlScormSession) {
	this.mdlScormSession = mdlScormSession;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlScormUser))
	    return false;
	MdlScormUser castOther = (MdlScormUser) other;
