...
public interface MdlAssignmentConstants {
    public static final String TOOL_SIGNATURE = "mdasgm10";

    // MdlAssignment session status
    ...
    public static final String RELATIVE_SERVLET_URL = "mod/lamstwo/tooladapter_assignment.php";
}
