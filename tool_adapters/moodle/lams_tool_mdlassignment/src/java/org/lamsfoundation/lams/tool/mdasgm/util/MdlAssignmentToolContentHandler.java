 ...
 */
public class MdlAssignmentToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "mdlAssignmentworkspace";

    public static String repositoryUser = "mdlAssignment";
     ...
     * 
     */
    public MdlAssignmentToolContentHandler() {
	super();
    }
