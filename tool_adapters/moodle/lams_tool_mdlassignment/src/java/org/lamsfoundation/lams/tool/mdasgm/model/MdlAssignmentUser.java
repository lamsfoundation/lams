 ...
 * 
 * @hibernate.class table="tl_mdasgm10_user"
 */

public class MdlAssignmentUser implements java.io.Serializable {
    ...
    private MdlAssignmentSession mdlAssignmentSession;
    ...
    /** default constructor */
    public MdlAssignmentUser() {
    }

    public MdlAssignmentUser(UserDTO user, MdlAssignmentSession mdlAssignmentSession) {
	this.userId = new Long(user.getUserID().intValue());
	this.firstName = user.getFirstName();
	this.lastName = user.getLastName();
	this.loginName = user.getLogin();
	this.mdlAssignmentSession = mdlAssignmentSession;
	this.finishedActivity = false;
    }

    /** full constructor */
    public MdlAssignmentUser(Long userId, String lastName, String firstName, MdlAssignmentSession mdlAssignmentSession) {
	this.userId = userId;
     ...
     * @hibernate.column name="mdlassignment_session_uid"
     * 
     */
    public MdlAssignmentSession getMdlAssignmentSession() {
	return this.mdlAssignmentSession;
    }

    public void setMdlAssignmentSession(MdlAssignmentSession mdlAssignmentSession) {
	this.mdlAssignmentSession = mdlAssignmentSession;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlAssignmentUser))
	    return false;
	MdlAssignmentUser castOther = (MdlAssignmentUser) other;
