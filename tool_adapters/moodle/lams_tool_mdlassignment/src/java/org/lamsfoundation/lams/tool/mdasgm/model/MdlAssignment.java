...
package org.lamsfoundation.lams.tool.mdasgm.model;
...
import org.lamsfoundation.lams.tool.mdasgm.service.MdlAssignmentService;

/**
 * @hibernate.class table="tl_mdasgm10_mdlassignment"
 */

public class MdlAssignment implements java.io.Serializable, Cloneable {
    ...
    static Logger log = Logger.getLogger(MdlAssignmentService.class.getName());
    ...
    private Set<MdlAssignmentSession> mdlAssignmentSessions;
    ...
    public MdlAssignment(Long uid, Date createDate, Date updateDate, boolean defineLater, boolean runOffline,
	    boolean contentInUse, Long toolContentId, Long extToolContentId, String extUsername, String extCourseId,
	    String extSection, Set<MdlAssignmentSession> mdlAssignmentSessions, IToolContentHandler toolContentHandler) {
	super();
	this.uid = uid;
	...
	this.mdlAssignmentSessions = mdlAssignmentSessions;
     ...
     * @hibernate.collection-key column="mdlassignment_uid"
     * @hibernate.collection-one-to-many class="org.lamsfoundation.lams.tool.mdasgm.model.MdlAssignmentSession"
     * 
     */
    public Set<MdlAssignmentSession> getMdlAssignmentSessions() {
	return mdlAssignmentSessions;
    }

    public void setMdlAssignmentSessions(Set<MdlAssignmentSession> mdlAssignmentSessions) {
	this.mdlAssignmentSessions = mdlAssignmentSessions;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlAssignment))
	    return false;
	MdlAssignment castOther = (MdlAssignment) other;
    ...
    public static MdlAssignment newInstance(MdlAssignment fromContent, Long toContentId,
	    IToolContentHandler mdlAssignmentToolContentHandler) {
	MdlAssignment toContent = new MdlAssignment();
	fromContent.toolContentHandler = mdlAssignmentToolContentHandler;
	toContent = (MdlAssignment) fromContent.clone();
	...
	MdlAssignment mdlAssignment = null;
	try {
	    mdlAssignment = (MdlAssignment) super.clone();
	    mdlAssignment.setUid(null);
	    mdlAssignment.mdlAssignmentSessions = new HashSet<MdlAssignmentSession>();

	} catch (CloneNotSupportedException cnse) {
	    log.error("Error cloning " + MdlAssignment.class);
	}
