...
<html>
	...
	<body class="stripes">
			...
			<html:form action="/mdlesn10admin" styleId="mdlesn10AdminForm" method="post" enctype="multipart/form-data">
				
				<html:hidden property="dispatch" value="saveContent" />
					<h3>
	                        <fmt:message key="admin.enableForIntegratedServers" />
	                </h3>
	                <logic:iterate name="mdlesn10AdminForm" property="mappableServers" id="mappableServer">
