...
package org.lamsfoundation.lams.tool.mdlesn.model;
...
/**
 * @hibernate.class table="tl_mdlesn10_mdllesson"
 */

public class MdlLesson implements java.io.Serializable, Cloneable {
    ...
    static Logger log = Logger.getLogger(MdlLesson.class.getName());
    ...
    private Set<MdlLessonSession> mdlLessonSessions;
    ...
    public MdlLesson(Long uid, Date createDate, Date updateDate, boolean defineLater, boolean runOffline,
	    boolean contentInUse, Long toolContentId, Long extToolContentId, String extUsername, String extCourseId,
	    String extSection, Set<MdlLessonSession> mdlLessonSessions, IToolContentHandler toolContentHandler) {
	super();
	this.uid = uid;
	...
	this.mdlLessonSessions = mdlLessonSessions;
     ...
     * @hibernate.collection-one-to-many class="org.lamsfoundation.lams.tool.mdlesn.model.MdlLessonSession"
     * 
     */
    public Set<MdlLessonSession> getMdlLessonSessions() {
	return mdlLessonSessions;
    }

    public void setMdlLessonSessions(Set<MdlLessonSession> mdlLessonSessions) {
	this.mdlLessonSessions = mdlLessonSessions;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlLesson))
	    return false;
	MdlLesson castOther = (MdlLesson) other;
    ...
    public static MdlLesson newInstance(MdlLesson fromContent, Long toContentId,
	    IToolContentHandler mdlLessonToolContentHandler) {
	MdlLesson toContent = new MdlLesson();
	fromContent.toolContentHandler = mdlLessonToolContentHandler;
	toContent = (MdlLesson) fromContent.clone();
	...
	MdlLesson mdlLesson = null;
	try {
	    mdlLesson = (MdlLesson) super.clone();
	    mdlLesson.setUid(null);
	    mdlLesson.mdlLessonSessions = new HashSet<MdlLessonSession>();

	} catch (CloneNotSupportedException cnse) {
	    log.error("Error cloning " + MdlLesson.class);
	}
	return mdlLesson;
    }
