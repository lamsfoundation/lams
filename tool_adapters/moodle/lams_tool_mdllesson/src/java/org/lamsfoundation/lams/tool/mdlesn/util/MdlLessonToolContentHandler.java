 ...
 */
public class MdlLessonToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "mdlLessonworkspace";

    public static String repositoryUser = "mdlLesson";
     ...
     * 
     */
    public MdlLessonToolContentHandler() {
	super();
    }
