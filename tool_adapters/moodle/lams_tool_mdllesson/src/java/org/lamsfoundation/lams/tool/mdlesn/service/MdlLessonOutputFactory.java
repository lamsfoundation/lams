...
public class MdlLessonOutputFactory extends OutputFactory {
	...
	if (names == null || names.contains(OUTPUT_NAME_LEARNER_NUM_POSTS)) {
	    map.put(OUTPUT_NAME_LEARNER_NUM_POSTS, getExtToolOutput(OUTPUT_NAME_LEARNER_NUM_POSTS, dlLessonService,
		    mdlLesson, learnerId, extSessionId.toString(), toolSessionId));
	}
	if (names.contains(OUTPUT_NAME_LEARNER_NUM_ENTRIES)) {
	    map.put(OUTPUT_NAME_LEARNER_NUM_ENTRIES, getExtToolOutput(OUTPUT_NAME_LEARNER_NUM_ENTRIES, dlLessonService,
		    mdlLesson, learnerId, extSessionId.toString(), toolSessionId));
	}
	return map;
    ...
    public ToolOutput getExtToolOutput(String outputName, IMdlLessonService mdlLessonService, MdlLesson mdlLesson,
