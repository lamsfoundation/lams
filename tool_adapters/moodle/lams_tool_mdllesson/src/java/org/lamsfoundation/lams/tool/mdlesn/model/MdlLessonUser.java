 ...
 * 
 * @hibernate.class table="tl_mdlesn10_user"
 */

public class MdlLessonUser implements java.io.Serializable {
    ...
    private MdlLessonSession mdlLessonSession;
    ...
    /** default constructor */
    public MdlLessonUser() {
    }

    public MdlLessonUser(UserDTO user, MdlLessonSession mdlLessonSession) {
	this.userId = new Long(user.getUserID().intValue());
	this.firstName = user.getFirstName();
	this.lastName = user.getLastName();
	this.loginName = user.getLogin();
	this.mdlLessonSession = mdlLessonSession;
	this.finishedActivity = false;
    }

    /** full constructor */
    public MdlLessonUser(Long userId, String lastName, String firstName, MdlLessonSession mdlLessonSession) {
	this.userId = userId;
     ...
     * @hibernate.column name="mdllesson_session_uid"
     * 
     */
    public MdlLessonSession getMdlLessonSession() {
	return this.mdlLessonSession;
    }

    public void setMdlLessonSession(MdlLessonSession mdlLessonSession) {
	this.mdlLessonSession = mdlLessonSession;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlLessonUser))
	    return false;
	MdlLessonUser castOther = (MdlLessonUser) other;
