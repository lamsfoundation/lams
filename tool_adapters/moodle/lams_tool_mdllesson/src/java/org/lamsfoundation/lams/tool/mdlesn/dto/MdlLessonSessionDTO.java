...
public class MdlLessonSessionDTO implements Comparable {
    ...
    Set<MdlLessonUserDTO> userDTOs = new TreeSet<MdlLessonUserDTO>();
    ...
    public MdlLessonSessionDTO(MdlLessonSession session) {
	...
	/*
	for (Iterator iterator = session.getMdlLessonUsers().iterator(); iterator.hasNext();) {
		MdlLessonUser user = (MdlLessonUser) iterator.next();
		MdlLessonUserDTO userDTO = new MdlLessonUserDTO(user);
	...
	*/
	...
	int returnValue;
	MdlLessonSessionDTO toSession = (MdlLessonSessionDTO) o;
    ...
    public Set<MdlLessonUserDTO> getUserDTOs() {
	return userDTOs;
    }

    public void setUserDTOs(Set<MdlLessonUserDTO> mdlLessonUsers) {
	this.userDTOs = mdlLessonUsers;
    }
