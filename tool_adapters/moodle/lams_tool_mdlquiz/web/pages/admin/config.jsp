...
<html>
	...
	<body class="stripes">
			...
			<html:form action="/mdquiz10admin" styleId="mdquiz10AdminForm" method="post" enctype="multipart/form-data">
				...
				<table class="alternative-color">
	                ...
	                <logic:iterate name="mdquiz10AdminForm" property="mappableServers" id="mappableServer">
