...
public interface MdlQuizConstants {
    public static final String TOOL_SIGNATURE = "mdquiz10";

    // MdlQuiz session status
    ...
    public static final String RELATIVE_SERVLET_URL = "mod/lamstwo/tooladapter_quiz.php";
}
