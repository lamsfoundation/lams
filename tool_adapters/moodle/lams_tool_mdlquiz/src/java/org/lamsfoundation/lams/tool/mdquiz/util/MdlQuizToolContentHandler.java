 ...
 */
public class MdlQuizToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "mdlQuizworkspace";

    public static String repositoryUser = "mdlQuiz";
     ...
     * 
     */
    public MdlQuizToolContentHandler() {
	super();
    }
