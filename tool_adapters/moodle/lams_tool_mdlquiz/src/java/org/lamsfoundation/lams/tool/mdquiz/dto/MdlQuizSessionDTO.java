...
public class MdlQuizSessionDTO implements Comparable {
    ...
    Set<MdlQuizUserDTO> userDTOs = new TreeSet<MdlQuizUserDTO>();
    ...
    public MdlQuizSessionDTO(MdlQuizSession session) {
	...
	/*
	for (Iterator iterator = session.getMdlQuizUsers().iterator(); iterator.hasNext();) {
		MdlQuizUser user = (MdlQuizUser) iterator.next();
		MdlQuizUserDTO userDTO = new MdlQuizUserDTO(user);
	...
	*/
	...
	int returnValue;
	MdlQuizSessionDTO toSession = (MdlQuizSessionDTO) o;
    ...
    public Set<MdlQuizUserDTO> getUserDTOs() {
	return userDTOs;
    }

    public void setUserDTOs(Set<MdlQuizUserDTO> mdlQuizUsers) {
	this.userDTOs = mdlQuizUsers;
    }
