 ...
 * 
 * @hibernate.class table="tl_mdquiz10_user"
 */

public class MdlQuizUser implements java.io.Serializable {
    ...
    private MdlQuizSession mdlQuizSession;
    ...
    public MdlQuizUser(UserDTO user, MdlQuizSession mdlQuizSession) {
	this.userId = new Long(user.getUserID().intValue());
	this.firstName = user.getFirstName();
	this.lastName = user.getLastName();
	this.loginName = user.getLogin();
	this.mdlQuizSession = mdlQuizSession;
	this.finishedActivity = false;
    }

    /** full constructor */
    public MdlQuizUser(Long userId, String lastName, String firstName, MdlQuizSession mdlQuizSession) {
	this.userId = userId;
     ...
     * @hibernate.column name="mdlquiz_session_uid"
     * 
     */
    public MdlQuizSession getMdlQuizSession() {
	return this.mdlQuizSession;
    }

    public void setMdlQuizSession(MdlQuizSession mdlQuizSession) {
	this.mdlQuizSession = mdlQuizSession;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlQuizUser))
	    return false;
	MdlQuizUser castOther = (MdlQuizUser) other;
