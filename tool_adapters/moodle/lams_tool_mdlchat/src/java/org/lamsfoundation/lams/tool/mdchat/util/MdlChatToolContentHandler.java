 ...
 */
public class MdlChatToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "mdlChatworkspace";

    public static String repositoryUser = "mdlChat";
     ...
     * 
     */
    public MdlChatToolContentHandler() {
	super();
    }
