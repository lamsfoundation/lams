 ...
 * 
 * @hibernate.class table="tl_mdchat10_user"
 */

public class MdlChatUser implements java.io.Serializable {
    ...
    private MdlChatSession mdlChatSession;
    ...
    public MdlChatUser(UserDTO user, MdlChatSession mdlChatSession) {
	this.userId = new Long(user.getUserID().intValue());
	this.firstName = user.getFirstName();
	this.lastName = user.getLastName();
	this.loginName = user.getLogin();
	this.mdlChatSession = mdlChatSession;
	this.finishedActivity = false;
    }

    /** full constructor */
    public MdlChatUser(Long userId, String lastName, String firstName, MdlChatSession mdlChatSession) {
	this.userId = userId;
     ...
     * @hibernate.column name="mdlchat_session_uid"
     * 
     */
    public MdlChatSession getMdlChatSession() {
	return this.mdlChatSession;
    }

    public void setMdlChatSession(MdlChatSession mdlChatSession) {
	this.mdlChatSession = mdlChatSession;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlChatUser))
	    return false;
	MdlChatUser castOther = (MdlChatUser) other;
