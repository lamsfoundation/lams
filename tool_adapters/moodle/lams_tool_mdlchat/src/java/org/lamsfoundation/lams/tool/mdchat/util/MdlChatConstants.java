...
public interface MdlChatConstants {
    public static final String TOOL_SIGNATURE = "mdchat10";

    // MdlChat session status
    ...
    public static final String RELATIVE_SERVLET_URL = "mod/lamstwo/tooladapter_chat.php";
}
