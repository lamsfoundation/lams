...
package org.lamsfoundation.lams.tool.mdchat.model;
...
/**
 * @hibernate.class table="tl_mdchat10_mdlchat"
 */

public class MdlChat implements java.io.Serializable, Cloneable {
    ...
    static Logger log = Logger.getLogger(MdlChatService.class.getName());
    ...
    private Set<MdlChatSession> mdlChatSessions;
    ...
    public MdlChat(Long uid, Date createDate, Date updateDate, boolean defineLater, boolean runOffline,
	    boolean contentInUse, Long toolContentId, Long extToolContentId, String extUsername, String extCourseId,
	    String extSection, Set<MdlChatSession> mdlChatSessions, IToolContentHandler toolContentHandler) {
	super();
	this.uid = uid;
	...
	this.mdlChatSessions = mdlChatSessions;
     ...
     * @hibernate.collection-key column="mdlchat_uid"
     * @hibernate.collection-one-to-many class="org.lamsfoundation.lams.tool.mdchat.model.MdlChatSession"
     * 
     */
    public Set<MdlChatSession> getMdlChatSessions() {
	return mdlChatSessions;
    }

    public void setMdlChatSessions(Set<MdlChatSession> mdlChatSessions) {
	this.mdlChatSessions = mdlChatSessions;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof MdlChat))
	    return false;
	MdlChat castOther = (MdlChat) other;
    ...
    public static MdlChat newInstance(MdlChat fromContent, Long toContentId,
	    IToolContentHandler mdlChatToolContentHandler) {
	MdlChat toContent = new MdlChat();
	fromContent.toolContentHandler = mdlChatToolContentHandler;
	toContent = (MdlChat) fromContent.clone();
	...
	MdlChat mdlChat = null;
	try {
	    mdlChat = (MdlChat) super.clone();
	    mdlChat.setUid(null);
	    mdlChat.mdlChatSessions = new HashSet<MdlChatSession>();

	} catch (CloneNotSupportedException cnse) {
	    log.error("Error cloning " + MdlChat.class);
	}
	return mdlChat;
    }
