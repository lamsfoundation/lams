...
public class MdlChatDTO {
    ...
    public Set<MdlChatSessionDTO> sessionDTOs = new TreeSet<MdlChatSessionDTO>();
    ...
    public MdlChatDTO(MdlChat mdlChat) {
	uid = mdlChat.getUid();
	createDate = mdlChat.getCreateDate();
	updateDate = mdlChat.getUpdateDate();
	defineLater = mdlChat.isDefineLater();
	toolContentId = mdlChat.getToolContentId();
	extToolContentId = mdlChat.getExtToolContentId();
	extUsername = mdlChat.getExtUsername();
	extCourseId = mdlChat.getExtCourseId();
	extSection = mdlChat.getExtSection();
	for (Iterator<MdlChatSession> iter = mdlChat.getMdlChatSessions().iterator(); iter.hasNext();) {
	    MdlChatSession session = (MdlChatSession) iter.next();
	    MdlChatSessionDTO sessionDTO = new MdlChatSessionDTO(session);
    ...
    /* Getters / Setters */
    public Set<MdlChatSessionDTO> getSessionDTOs() {
	return sessionDTOs;
    }

    public void setSessionDTOs(Set<MdlChatSessionDTO> sessionDTOs) {
