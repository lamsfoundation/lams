...
alter table tl_mdchat10_session add index FKmdchat10_session (mdlChat_uid), add constraint FKmdchat10_session foreign key (mdlChat_uid) references tl_mdchat10_user (uid);
