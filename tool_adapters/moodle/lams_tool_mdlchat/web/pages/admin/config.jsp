...
<html>
	...
	<body class="stripes">
			...
			<html:form action="/mdchat10admin" styleId="mdchat10AdminForm" method="post" enctype="multipart/form-data">
				
				<html:hidden property="dispatch" value="saveContent" />
				<h3>
                        <fmt:message key="admin.enableForIntegratedServers" />
                </h3>
                <logic:iterate name="mdchat10AdminForm" property="mappableServers" id="mappableServer">
