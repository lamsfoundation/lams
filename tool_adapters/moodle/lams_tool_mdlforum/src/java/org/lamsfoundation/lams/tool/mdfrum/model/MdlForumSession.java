...
public class MdlForumSession implements java.io.Serializable {
    ...
    /** full constructor */
    public MdlForumSession(Date sessionEndDate, Date sessionStartDate, Integer status, Long sessionId,
	    Long extSessionId, String sessionName, MdlForum mdlForum, Set mdlForumUsers) {
