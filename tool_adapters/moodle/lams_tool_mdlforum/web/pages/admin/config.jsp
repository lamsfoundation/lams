...
<html>
	...
	<body class="stripes">
			...
			<html:form action="/mdfrum10admin" styleId="mdfrum10AdminForm" method="post" enctype="multipart/form-data">
				...
				<logic:iterate name="mdfrum10AdminForm" property="mappableServers" id="mappableServer">
