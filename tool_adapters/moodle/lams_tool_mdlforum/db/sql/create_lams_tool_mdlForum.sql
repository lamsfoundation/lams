...
alter table tl_mdfrum10_session add index FKmdfrum10_session (mdlForum_uid), add constraint FKmdfrum10_session foreign key (mdlforum_uid) references tl_mdfrum10_mdlforum (uid);
