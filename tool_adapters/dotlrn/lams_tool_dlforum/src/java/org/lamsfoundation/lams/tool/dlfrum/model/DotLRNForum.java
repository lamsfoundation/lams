...
public class DotLRNForum implements java.io.Serializable, Cloneable {
	...
	private Set<DotLRNForumSession> dotLRNForumSessions;
	...
	public DotLRNForum(Long uid, Date createDate, Date updateDate,
			...
			Set<DotLRNForumSession> dotLRNForumSessions,
	 ...
	 * 
	 */
	public Set<DotLRNForumSession> getDotLRNForumSessions() {
		return dotLRNForumSessions;
	}

	public void setDotLRNForumSessions(Set<DotLRNForumSession> dotLRNForumSessions) {
		this.dotLRNForumSessions = dotLRNForumSessions;
	}
	...
	protected Object clone() {
		...
		try {
			...
			dotLRNForum.dotLRNForumSessions = new HashSet<DotLRNForumSession>();
