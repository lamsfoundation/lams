...
public interface QaAppConstants {
    ...
    public static final String TEXT_SEARCH_DEFINITION_NAME = "text.search.output.definition";
    public static final String TEXT_SEARCH_DEFAULT_CONDITION_DISPLAY_NAME_KEY = "text.search.output.definition.default.condition";
}
