...
public class QaUploadedFile implements Serializable, Comparable {
    ...
    /** full constructor */
    public QaUploadedFile(Long submissionId, String uuid, boolean fileOnline, String fileName, QaContent qaContent) {
	...
	newMcUploadedFile = new QaUploadedFile(qaUploadedFile.getUuid(), qaUploadedFile.isFileOnline(), qaUploadedFile
		.getFileName(), newMcContent);
	...
	if (!(other instanceof QaUploadedFile))
	    return false;
