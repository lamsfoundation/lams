...
ALTER IGNORE TABLE tl_laqa11_que_content DROP FOREIGN KEY FK_tl_laqa11_que_content_1;
...
ALTER IGNORE TABLE tl_laqa11_que_usr DROP FOREIGN KEY FK_tl_laqa11_que_usr_1;
...
ALTER IGNORE TABLE tl_laqa11_session DROP FOREIGN KEY FK_laqa11_session1;
...
ALTER IGNORE TABLE tl_laqa11_session DROP FOREIGN KEY FK_tl_laqa11_session_1;
...
ALTER IGNORE TABLE tl_laqa11_usr_resp DROP FOREIGN KEY FK_tl_laqa11_usr_resp_2;
...
ALTER IGNORE TABLE tl_laqa11_usr_resp DROP FOREIGN KEY FK_tl_laqa11_usr_resp_3;
...
ALTER IGNORE TABLE tl_laqa11_wizard_cognitive_skill DROP FOREIGN KEY FK3BA4132BCBB0DC8D;
...
ALTER IGNORE TABLE tl_laqa11_wizard_question DROP FOREIGN KEY FKAF08A0C7EFF77FD4;
