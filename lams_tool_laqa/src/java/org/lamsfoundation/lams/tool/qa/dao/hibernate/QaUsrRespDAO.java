...
public class QaUsrRespDAO extends LAMSBaseDAO implements IQaUsrRespDAO {
	...
	if ( useAverageRatingSort ) {
	    ...
	    query = getSessionFactory().getCurrentSession()
		    .createQuery(LOAD_ATTEMPT_FOR_SESSION_AND_QUESTION_LIMIT_WITH_NAME_SEARCH+sortingOrder);
	}
	...
	List list = doFind(GET_COUNT_RESPONSES_FOR_SESSION_AND_QUESTION_WITH_NAME_SEARCH,
