...
public class QaStarterAction extends Action implements QaAppConstants {
	...
	if (getServlet() == null || getServlet().getServletContext() == null) {
	    QaStarterAction.logger.debug("obtaining qaService from the form");
	...
	SortedSet<QaCondition> conditionList = getTaskListConditionList(sessionMap);
	conditionList.clear();
	...
	SortedSet<QaCondition> conditionSet = new TreeSet<QaCondition>(
	...
	QaStarterAction.logger.debug("add " + message + "  to ActionMessages:");
	saveErrors(request, errors);
    }

    private SortedSet<QaCondition> getTaskListConditionList(
	    SessionMap sessionMap) {
	SortedSet<QaCondition> list = (SortedSet<QaCondition>) sessionMap
