		...
		<tr> <td>
			<table>
				<tr> 
			 		...
			 		<td> 
			 			<html:text property="title" size="60" maxlength="100" value="${sessionScope.title}" />
			 		</td>
			  	</tr>
			  	<tr> 
			 		<td> <bean:message key="label.authoring.instructions"/>: </td>
			 		<td> 
			 			<html:text property="instructions" size="60" maxlength="255" value="${sessionScope.instructions}" />
			 		</td>
			  	</tr>
	 		...
	 		<!--default question content, this entry can not be deleted but can be updated -->
			 		...
			 		<tr> 
					  	<td> 
					  		<bean:message key="label.question1"/> : </td>
					  		<td>
