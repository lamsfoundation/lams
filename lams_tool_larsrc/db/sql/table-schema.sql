...
create table tl_larsrc11_user (uid bigint not null auto_increment, user_id bigint, last_name varchar(255), first_name varchar(255), login_name varchar(255), session_uid bigint, content_uid bigint, session_finished bit, primary key (uid));
...
alter table tl_larsrc11_user add index FK30113BFC309ED320 (content_uid), add constraint FK30113BFC309ED320 foreign key (content_uid) references tl_larsrc11_resource (uid);
