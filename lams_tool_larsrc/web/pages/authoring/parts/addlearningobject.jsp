		...
		<table class="forms">
			...
			<tr>
				<td align="center" valign="bottom">
					<a href="#" onclick="submitResourceItem()" class="button-add-item"><fmt:message key="label.authoring.basic.add.learning.object" /></a> <a href="javascript:;" onclick="cancelResourceItem()" class="button"><fmt:message key="label.cancel" /></a> 
				</td>
			</tr>
			<tr>
				<td>
