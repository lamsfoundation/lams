		...
		<table class="forms">
			...
			<tr>
				<td align="center" valign="bottom">
					<a href="javascript:;" onclick="cancelResourceItem()" class="button"><fmt:message key="label.cancel" /></a> <a href="#" onclick="submitResourceItem()" class="button"><fmt:message key="label.authoring.basic.add.learning.object" /></a>
				</td>
			</tr>
			<tr>
				<td>
