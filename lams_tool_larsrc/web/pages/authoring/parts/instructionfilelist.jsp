			...
			<c:if test="${targetFileType == file.fileType}">
				<tr>
					...
					<td width="80px" align="center">
						...
						<html:link href="javascript:launchPopup('${viewURL}','instructionfile')" styleClass="button">
					...
					<td width="80px" align="center">
						<c:choose>
							<c:when test="${fileTypeFlag==CONS_OFFLINE}">
								<a href="#" onclick="deleteOfflineFile(${file.fileUuid},${file.fileVersionId})" class="button">
									<fmt:message key="label.authoring.offline.delete"/>
								</a>
							</c:when>
							<c:otherwise>
								<a href="#" onclick="deleteOnlineFile(${file.fileUuid},${file.fileVersionId})" class="button">
