...
public class ResourceServiceProxy {
	...
	return (IResourceService) ResourceServiceProxy.getResourceDomainService(servletContext);
    }

    public static final ToolSessionManager getSessionManager(ServletContext servletContext) {
	return (ToolSessionManager) ResourceServiceProxy.getResourceDomainService(servletContext);
    }

    public static final ToolContentManager getContentManager(ServletContext servletContext) {
	return (ToolContentManager) ResourceServiceProxy.getResourceDomainService(servletContext);
    }
