...
ALTER IGNORE TABLE tl_larsrc11_item_instruction DROP FOREIGN KEY FKA5665013980570ED;
...
ALTER IGNORE TABLE tl_larsrc11_item_log DROP FOREIGN KEY FK693580A438BF8DFE;
ALTER TABLE tl_larsrc11_item_log ADD CONSTRAINT FK693580A438BF8DFE FOREIGN KEY (`resource_item_uid`)
REFERENCES `tl_larsrc11_resource_item` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_larsrc11_item_log DROP FOREIGN KEY FK693580A441F9365D;
...
ALTER IGNORE TABLE tl_larsrc11_resource DROP FOREIGN KEY FK89093BF758092FB;
...
ALTER IGNORE TABLE tl_larsrc11_resource_item DROP FOREIGN KEY FKF52D1F9330E79035;
...
ALTER IGNORE TABLE tl_larsrc11_resource_item DROP FOREIGN KEY FKF52D1F93758092FB;
ALTER TABLE tl_larsrc11_resource_item ADD CONSTRAINT FKF52D1F93758092FB FOREIGN KEY (`create_by`)
REFERENCES `tl_larsrc11_user` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_larsrc11_resource_item DROP FOREIGN KEY FKF52D1F93EC0D3147;
...
ALTER IGNORE TABLE tl_larsrc11_session DROP FOREIGN KEY FK24AA78C530E79035;
ALTER TABLE tl_larsrc11_session ADD CONSTRAINT FK24AA78C530E79035 FOREIGN KEY (`resource_uid`)
REFERENCES `tl_larsrc11_resource` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_larsrc11_user DROP FOREIGN KEY FK30113BFCEC0D3147;
ALTER TABLE tl_larsrc11_user ADD CONSTRAINT FK30113BFCEC0D3147 FOREIGN KEY (`session_uid`)
REFERENCES `tl_larsrc11_session` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_larsrc11_user DROP FOREIGN KEY FK30113BFC309ED320;
