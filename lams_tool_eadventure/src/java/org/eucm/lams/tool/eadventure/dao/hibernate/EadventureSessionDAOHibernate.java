...
public class EadventureSessionDAOHibernate extends BaseDAOHibernate implements EadventureSessionDAO {
    ...
    private static final String FIND_BY_SESSION_ID = "from " + EadventureSession.class.getName()
	    + " as p where p.sessionId=?";
    private static final String FIND_BY_CONTENT_ID = "from " + EadventureSession.class.getName()
	    + " as p where p.eadventure.contentId=?";
