...
ALTER TABLE tl_eueadv10_condition DROP FOREIGN KEY FK_NEW_1226715514_5656683026352999;
...
ALTER TABLE tl_eueadv10_condition_expression DROP FOREIGN KEY FK_NEW_1226715514_5656683026352390;
...
ALTER TABLE tl_eueadv10_condition_expression DROP FOREIGN KEY FK_NEW_1226715514_5656683026352EEE;
...
ALTER TABLE tl_eueadv10_condition_expression DROP FOREIGN KEY FK_NEW_1226715514_5656683026352FFF;
...
ALTER TABLE tl_eueadv10_item_log DROP FOREIGN KEY FK_NEW_1226715514_693580A438BF8DFE;
ALTER TABLE tl_eueadv10_item_log ADD CONSTRAINT FK_NEW_1226715514_693580A438BF8DFE FOREIGN KEY (`eadventure_item_uid`)
REFERENCES `tl_eueadv10_eadventure` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE tl_eueadv10_item_log DROP FOREIGN KEY FK_NEW_1226715514_693580A441F9365D;
...
ALTER TABLE tl_eueadv10_param DROP FOREIGN KEY FK_NEW_1226715514_56566830263527E3;
...
ALTER TABLE tl_eueadv10_user DROP FOREIGN KEY FK_NEW_1226715514_30113BFC309ED320;
...
ALTER TABLE tl_eueadv10_var DROP FOREIGN KEY FK_NEW_1226715514_42637763767637E6;
