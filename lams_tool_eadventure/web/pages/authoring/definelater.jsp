...
<div id="content">
		...
		<div class="tabbody">
			...
			<!-- Button Row -->
			<lams:AuthoringButton formID="authoringForm" clearSessionActionUrl="/clearsession.do" toolSignature="<%=EadventureConstants.TOOL_SIGNATURE%>" 
				toolContentID="${formBean.eadventure.contentId}"  accessMode="teacher" defineLater="yes"  
