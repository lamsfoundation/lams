...
<table cellspacing="0">
	...
	<tr>
		<td colspan="3">
			...
			<div style="padding-left: 20px;">
				<c:out value="${eadventure.onlineInstructions}" escapeXml="false" />
			</div>
		</td>
	</tr>
	
	<c:if test="${not empty eadventure.onlineFileList}">
		<tr>
	...
	<c:forEach var="file" items="${eadventure.onlineFileList}">
		<tr >
	...
	<tr>
		<td colspan="3">
			...
			<div style="padding-left: 20px;">
				<c:out value="${eadventure.offlineInstructions}" escapeXml="false" />
			</div>
		</td>
	</tr>
	
	<c:if test="${not empty eadventure.offlineFileList}">
		<tr>
			<td  colspan="3" class="field-name-alternative-color">
				<fmt:message key="monitoring.label.attachments" />
			</td>
	...
	<c:forEach var="file" items="${eadventure.offlineFileList}">
		<tr >
			<td width="7%" style="padding-left: 30px;">			
				<c:out value="${file.fileName}" />
			</td>
