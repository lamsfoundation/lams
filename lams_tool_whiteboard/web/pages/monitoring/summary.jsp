...
<c:url var="timeLimitPanelUrl" value="${timeLimitPanelUrl}">
	...
	<c:param name="absoluteTimeLimitFinish" value="${whiteboard.absoluteTimeLimitFinishSeconds}"/>
	<c:param name="absoluteTimeLimit" value="${whiteboard.absoluteTimeLimit}"/>
				...
				ajaxProcessing: function (data, table) {
					...
					.bind('pagerInitialized pagerComplete', function(event, options){
						if ( options.totalRows == 0 ) {
							$.tablesorter.showError($(this), '<spring:escapeBody javaScriptEscape="true"><fmt:message key="messsage.monitoring.learner.marks.no.data"/></spring:escapeBody>');
						}
					});
		});
