...
package org.lamsfoundation.lams.tool.whiteboard;

public class WhiteboardConstants {
    public static final String TOOL_SIGNATURE = "lawhiteboard11";

    public static final String WHITEBOARD_SERVICE = "whiteboardService";

    public static final String TOOL_CONTENT_HANDLER_NAME = "whiteboardToolContentHandler";
    ...
    public static final String ATTR_RESOURCE_FORM = "whiteboardForm";
    ...
    public static final String KEY_WHITEBOARD_SERVER_URL = "whiteboardServerUrl";
