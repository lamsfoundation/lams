...
public class AdminForm {
    ...
    public void setWhiteboardServerUrl(String whiteboardServerUrl) {
	this.whiteboardServerUrl = whiteboardServerUrl;
    }

    public String getWhiteboardAccessToken() {
	return whiteboardAccessToken;
    }
