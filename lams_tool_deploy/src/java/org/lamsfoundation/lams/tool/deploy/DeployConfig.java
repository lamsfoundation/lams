...
public abstract class DeployConfig {   
     ...
     * @param configFilePath The file location of the configuration file deploy.xml.
     * @throws ParserConfigurationException
     * @throws IOException
     * @throws SAXException
     */
    public abstract void updateConfigurationProperties(String configFilePath) throws ParserConfigurationException, IOException, SAXException;
    ...
    */
     ...
     * @param xml The xml to deserialise
