...
create table tl_lasbmt11_content (content_id bigint not null, title varchar(64) not null, instruction text, define_later bit not null, run_offline bit not null, offline_instruction text, online_instruction text, content_in_use bit, lock_on_finished bit, reflect_instructions varchar(255), reflect_on_activity bit, primary key (content_id));
...
create table tl_lasbmt11_session_learners (learner_id bigint not null auto_increment, user_id integer, finished bit, session_id bigint, first_name varchar(255), login_name varchar(255), last_name varchar(255), primary key (learner_id));
