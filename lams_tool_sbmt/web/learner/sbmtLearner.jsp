 				...
 				-->
					...
					<c:forEach var="file" items="${learner.filesUploaded}">
						<tr>
							...
							<td>
								<BR>
								<b><fmt:message key="label.learner.fileName" /></b>
							</td>
							<td>
								<BR>
						...
						<tr>
							...
							<td>
								<b><fmt:message key="label.learner.time" /></b>
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<b><fmt:message key="label.learner.comments" /></b>
							</td>
							<td>
								<c:choose>
						...
						<tr>
							...
							<td>
								<b><fmt:message key="label.learner.marks" /></b>
							</td>
							<td>
								<c:choose>
									<c:when test="${empty file.comments}">
