...
<c:if test="${status.first}">
			<div class="lead"><lams:Portrait userId="${fileInfo.owner.userID}"/>&nbsp;<strong><c:out value="${fileInfo.owner.firstName}" />&nbsp;<c:out value="${fileInfo.owner.lastName}" /></strong> <fmt:message key="label.submit.file.suffix" /></div>
</c:if> 
