...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#minLimitUpload').change(function(){
...
<lams:SimplePanel titleKey="label.file.options">
	<div class="checkbox">
		<label for="minLimitUpload">
			<form:checkbox path="minLimitUpload" id="minLimitUpload" />
			<fmt:message key="label.enable.min.limit" />
		</label>

		<div class="slider-div <c:if test="${!authoringForm.minLimitUpload}">hidden</c:if>">
