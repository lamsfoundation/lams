...
ALTER IGNORE TABLE tl_lasbmt11_content DROP FOREIGN KEY FKAEF329AC172BC670;
...
ALTER IGNORE TABLE tl_lasbmt11_session DROP FOREIGN KEY FKEC8C77C9785A173A;
...
ALTER IGNORE TABLE tl_lasbmt11_submission_details DROP FOREIGN KEY FK1411A53C93C861A;
...
ALTER IGNORE TABLE tl_lasbmt11_submission_details DROP FOREIGN KEY FK1411A53CFFD5A38B;
