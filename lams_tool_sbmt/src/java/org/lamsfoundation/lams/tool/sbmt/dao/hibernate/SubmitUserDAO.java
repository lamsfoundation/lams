...
public class SubmitUserDAO extends BaseDAO implements ISubmitUserDAO {
	...
	query.addEntity("user", SubmitUser.class).addScalar("numFiles", Hibernate.INTEGER)
		.addScalar("numFilesMarked", Hibernate.INTEGER).addScalar("notebookEntry", Hibernate.STRING)
	...
	query.addScalar("sessionId", Hibernate.LONG).addScalar("sessionName", Hibernate.STRING)
		.addScalar("totalUploadedFiles", Hibernate.INTEGER).addScalar("markedCount", Hibernate.INTEGER)
