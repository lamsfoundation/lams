				...
				<div id="courseHeading" class="panel-heading">
					...
					<div class="pull-right btn-group btn-group-sm">
						...
						<c:if test="${UserManageForm.canResetOrgPassword == true}">
							<a class="btn btn-default" href="orgPasswordChange.do?organisationID=<c:out value="${UserManageForm.orgId}"/>"><fmt:message key='admin.org.password.change.button'/></a>
						</c:if>
				...
				<c:forEach var="userManageBean" items="${UserManageForm.userManageBeans}">
					<tr>
						...
						<td>
								...
								&nbsp;
								<c:if test="${UserManageForm.courseAdminCanAddNewUsers == true }">
									<a href="user/edit.do?userId=<c:out value="${userManageBean.userId}" />&orgId=<c:out value="${userManageBean.orgId}"/>"><fmt:message key="admin.edit" /></a>
									&nbsp;
								</c:if>
								<c:if test="${canDeleteUser == true}">
									<a href="user/remove.do?userId=<c:out value="${userManageBean.userId}" />&orgId=<c:out value="${userManageBean.orgId"/>"><fmt:message key="admin.user.delete"/></a>
								</c:if>
								<br/>
						</td>		
					</tr>
