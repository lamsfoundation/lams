...
public class AdminConstants {
    ...
    public static final String START_SYSADMIN_CONFIG_LINKS = "server.sys.config.title";
    public static final String START_APPADMIN_CONFIG_LINKS = "server.app.config.title";
