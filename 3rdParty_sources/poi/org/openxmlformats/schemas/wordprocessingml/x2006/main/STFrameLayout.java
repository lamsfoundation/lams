...
public interface STFrameLayout extends org.apache.xmlbeans.XmlString {
    SimpleTypeFactory<org.openxmlformats.schemas.wordprocessingml.x2006.main.STFrameLayout> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "stframelayoute68btype");
    ...
    Enum ROWS = Enum.forString("rows");
    Enum COLS = Enum.forString("cols");
    Enum NONE = Enum.forString("none");

    int INT_ROWS = Enum.INT_ROWS;
    int INT_COLS = Enum.INT_COLS;
