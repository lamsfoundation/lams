...
public interface STTextboxTightWrap extends org.apache.xmlbeans.XmlString {
    SimpleTypeFactory<org.openxmlformats.schemas.wordprocessingml.x2006.main.STTextboxTightWrap> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "sttextboxtightwrap8c6etype");
    ...
    Enum ALL_LINES = Enum.forString("allLines");
    Enum FIRST_AND_LAST_LINE = Enum.forString("firstAndLastLine");
    Enum FIRST_LINE_ONLY = Enum.forString("firstLineOnly");
    Enum LAST_LINE_ONLY = Enum.forString("lastLineOnly");

    int INT_NONE = Enum.INT_NONE;
    int INT_ALL_LINES = Enum.INT_ALL_LINES;
    int INT_FIRST_AND_LAST_LINE = Enum.INT_FIRST_AND_LAST_LINE;
    int INT_FIRST_LINE_ONLY = Enum.INT_FIRST_LINE_ONLY;
    int INT_LAST_LINE_ONLY = Enum.INT_LAST_LINE_ONLY;
