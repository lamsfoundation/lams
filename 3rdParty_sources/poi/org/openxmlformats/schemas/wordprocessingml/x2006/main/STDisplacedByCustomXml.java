...
public interface STDisplacedByCustomXml extends org.apache.xmlbeans.XmlString {
    SimpleTypeFactory<org.openxmlformats.schemas.wordprocessingml.x2006.main.STDisplacedByCustomXml> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "stdisplacedbycustomxml72d4type");
    ...
    Enum NEXT = Enum.forString("next");
    Enum PREV = Enum.forString("prev");

    int INT_NEXT = Enum.INT_NEXT;
    int INT_PREV = Enum.INT_PREV;
