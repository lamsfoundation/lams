...
public interface STRestartNumber extends org.apache.xmlbeans.XmlString {
    SimpleTypeFactory<org.openxmlformats.schemas.wordprocessingml.x2006.main.STRestartNumber> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "strestartnumber11aatype");
    ...
    Enum EACH_SECT = Enum.forString("eachSect");
    Enum EACH_PAGE = Enum.forString("eachPage");

    int INT_CONTINUOUS = Enum.INT_CONTINUOUS;
    int INT_EACH_SECT = Enum.INT_EACH_SECT;
    int INT_EACH_PAGE = Enum.INT_EACH_PAGE;
