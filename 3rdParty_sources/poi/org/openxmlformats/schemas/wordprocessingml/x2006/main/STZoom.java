...
public interface STZoom extends org.apache.xmlbeans.XmlString {
    SimpleTypeFactory<org.openxmlformats.schemas.wordprocessingml.x2006.main.STZoom> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "stzoom8865type");
    ...
    Enum FULL_PAGE = Enum.forString("fullPage");
    Enum BEST_FIT = Enum.forString("bestFit");
    Enum TEXT_FIT = Enum.forString("textFit");

    int INT_NONE = Enum.INT_NONE;
    int INT_FULL_PAGE = Enum.INT_FULL_PAGE;
    int INT_BEST_FIT = Enum.INT_BEST_FIT;
    int INT_TEXT_FIT = Enum.INT_TEXT_FIT;
