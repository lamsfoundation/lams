...
public interface STSortBy extends org.apache.xmlbeans.XmlString {
    SimpleTypeFactory<org.openxmlformats.schemas.spreadsheetml.x2006.main.STSortBy> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "stsortbyca6etype");
    ...
    Enum CELL_COLOR = Enum.forString("cellColor");
    Enum FONT_COLOR = Enum.forString("fontColor");
    Enum ICON = Enum.forString("icon");

    int INT_VALUE = Enum.INT_VALUE;
    int INT_CELL_COLOR = Enum.INT_CELL_COLOR;
    int INT_FONT_COLOR = Enum.INT_FONT_COLOR;
