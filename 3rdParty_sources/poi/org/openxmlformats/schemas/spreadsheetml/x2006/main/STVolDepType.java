...
public interface STVolDepType extends org.apache.xmlbeans.XmlString {
    SimpleTypeFactory<org.openxmlformats.schemas.spreadsheetml.x2006.main.STVolDepType> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "stvoldeptype59aftype");
    ...
    Enum REAL_TIME_DATA = Enum.forString("realTimeData");
    Enum OLAP_FUNCTIONS = Enum.forString("olapFunctions");

    int INT_REAL_TIME_DATA = Enum.INT_REAL_TIME_DATA;
    int INT_OLAP_FUNCTIONS = Enum.INT_OLAP_FUNCTIONS;
