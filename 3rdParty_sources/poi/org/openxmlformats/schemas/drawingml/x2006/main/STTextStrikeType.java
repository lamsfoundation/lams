...
public interface STTextStrikeType extends org.apache.xmlbeans.XmlToken {
    SimpleTypeFactory<org.openxmlformats.schemas.drawingml.x2006.main.STTextStrikeType> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "sttextstriketype4744type");
    ...
    Enum NO_STRIKE = Enum.forString("noStrike");
    Enum SNG_STRIKE = Enum.forString("sngStrike");
    Enum DBL_STRIKE = Enum.forString("dblStrike");

    int INT_NO_STRIKE = Enum.INT_NO_STRIKE;
    int INT_SNG_STRIKE = Enum.INT_SNG_STRIKE;
    int INT_DBL_STRIKE = Enum.INT_DBL_STRIKE;
