...
public interface STPathFillMode extends org.apache.xmlbeans.XmlToken {
    SimpleTypeFactory<org.openxmlformats.schemas.drawingml.x2006.main.STPathFillMode> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "stpathfillmode3cf6type");
    ...
    Enum LIGHTEN_LESS = Enum.forString("lightenLess");
    Enum DARKEN = Enum.forString("darken");
    Enum DARKEN_LESS = Enum.forString("darkenLess");

    int INT_NONE = Enum.INT_NONE;
    int INT_NORM = Enum.INT_NORM;
    int INT_LIGHTEN = Enum.INT_LIGHTEN;
    int INT_LIGHTEN_LESS = Enum.INT_LIGHTEN_LESS;
    int INT_DARKEN = Enum.INT_DARKEN;
    int INT_DARKEN_LESS = Enum.INT_DARKEN_LESS;
