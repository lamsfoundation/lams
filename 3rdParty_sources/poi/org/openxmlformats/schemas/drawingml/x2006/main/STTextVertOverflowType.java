...
public interface STTextVertOverflowType extends org.apache.xmlbeans.XmlToken {
    SimpleTypeFactory<org.openxmlformats.schemas.drawingml.x2006.main.STTextVertOverflowType> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "sttextvertoverflowtype2725type");
    ...
    Enum OVERFLOW = Enum.forString("overflow");
    Enum ELLIPSIS = Enum.forString("ellipsis");
    Enum CLIP = Enum.forString("clip");

    int INT_OVERFLOW = Enum.INT_OVERFLOW;
    int INT_ELLIPSIS = Enum.INT_ELLIPSIS;
    int INT_CLIP = Enum.INT_CLIP;
