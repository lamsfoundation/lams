...
public interface STTextVerticalType extends org.apache.xmlbeans.XmlToken {
    SimpleTypeFactory<org.openxmlformats.schemas.drawingml.x2006.main.STTextVerticalType> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "sttextverticaltyped988type");
    ...
    Enum VERT_270 = Enum.forString("vert270");
    Enum WORD_ART_VERT = Enum.forString("wordArtVert");
    Enum EA_VERT = Enum.forString("eaVert");
    Enum MONGOLIAN_VERT = Enum.forString("mongolianVert");
    Enum WORD_ART_VERT_RTL = Enum.forString("wordArtVertRtl");

    int INT_HORZ = Enum.INT_HORZ;
    int INT_VERT = Enum.INT_VERT;
    int INT_VERT_270 = Enum.INT_VERT_270;
    int INT_WORD_ART_VERT = Enum.INT_WORD_ART_VERT;
    int INT_EA_VERT = Enum.INT_EA_VERT;
    int INT_MONGOLIAN_VERT = Enum.INT_MONGOLIAN_VERT;
    int INT_WORD_ART_VERT_RTL = Enum.INT_WORD_ART_VERT_RTL;
