...
public interface STCxnType extends org.apache.xmlbeans.XmlToken {
    SimpleTypeFactory<org.openxmlformats.schemas.drawingml.x2006.diagram.STCxnType> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "stcxntypeca58type");
    ...
    Enum PAR_OF = Enum.forString("parOf");
    Enum PRES_OF = Enum.forString("presOf");
    Enum PRES_PAR_OF = Enum.forString("presParOf");
    Enum UNKNOWN_RELATIONSHIP = Enum.forString("unknownRelationship");

    int INT_PAR_OF = Enum.INT_PAR_OF;
    int INT_PRES_OF = Enum.INT_PRES_OF;
    int INT_PRES_PAR_OF = Enum.INT_PRES_PAR_OF;
    int INT_UNKNOWN_RELATIONSHIP = Enum.INT_UNKNOWN_RELATIONSHIP;
