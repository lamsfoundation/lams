...
public interface STErrBarType extends org.apache.xmlbeans.XmlString {
    SimpleTypeFactory<org.openxmlformats.schemas.drawingml.x2006.chart.STErrBarType> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "sterrbartypea2a4type");
    ...
    Enum MINUS = Enum.forString("minus");
    Enum PLUS = Enum.forString("plus");

    int INT_BOTH = Enum.INT_BOTH;
    int INT_MINUS = Enum.INT_MINUS;
