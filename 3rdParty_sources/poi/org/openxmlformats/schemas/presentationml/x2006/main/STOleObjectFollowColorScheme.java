...
public interface STOleObjectFollowColorScheme extends org.apache.xmlbeans.XmlToken {
    SimpleTypeFactory<org.openxmlformats.schemas.presentationml.x2006.main.STOleObjectFollowColorScheme> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "stoleobjectfollowcolorschemead25type");
    ...
    Enum TEXT_AND_BACKGROUND = Enum.forString("textAndBackground");

    int INT_NONE = Enum.INT_NONE;
    int INT_FULL = Enum.INT_FULL;
    int INT_TEXT_AND_BACKGROUND = Enum.INT_TEXT_AND_BACKGROUND;
