...
public class DokumaranServiceProxy {
     ...
     * @return Shared dokumaran service object.
     */
    public static final IDokumaranService getDokumaranService(ServletContext servletContext) {
	return (IDokumaranService) DokumaranServiceProxy.getDokumaranDomainService(servletContext);
    }

    public static final ToolSessionManager getSessionManager(ServletContext servletContext) {
	return (ToolSessionManager) DokumaranServiceProxy.getDokumaranDomainService(servletContext);
    }

    public static final ToolContentManager getContentManager(ServletContext servletContext) {
	return (ToolContentManager) DokumaranServiceProxy.getDokumaranDomainService(servletContext);
    }

    private static Object getDokumaranDomainService(ServletContext servletContext) {
	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(servletContext);
	return wac.getBean(DokumaranConstants.RESOURCE_SERVICE);
    }
