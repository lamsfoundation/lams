				...
				<table class="forms">
						...
						<c:if test="${isGroupedActivity}">
	  					...
	  					<tr>
					 		...
					 		<td >  <c:out value="${voteGeneralMonitoringDTO.completedSessionUserCount}"/> 
						 		&nbsp(<c:out value="${voteGeneralMonitoringDTO.completedSessionUserPercent}"/> <fmt:message key="label.percent"/>)
					 		</td>
						</tr>
						...
						<tr>
							...
							<c:if test="${statsTabActive != 'true'}"> 							
								<tr> 
									<td> </td>
									<td  valign=top class="align-left" >
										<a href="javascript:drawChart('pie', 0)">
								...
								<tr> 
									<td> </td>
									<td  valign=top class="align-left" >
										<a href="javascript:drawChart('bar', 0)">
