					...
					<tr><td align=center>
							...
							<table  width="100%" align=center  border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<c:forEach var="attachment" items="${voteGeneralAuthoringDTO.attachmentList}">
