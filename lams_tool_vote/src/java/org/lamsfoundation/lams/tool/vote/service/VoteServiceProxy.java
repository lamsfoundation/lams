...
public class VoteServiceProxy {
	...
	return (IVoteService) VoteServiceProxy.getVoteDomainService(servletContext);
    }

    public static final ToolSessionManager getVoteSessionManager(ServletContext servletContext) {
	return (ToolSessionManager) VoteServiceProxy.getVoteDomainService(servletContext);
    }

    public static final ToolContentManager getVoteContentManager(ServletContext servletContext) {
	return (ToolContentManager) VoteServiceProxy.getVoteDomainService(servletContext);
    }

    public static final MessageService getMessageService(ServletContext servletContext) {
	return (MessageService) VoteServiceProxy.getVoteMessageService(servletContext);
    }
