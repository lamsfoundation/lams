 ...
 */
public class MindmapToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "mindmapworkspace";

    public static String repositoryUser = "mindmap";
     ...
     * 
     */
    public MindmapToolContentHandler() {
	super();
    }
