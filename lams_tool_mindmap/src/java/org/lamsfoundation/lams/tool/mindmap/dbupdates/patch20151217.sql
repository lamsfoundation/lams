...
ALTER IGNORE TABLE tl_lamind10_node DROP FOREIGN KEY MindmapNode_Mindmap_FK;
...
ALTER IGNORE TABLE tl_lamind10_node DROP FOREIGN KEY MindmapNode_Parent_FK;
...
ALTER IGNORE TABLE tl_lamind10_node DROP FOREIGN KEY MindmapNode_User_FK;
...
ALTER IGNORE TABLE tl_lamind10_request DROP FOREIGN KEY tl_lamind10_request_fk;
ALTER TABLE tl_lamind10_request ADD CONSTRAINT tl_lamind10_request_fk FOREIGN KEY (`mindmap_id`)
REFERENCES `tl_lamind10_mindmap` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_lamind10_request DROP FOREIGN KEY tl_lamind10_request_fk1;
...
ALTER IGNORE TABLE tl_lamind10_session DROP FOREIGN KEY FK_NEW_972920762_B7C198E2FC940906;
ALTER TABLE tl_lamind10_session ADD CONSTRAINT FK_NEW_972920762_B7C198E2FC940906 FOREIGN KEY (`mindmap_uid`)
REFERENCES `tl_lamind10_mindmap` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_lamind10_user DROP FOREIGN KEY FK_NEW_972920762_CB8A58FFA3B0FADF;
