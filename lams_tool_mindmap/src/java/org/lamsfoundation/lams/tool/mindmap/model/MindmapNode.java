...
public class MindmapNode implements Cloneable {
	...
	/** full constructor */
	public MindmapNode(Long nodeId, Long uniqueId, MindmapNode parent, String text, String color, 
		MindmapUser user, Mindmap mindmap) {
	    this.nodeId = nodeId;
	...
	/**
	 * @param parent The parent of this MindmapNode
	 */
