 ...
 * 
 * @hibernate.class table="tl_lamind10_attachment"
 * 
 */

public class MindmapAttachment implements java.io.Serializable, Cloneable {
	...
	private static final Logger log = Logger.getLogger(MindmapAttachment.class);
	...
	/** default constructor */
	public MindmapAttachment() {
	}

	/** Constructor setting up all the properties except for mindmap one*/
	public MindmapAttachment(Long fileVersionId, String fileType, String fileName,	Long fileUuid, Date createDate) {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof MindmapAttachment))
			return false;

		final MindmapAttachment genericEntity = (MindmapAttachment) o;
	...
	public Object clone() {
		...
		try {
			obj = super.clone();
			((MindmapAttachment) obj).setUid(null);
		} catch (CloneNotSupportedException e) {
			log.error("Failed to clone " + MindmapAttachment.class);
		}
