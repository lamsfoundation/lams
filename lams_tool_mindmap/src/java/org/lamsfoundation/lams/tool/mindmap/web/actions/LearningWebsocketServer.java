...
public class LearningWebsocketServer {
	 ...
	 */
	private static void send(Long toolSessionId, Session newWebsocket, Long userLastGlobalId) throws JSONException, IOException {
		...
		responseJSON = getServerActionJSON(mindmapSession.getMindmap().getUid(),
		...
		Long currentMaxGlobalId = getMindmapService().getLastGlobalIdByMindmapId(
	...
	private static JSONObject getServerActionJSON(Long mindmapId, Long toolSessionId, Long lastActionId)
		throws JSONException {

	    JSONObject sendJSONObject = new JSONObject();
	    JSONArray actions = new JSONArray();
	    sendJSONObject.put(RESPONSE_JSON_ACTIONS, actions);

	    List<MindmapRequest> requestsList = mindmapService.getLastRequestsAfterGlobalId(lastActionId, mindmapId, toolSessionId);
