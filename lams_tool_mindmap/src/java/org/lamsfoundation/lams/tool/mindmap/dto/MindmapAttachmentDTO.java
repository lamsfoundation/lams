...
public class MindmapAttachmentDTO implements Comparable {

	public MindmapAttachmentDTO(MindmapAttachment att) {
	...
	public int compareTo(Object o) {
		MindmapAttachmentDTO toAttachment = (MindmapAttachmentDTO) o;
		int returnValue = this.createDate.compareTo(((MindmapAttachmentDTO) o)
				.getCreateDate());
