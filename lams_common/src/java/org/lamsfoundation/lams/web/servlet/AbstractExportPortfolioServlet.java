...
public abstract class AbstractExportPortfolioServlet extends HttpServlet {
     ...
     * @param filename
     */
    protected int writeResponseToFile(String urlToConnectTo, String directoryToStoreFile, String filename,
	    Cookie[] cookies) {
     ...
     * @param url
     *            The url in which the parameters should be appended to
	...
	String finalURL;
	finalURL = WebUtil.appendParameterToURL(url, AttributeNames.PARAM_MODE,
		WebUtil.readStrParam(request, AttributeNames.PARAM_MODE));
	finalURL = WebUtil.appendParameterToURL(finalURL, AttributeNames.PARAM_TOOL_SESSION_ID,
		WebUtil.readStrParam(request, AttributeNames.PARAM_TOOL_SESSION_ID));
	finalURL = WebUtil.appendParameterToURL(finalURL, AttributeNames.PARAM_USER_ID,
		WebUtil.readStrParam(request, AttributeNames.PARAM_USER_ID));
	...
	finalURL = WebUtil.appendParameterToURL(url, AttributeNames.PARAM_MODE,
		WebUtil.readStrParam(request, AttributeNames.PARAM_MODE));
	finalURL = WebUtil.appendParameterToURL(finalURL, AttributeNames.PARAM_TOOL_CONTENT_ID,
		WebUtil.readStrParam(request, AttributeNames.PARAM_TOOL_CONTENT_ID));
	return finalURL;
    }
