...
public class SeleniumConstants {
     ...
     */
    public static final String BROWSER = BROWSER_INTERNET_EXPLORER;
    public static final String WEB_APP_HOST = "http://127.0.0.1:8080";
    /**
     * The starting URL including just a domain name. 
     * We'll start the browser pointing at the Selenium resources on this URL.
     */
