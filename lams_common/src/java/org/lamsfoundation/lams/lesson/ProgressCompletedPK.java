...
public class ProgressCompletedPK implements Serializable {
    ...
    /** full constructor */
    public ProgressCompletedPK(Long learnerProgressId, Long activityId) {
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof ProgressCompletedPK) ) return false;
        ProgressCompletedPK castOther = (ProgressCompletedPK) other;
