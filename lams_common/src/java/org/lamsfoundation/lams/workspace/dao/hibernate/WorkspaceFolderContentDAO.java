...
public class WorkspaceFolderContentDAO extends BaseDAO implements IWorkspaceFolderContentDAO {
	...
	if (uuid != null && versionID != null && folderContentID != null) {
	    List list = this.getSession().createQuery(DELETE_BY_VERSION).setLong(0, folderContentID.longValue())
		    .setLong(1, uuid.longValue()).setLong(2, versionID.longValue()).list();
