...
public class ToolOutputValue {
     ...
     * @throws ToolOutputFormatException If unable to convert the value to the requested type.
	 * @param val mandatory
	 */
     ...
     * @throws ToolOutputFormatException If unable to convert the value to a string.
     */
	 ...
	 * 
     * @throws ToolOutputFormatException If unable to convert the value to a Long.
     */
	 ...
	 * and we will try to convert other types but that isn't guaranteed. A boolean value will convert to 1 or 0.
	 * 
     * @throws ToolOutputFormatException If unable to convert the value to a Double.
     */
   ...
   /**
	 ...
	 * otherwise false.
	 *
     * @throws ToolOutputFormatException If unable to convert the value to a boolean.
     */
