 ...
 * 
 * The implemented factory should implement public SortedMap<String,
 * ToolOutputDefinition> getToolOutputDefinitions(Object toolContentObject) and
 * this method should call the buildBlahDefinition() calls to build the
 * definitions.
 * 
 * It should also implement two methods similar to SortedMap<String,
 * ToolOutput> getToolOutput(List<String> names, various tool objects) and
 ...
 * class="org.lamsfoundation.lams.tool.mc.service.MCOutputFactory"> <property
 * name="loadedMessageSourceService"><ref bean="loadedMessageSourceService"/></property>
 * <property name="languageFilename"><value>org.lamsfoundation.lams.tool.mc.ApplicationResources</value></property>
 * </bean>
 * 
 * <bean id="forumOuputDefinitionFactory"
