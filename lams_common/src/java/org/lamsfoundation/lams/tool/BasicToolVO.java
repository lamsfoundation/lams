...
public class BasicToolVO implements Serializable, IToolVO {
    ...
    public BasicToolVO(Long toolId, boolean supportsGrouping, String learnerUrl, String learnerPreviewUrl,
	    String learnerProgressUrl, String authorUrl, String exportPortfolioLearnerUrl,
	    String exportPortfolioClassUrl, String monitorUrl, String helpUrl, long defaultToolContentId,
