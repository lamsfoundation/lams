...
public abstract class GateActivity extends SimpleActivity implements Serializable, ISystemToolActivity {
	...
	/** minimal constructor */
	public GateActivity(Long activityId, Boolean defineLater, java.util.Date createDateTime,
	 ...
	 * @param learner the new learner.
	 * @param isAllowedToPass is the learner allowed to pass the gate
	 */
