...
public class LearnerChoiceGrouper extends Grouper implements Serializable {
	...
	private void doGrouping(Grouping learnerChoiceGrouping, Group group, String groupName, List learners) {
		if (group != null) {
			...
			learnerChoiceGrouping.getGroups().add(
					Group.createLearnerGroup(learnerChoiceGrouping, groupName, new HashSet(learners)));
		}
	}
	 ...
	 * @param learnerChoiceGrouping the requested grouping. 
