...
public class UserFlashDTO {
    ...
    // minimal constructor (flash)
    public UserFlashDTO(Integer userID, String firstName, String lastName, String login) {
	this.userID = userID;
	...
	if ((o != null) && (o.getClass() == this.getClass())) {
	    return ((UserFlashDTO) o).userID == this.userID;
	} else {
	    return false;
	}
    }
