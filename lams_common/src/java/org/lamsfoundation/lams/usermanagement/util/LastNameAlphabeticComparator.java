...
public class LastNameAlphabeticComparator implements Comparator, Serializable {
	...
	private static Logger log = Logger
			.getLogger(LastNameAlphabeticComparator.class);
	...
	private int compareLastName(Object o1, Object o2) {
		...
		try {
			...
			lastNameMethod = o1.getClass().getMethod("getLastName",
					(Class[]) null);
			surname1 = (String) lastNameMethod.invoke(o1, (Object[]) null);

			lastNameMethod = o2.getClass().getMethod("getLastName",
					(Class[]) null);
	...
	private int compareFirstName(Object o1, Object o2) {
		...
		try {
			...
			lastNameMethod = o1.getClass().getMethod("getFirstName",
					(Class[]) null);
			name1 = (String) lastNameMethod.invoke(o1, (Object[]) null);

			lastNameMethod = o2.getClass().getMethod("getFirstName",
					(Class[]) null);
	...
	private int compareLogin(Object o1, Object o2) {
		...
		try {
			...
			lastNameMethod = o1.getClass()
					.getMethod("getLogin", (Class[]) null);
			name1 = (String) lastNameMethod.invoke(o1, (Object[]) null);

			lastNameMethod = o2.getClass()
					.getMethod("getLogin", (Class[]) null);
			name2 = (String) lastNameMethod.invoke(o2, (Object[]) null);
