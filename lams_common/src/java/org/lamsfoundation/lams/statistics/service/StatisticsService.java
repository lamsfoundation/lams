...
public class StatisticsService implements IStatisticsService {
	...
	if (group != null) {
	    ...
	    groupStats.setAuthors(userService
		    .getUsersFromOrganisationByRole(group.getOrganisationId(), Role.AUTHOR, false, false).size());
	    groupStats.setMonitors(userService
		    .getUsersFromOrganisationByRole(group.getOrganisationId(), Role.MONITOR, false, false).size());
	    groupStats.setLearners(userService
		    .getUsersFromOrganisationByRole(group.getOrganisationId(), Role.LEARNER, false, false).size());
		...
		for (Organisation subGroup : subGroups) {
		    ...
		    subGroupStats.setAuthors(userService
			    .getUsersFromOrganisationByRole(subGroup.getOrganisationId(), Role.AUTHOR, false, false)
			    .size());
		    subGroupStats.setMonitors(userService
			    .getUsersFromOrganisationByRole(subGroup.getOrganisationId(), Role.MONITOR, false, false)
			    .size());
		    subGroupStats.setLearners(userService
			    .getUsersFromOrganisationByRole(subGroup.getOrganisationId(), Role.LEARNER, false, false)
			    .size());
