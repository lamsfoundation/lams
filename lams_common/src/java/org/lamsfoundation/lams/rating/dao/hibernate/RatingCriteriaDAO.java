...
public class RatingCriteriaDAO extends BaseDAO implements IRatingCriteriaDAO {
	...
	return (getHibernateTemplate().find(FIND_BY_TOOL_CONTENT_ID, new Object[] { toolContentId }));
    }
	...
	List list = getHibernateTemplate().find(IS_COMMENTS_ENABLED_FOR_TOOL_CONTENT_ID,
