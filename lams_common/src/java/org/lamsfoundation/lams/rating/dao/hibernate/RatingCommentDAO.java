...
//	    + " WHERE r.ratingCriteria.toolContentId = ? AND r.ratingCriteria.commentsEnabled IS TRUE AND r.itemId =? AND r.learner.userId =?";
	...
	List<Object[]> results = (getHibernateTemplate().find(FIND_COMMENTS_BY_CRITERIA_AND_ITEM,
	...
	List<Object[]> results = (itemIds.isEmpty()) ? new ArrayList<Object[]>()
		: getSession().createQuery(FIND_COMMENTS_BY_CRITERIA_AND_ITEMS)
	...
	List<Object[]> results = (itemIds.isEmpty()) ? new ArrayList<Object[]>()
		: getSession().createQuery(FIND_COMMENTS_BY_CRITERIA_AND_ITEMS_AND_USER)
	...
	List<Object[]> results = (getHibernateTemplate().find(FIND_COMMENTS_BY_CRITERIA,
