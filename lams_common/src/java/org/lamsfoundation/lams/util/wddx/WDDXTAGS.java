...
public interface WDDXTAGS {
	...
	/**
	 * The string value in a WDDX packet that indicates that this value is
	 * really null
	 */
	public static final String STRING_NULL_VALUE = "string_null_value";
	/**
	 * The Boolean value in a WDDX packet that indicates that this value is
	 * really null. Implemented as a String as Boolean is too restrictive.
	 */
	...
	/**
	 * The Long value in a WDDX packet that indicates that this value is really
	 * null.
	 */
	public static final Long NUMERIC_NULL_VALUE_LONG = new Long(-111111);
	/**
	 * The Integer value in a WDDX packet that indicates that this value is
	 * really null.
	 */
	public static final Integer NUMERIC_NULL_VALUE_INTEGER = new Integer(
			-111111);
	/**
	 * The Double value in a WDDX packet that indicates that this value is
	 * really null. This is used to check a value coming in from WDDX - as it
	 * tends to return Doubles, not Long or Integers.
	 */
	public static final Double NUMERIC_NULL_VALUE_DOUBLE = new Double(-111111);
	/**
	 * The Date value in a WDDX packet that indicates that this value is really
	 * null.
	 */
