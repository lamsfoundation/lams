...
public class WDDXProcessor {
     ...
     * 
     * @param table
     *            Hashtable containing values from Flash. Must not be null
     *            or NullPointerException will be thrown.
     * @param key
     *            Key of entry in table. Must not be null
     *            or NullPointerException will be thrown.
     ...
     * 
     * @param identifier
     *            - name of value being converted - using in the exception thrown
	...
	try {
	    ...
	    throw new WDDXProcessorConversionException(
		    "Unable to convert value " + identifier + ":" + value + " to an int");
	}
	return (result);
    }
     ...
     * @author Jacky Fang
     */
    public static Integer nullSafeCovertToInteger(String identifier, Object value)
	    throws WDDXProcessorConversionException {
	if (value == null || WDDXProcessor.isNull(value)) {
     ...
     * @throws Exception
     *             - will contain a message "Unable to convert value (identifier): (value) to an int"
     */
	...
	try {
	    ...
	    throw new WDDXProcessorConversionException(
		    "Unable to convert value " + identifier + ":" + value + " to a Boolean");
	}
    }
	...
	try {
	    ...
	    throw new WDDXProcessorConversionException(
		    "Unable to convert value " + identifier + ":" + value + " to an String");
	}
    }
	...
	try {
	    ...
	    throw new WDDXProcessorConversionException(
		    "Unable to convert value " + identifier + ":" + value + " to a Date");
	}
    }
	...
	if (obj.equals(WDDXTAGS.STRING_NULL_VALUE)) {
	    return true;
	}
	if (obj.equals(WDDXTAGS.BOOLEAN_NULL_VALUE_AS_STRING)) {
	    return true;
	}
	...
	if (obj.equals(WDDXTAGS.DATE_NULL_VALUE)) {
	    return true;
	}
	return false;
    }
