...
public class ActivityTreeNodeComparator implements Comparator<ActivityTreeNode> {
     ...
     */
    @Override
    public int compare(ActivityTreeNode treeNode1, ActivityTreeNode treeNode2) {
	AuthoringActivityDTO activity1 = treeNode1.getActivity();
	AuthoringActivityDTO activity2 = treeNode2.getActivity();
