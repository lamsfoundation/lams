...
public class SVGTrigonometryUtils {
	...
	Line2D topLine = new Line2D.Double(fromRectangleX, fromRectangleY, fromRectangleX + fromRectangleWidth,
		fromRectangleY);
	Line2D rightLine = new Line2D.Double(fromRectangleX + fromRectangleWidth, fromRectangleY, fromRectangleX
		+ fromRectangleWidth, fromRectangleY + fromRectangleHeight);
	Line2D bottomLine = new Line2D.Double(fromRectangleX, fromRectangleY + fromRectangleHeight, fromRectangleX
		+ fromRectangleWidth, fromRectangleY + fromRectangleHeight);
	Line2D leftLine = new Line2D.Double(fromRectangleX, fromRectangleY, fromRectangleX, fromRectangleY
		+ fromRectangleHeight);
	...
	Line2D transitionLine = new Line2D.Double(fromRectangleX + fromRectangleWidth / 2, fromRectangleY
		+ fromRectangleHeight / 2, transitionToX, transitionToY);
