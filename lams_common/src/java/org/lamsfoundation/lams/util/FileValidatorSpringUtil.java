...
public class FileValidatorSpringUtil {
     ...
     */
//    public static boolean validateFileSize(Object bean, ValidatorAction va, Field field, Errors errors,
...
//	return FileValidatorSpringUtil.validateFileSize(fileSize, largeFile, errors);
//    }
     ...
     * @return Be careful, if the file size is under maximum size, return TRUE. Otherwise, return false.
     */
    public static boolean validateFileSize(MultipartFile file, Long fileSize, boolean largeFile, String errorKey,
	    Errors errors) {
	...
	return FileValidatorSpringUtil.validateFileSize(file, fileSize, largeFile, errorKey, errors);
    }
    ...
    private static boolean validateFileSize(int fileSize, boolean largeFile, String errorKey, Errors errors) {
	float maxFileSize = largeFile ? Configuration.getAsInt(ConfigurationKeys.UPLOAD_FILE_LARGE_MAX_SIZE)
		: Configuration.getAsInt(ConfigurationKeys.UPLOAD_FILE_MAX_SIZE);
