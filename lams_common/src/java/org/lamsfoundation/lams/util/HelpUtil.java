...
public class HelpUtil {
    ...
    /** Build an I18N'd tool url, based on the tool url in the database. If this is for a particular module, such as "authoring", then the 
     * module must be included and it will be converted to the wiki anchor format.
     * 
     * @param baseToolURL Mandatory
     * @param toolSignature Mandatory
    ...
    public static String constructToolURL(String baseToolURL, String toolSignature, String module, String languageCode ) {
    	...
    	String helpURL = addLanguageToURL(baseToolURL, languageCode);
    ...
    public static String constructPageURL(String page, String languageCode) {
   		return  addLanguageToURL(Configuration.get(ConfigurationKeys.HELP_URL), languageCode) + page;
	}
