-- dumped with
-- mysqldump --default-character-set=utf8mb4 --single-transaction --hex-blob --routines --triggers --add-drop-table --add-drop-trigger --skip-quote-names --skip-set-charset --skip-add-locks --skip-comments --no-data
...
CREATE TABLE lams_ext_server_lesson_map (
                                            ...
                                            lti_adv_deployment_id varchar(255) DEFAULT NULL,
                                            lti_adv_grading_type varchar(10) DEFAULT NULL,
                                            lti_adv_grading_url varchar(255) DEFAULT NULL,
                                            PRIMARY KEY (uid),
...
CREATE TABLE lams_ext_server_org_map (
                                         ...
                                         add_staff_to_all_lessons tinyint NOT NULL DEFAULT '0',
                                         ext_groups_url text,
                                         ...
                                         default_country char(2) DEFAULT NULL,
                                         default_locale_id tinyint unsigned DEFAULT NULL,
                                         default_timezone varchar(255) DEFAULT NULL,
                                         use_course_prefix tinyint NOT NULL DEFAULT '1',
                                         user_registration_enabled tinyint NOT NULL DEFAULT '1',
                                         user_name_lower_case tinyint NOT NULL DEFAULT '0',
                                         lti_adv_enforce_cookie tinyint NOT NULL DEFAULT '0',
                                         lti_adv_reregistration_enabled tinyint NOT NULL DEFAULT '1',
                                         lti_adv_issuer varchar(64) DEFAULT NULL,
                                         lti_adv_client_id varchar(64) DEFAULT NULL,
                                         lti_adv_platform_key_set_url varchar(255) DEFAULT NULL,
                                         lti_adv_oidc_auth_url varchar(255) DEFAULT NULL,
                                         lti_adv_access_token_url varchar(255) DEFAULT NULL,
                                         lti_adv_tool_name varchar(64) DEFAULT NULL,
                                         lti_adv_tool_description varchar(255) DEFAULT NULL,
                                         lti_adv_tool_key_set_url varchar(255) DEFAULT NULL,
                                         lti_adv_tool_key_id varchar(32) DEFAULT NULL,
                                         lti_adv_public_key text,
                                         lti_adv_private_key text,
                                         PRIMARY KEY (sid),
...
CREATE TABLE lams_ext_user_userid_map (
                                          ...
                                          lti_adv_username varchar(250) DEFAULT NULL,
                                          user_id bigint NOT NULL,
                                          ext_server_org_map_id int NOT NULL,
                                          tc_gradebook_id text,
                                          PRIMARY KEY (sid),
                                          UNIQUE KEY UQ_lams_ext_user_userid_map_1 (ext_server_org_map_id,external_username),
                                          KEY user_id (user_id),
                                          KEY ext_server_org_map_id (ext_server_org_map_id),
                                          KEY UQ_lams_ext_user_userid_map_2 (external_username),
