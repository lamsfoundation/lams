...
insert into lams_configuration (config_key, config_value) values ('Version','2.0 RC2');
...
insert into lams_configuration (config_key, config_value) values ('FileManagerDir','/usr/local/jboss-4.0.2/server/default/deploy/upload.war');
