...
INSERT INTO `lams_ext_server_org_map` VALUES (1,'moodle','moodle','moodle','moodle','mdl','http://localhost/moodle/mod/lamstwo/userinfo.php?ts=%timestamp%&un=%username%&hs=%hash%','',NULL,0x01,80,0,NULL,1,NULL,0,0,1,1,0,0,1,0,NULL);
UNLOCK TABLES;
...
INSERT INTO `lams_outcome_scale` VALUES (1,'Default attainment scale','default','Default global scale',1,NOW());
UNLOCK TABLES;
...
INSERT INTO patches VALUES ('lams', 20200219, NOW(), 'F');
UNLOCK TABLES;
...
LOCK TABLES `lams_qb_collection` WRITE;
