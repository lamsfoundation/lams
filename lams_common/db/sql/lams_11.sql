...
CREATE TABLE DEFAULT_SCHEMA.lams_organisation_type (
       organisation_type_id INT(3) NOT NULL
     , name VARCHAR(64) NOT NULL
     , description VARCHAR(255) NOT NULL
     , PRIMARY KEY (organisation_type_id)
)TYPE=InnoDB;
CREATE UNIQUE INDEX UQ_lams_organisation_type_name ON DEFAULT_SCHEMA.lams_organisation_type (name ASC);

CREATE TABLE DEFAULT_SCHEMA.lams_role (
...
CREATE INDEX gname ON DEFAULT_SCHEMA.lams_role (name ASC);

CREATE TABLE DEFAULT_SCHEMA.lams_tool_session_state (
       tool_session_state_id INT(3) NOT NULL
     , description VARCHAR(255) NOT NULL
     , PRIMARY KEY (tool_session_state_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_lesson_state (
       lesson_state_id INT(3) NOT NULL
     , description VARCHAR(255) NOT NULL
     , PRIMARY KEY (lesson_state_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_tool_session_type (
       tool_session_type_id INT(3) NOT NULL
     , description VARCHAR(255) NOT NULL
     , PRIMARY KEY (tool_session_type_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_license (
...
CREATE TABLE DEFAULT_SCHEMA.lams_workspace_folder_type (
       lams_workspace_folder_type_id INT(3) NOT NULL
     , description VARCHAR(255) NOT NULL
     , PRIMARY KEY (lams_workspace_folder_type_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_grouping_support_type (
       grouping_support_type_id INT(3) NOT NULL
     , description VARCHAR(64) NOT NULL
     , PRIMARY KEY (grouping_support_type_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_log_event_type (
       log_event_type_id INT(5) NOT NULL
     , description VARCHAR(255) NOT NULL
     , PRIMARY KEY (log_event_type_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_wkspc_fld_content_type (
       content_type_id INT(3) NOT NULL AUTO_INCREMENT
     , description VARCHAR(64) NOT NULL
     , PRIMARY KEY (content_type_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_privilege (
       privilege_id BIGINT(20) NOT NULL AUTO_INCREMENT
     , code VARCHAR(10) NOT NULL
     , description VARCHAR(255)
     , PRIMARY KEY (privilege_id)
)TYPE=InnoDB;
CREATE UNIQUE INDEX IX_lams_privilege_code ON DEFAULT_SCHEMA.lams_privilege (code ASC);

CREATE TABLE DEFAULT_SCHEMA.lams_organisation_state (
       organisation_state_id INT(3) NOT NULL
     , description VARCHAR(255)
     , PRIMARY KEY (organisation_state_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_supported_locale (
...
CREATE TABLE DEFAULT_SCHEMA.lams_tool_import_support (
...
CREATE TABLE DEFAULT_SCHEMA.lams_configuration (
       config_key VARCHAR(30) NOT NULL
     , config_value VARCHAR(255)
     , PRIMARY KEY (config_key)
);

CREATE TABLE DEFAULT_SCHEMA.lams_progress_waiting_state (
       waiting_flag TINYINT NOT NULL
     , description VARCHAR(255)
     , PRIMARY KEY (waiting_flag)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_auth_method_type (
       authentication_method_type_id INT(3) NOT NULL
     , description VARCHAR(64) NOT NULL
     , PRIMARY KEY (authentication_method_type_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_authentication_method (
     ...
     , CONSTRAINT FK_lams_authorization_method_1 FOREIGN KEY (authentication_method_type_id)
                  REFERENCES DEFAULT_SCHEMA.lams_auth_method_type (authentication_method_type_id) ON DELETE NO ACTION ON UPDATE NO ACTION
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_workspace_folder (
     ...
     , CONSTRAINT FK_lams_workspace_folder_2 FOREIGN KEY (parent_folder_id)
                  REFERENCES DEFAULT_SCHEMA.lams_workspace_folder (workspace_folder_id) ON DELETE NO ACTION ON UPDATE NO ACTION
     , INDEX (lams_workspace_folder_type_id)
     , CONSTRAINT FK_lams_workspace_folder_4 FOREIGN KEY (lams_workspace_folder_type_id)
                  REFERENCES DEFAULT_SCHEMA.lams_workspace_folder_type (lams_workspace_folder_type_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_workspace (
     ...
     , CONSTRAINT FK_lams_workspace_1 FOREIGN KEY (def_run_seq_fld_id)
                  REFERENCES DEFAULT_SCHEMA.lams_workspace_folder (workspace_folder_id)
     , INDEX (default_fld_id)
     , CONSTRAINT FK_lams_workspace_2 FOREIGN KEY (default_fld_id)
                  REFERENCES DEFAULT_SCHEMA.lams_workspace_folder (workspace_folder_id)
)TYPE=InnoDB;
CREATE INDEX root_folder_id ON DEFAULT_SCHEMA.lams_workspace ();

CREATE TABLE DEFAULT_SCHEMA.lams_user (
     ...
     , CONSTRAINT FK_lams_user_1 FOREIGN KEY (authentication_method_id)
                  REFERENCES DEFAULT_SCHEMA.lams_authentication_method (authentication_method_id) ON DELETE NO ACTION ON UPDATE NO ACTION
     , INDEX (workspace_id)
     , CONSTRAINT FK_lams_user_2 FOREIGN KEY (workspace_id)
                  REFERENCES DEFAULT_SCHEMA.lams_workspace (workspace_id) ON DELETE NO ACTION ON UPDATE NO ACTION
     , INDEX (flash_theme_id)
     , CONSTRAINT FK_lams_user_4 FOREIGN KEY (flash_theme_id)
                  REFERENCES DEFAULT_SCHEMA.lams_css_theme_ve (theme_ve_id) ON DELETE NO ACTION ON UPDATE NO ACTION
     , INDEX (html_theme_id)
     , CONSTRAINT FK_lams_user_5 FOREIGN KEY (html_theme_id)
                  REFERENCES DEFAULT_SCHEMA.lams_css_theme_ve (theme_ve_id) ON DELETE NO ACTION ON UPDATE NO ACTION
     , INDEX (locale_id)
     , CONSTRAINT FK_lams_user_6 FOREIGN KEY (locale_id)
                  REFERENCES DEFAULT_SCHEMA.lams_supported_locale (locale_id) ON DELETE NO ACTION ON UPDATE NO ACTION
)TYPE=InnoDB;
CREATE UNIQUE INDEX UQ_lams_user_login ON DEFAULT_SCHEMA.lams_user (login ASC);
CREATE INDEX login ON DEFAULT_SCHEMA.lams_user (login ASC);

CREATE TABLE DEFAULT_SCHEMA.lams_learning_design (
     ...
     , CONSTRAINT FK_lams_learning_design_3 FOREIGN KEY (user_id)
                  REFERENCES DEFAULT_SCHEMA.lams_user (user_id)
     ...
     , CONSTRAINT FK_lams_learning_design_5 FOREIGN KEY (license_id)
                  REFERENCES DEFAULT_SCHEMA.lams_license (license_id)
     , INDEX (copy_type_id)
     , CONSTRAINT FK_lams_learning_design_6 FOREIGN KEY (copy_type_id)
                  REFERENCES DEFAULT_SCHEMA.lams_copy_type (copy_type_id)
     , INDEX (edit_override_user_id)
     , CONSTRAINT FK_lams_learning_design_7 FOREIGN KEY (edit_override_user_id)
                  REFERENCES DEFAULT_SCHEMA.lams_user (user_id)
)TYPE=InnoDB;
CREATE INDEX idx_design_parent_id ON DEFAULT_SCHEMA.lams_learning_design (original_learning_design_id ASC);
CREATE INDEX idx_design_first_act ON DEFAULT_SCHEMA.lams_learning_design (first_activity_id ASC);

CREATE TABLE DEFAULT_SCHEMA.lams_grouping (
     ...
     , CONSTRAINT FK_lams_learning_grouping_1 FOREIGN KEY (grouping_type_id)
                  REFERENCES DEFAULT_SCHEMA.lams_grouping_type (grouping_type_id) ON DELETE NO ACTION ON UPDATE NO ACTION
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_group (
     ...
     , CONSTRAINT FK_lams_learning_group_1 FOREIGN KEY (grouping_id)
                  REFERENCES DEFAULT_SCHEMA.lams_grouping (grouping_id) ON DELETE NO ACTION ON UPDATE NO ACTION
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_organisation (
     ...
     , CONSTRAINT FK_lams_organisation_1 FOREIGN KEY (organisation_type_id)
                  REFERENCES DEFAULT_SCHEMA.lams_organisation_type (organisation_type_id) ON DELETE NO ACTION ON UPDATE NO ACTION
     , INDEX (workspace_id)
     ...
     , CONSTRAINT FK_lams_organisation_3 FOREIGN KEY (parent_organisation_id)
                  REFERENCES DEFAULT_SCHEMA.lams_organisation (organisation_id) ON DELETE NO ACTION ON UPDATE NO ACTION
     , INDEX (organisation_state_id)
     , CONSTRAINT FK_lams_organisation_4 FOREIGN KEY (organisation_state_id)
                  REFERENCES DEFAULT_SCHEMA.lams_organisation_state (organisation_state_id) ON DELETE NO ACTION ON UPDATE NO ACTION
     , INDEX (locale_id)
     , CONSTRAINT FK_lams_organisation_5 FOREIGN KEY (locale_id)
                  REFERENCES DEFAULT_SCHEMA.lams_supported_locale (locale_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_learning_activity (
...
CREATE TABLE DEFAULT_SCHEMA.lams_tool (
     ...
     , CONSTRAINT FK_lams_tool_1 FOREIGN KEY (learning_library_id)
                  REFERENCES DEFAULT_SCHEMA.lams_learning_library (learning_library_id)
     , INDEX (grouping_support_type_id)
     , CONSTRAINT FK_lams_tool_2 FOREIGN KEY (grouping_support_type_id)
                  REFERENCES DEFAULT_SCHEMA.lams_grouping_support_type (grouping_support_type_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_user_organisation (
     ...
     , CONSTRAINT FK_lams_user_organisation_2 FOREIGN KEY (user_id)
                  REFERENCES DEFAULT_SCHEMA.lams_user (user_id) ON DELETE NO ACTION ON UPDATE NO ACTION
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_learner_progress (
     ...
     , CONSTRAINT FK_lams_learner_progress_2 FOREIGN KEY (lesson_id)
                  REFERENCES DEFAULT_SCHEMA.lams_lesson (lesson_id)
     ...
     , CONSTRAINT FK_lams_learner_progress_5 FOREIGN KEY (previous_activity_id)
                  REFERENCES DEFAULT_SCHEMA.lams_learning_activity (activity_id)
     , INDEX (waiting_flag)
     , CONSTRAINT FK_lams_learner_progress_6 FOREIGN KEY (waiting_flag)
                  REFERENCES DEFAULT_SCHEMA.lams_progress_waiting_state (waiting_flag)
)TYPE=InnoDB;
CREATE UNIQUE INDEX IX_lams_learner_progress_1 ON DEFAULT_SCHEMA.lams_learner_progress (user_id ASC, lesson_id ASC);

CREATE TABLE DEFAULT_SCHEMA.lams_cr_node (
     ...
     , CONSTRAINT FK_lams_cr_node_1 FOREIGN KEY (workspace_id)
                  REFERENCES DEFAULT_SCHEMA.lams_cr_workspace (workspace_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_cr_node_version (
     ...
     , CONSTRAINT FK_lams_cr_node_version_2 FOREIGN KEY (node_id)
                  REFERENCES DEFAULT_SCHEMA.lams_cr_node (node_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_css_theme_ve (
...
CREATE TABLE DEFAULT_SCHEMA.lams_css_style (
...
CREATE TABLE DEFAULT_SCHEMA.lams_system_tool (
...
CREATE TABLE DEFAULT_SCHEMA.lams_user_organisation_role (
     ...
     , CONSTRAINT FK_lams_user_organisation_role_2 FOREIGN KEY (role_id)
                  REFERENCES DEFAULT_SCHEMA.lams_role (role_id) ON DELETE NO ACTION ON UPDATE NO ACTION
     , INDEX (user_organisation_id)
     , CONSTRAINT FK_lams_user_organisation_role_3 FOREIGN KEY (user_organisation_id)
                  REFERENCES DEFAULT_SCHEMA.lams_user_organisation (user_organisation_id) ON DELETE NO ACTION ON UPDATE NO ACTION
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_tool_session (
     ...
     , CONSTRAINT FK_lams_tool_session_4 FOREIGN KEY (tool_session_state_id)
                  REFERENCES DEFAULT_SCHEMA.lams_tool_session_state (tool_session_state_id)
     , INDEX (user_id)
     ...
     , CONSTRAINT FK_lams_tool_session_7 FOREIGN KEY (tool_session_type_id)
                  REFERENCES DEFAULT_SCHEMA.lams_tool_session_type (tool_session_type_id)
     , INDEX (activity_id)
     , CONSTRAINT FK_lams_tool_session_8 FOREIGN KEY (activity_id)
                  REFERENCES DEFAULT_SCHEMA.lams_learning_activity (activity_id)
     , INDEX (group_id)
     , CONSTRAINT FK_lams_tool_session_1 FOREIGN KEY (group_id)
                  REFERENCES DEFAULT_SCHEMA.lams_group (group_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_progress_completed (
     ...
     , CONSTRAINT FK_lams_progress_completed_1 FOREIGN KEY (learner_progress_id)
                  REFERENCES DEFAULT_SCHEMA.lams_learner_progress (learner_progress_id)
     , INDEX (activity_id)
     , CONSTRAINT FK_lams_progress_completed_2 FOREIGN KEY (activity_id)
                  REFERENCES DEFAULT_SCHEMA.lams_learning_activity (activity_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_progress_attempted (
       learner_progress_id BIGINT(20) NOT NULL
     , activity_id BIGINT(20) NOT NULL
     , PRIMARY KEY (learner_progress_id, activity_id)
     , INDEX (learner_progress_id)
...
CREATE TABLE DEFAULT_SCHEMA.lams_user_group (
       user_id BIGINT(20) NOT NULL
...
CREATE TABLE DEFAULT_SCHEMA.lams_tool_content (
...
CREATE TABLE DEFAULT_SCHEMA.lams_activity_learners (
...
CREATE TABLE DEFAULT_SCHEMA.lams_lesson_learner (
       lesson_id BIGINT(20) NOT NULL
     , user_id BIGINT(20) NOT NULL
     , INDEX (lesson_id)
...
CREATE TABLE DEFAULT_SCHEMA.lams_cr_workspace_credential (
     ...
     , CONSTRAINT FK_lams_cr_workspace_credential_1 FOREIGN KEY (workspace_id)
                  REFERENCES DEFAULT_SCHEMA.lams_cr_workspace (workspace_id) ON DELETE NO ACTION ON UPDATE NO ACTION
     , INDEX (credential_id)
     , CONSTRAINT FK_lams_cr_workspace_credential_2 FOREIGN KEY (credential_id)
                  REFERENCES DEFAULT_SCHEMA.lams_cr_credential (credential_id) ON DELETE NO ACTION ON UPDATE NO ACTION
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_cr_node_version_property (
     ...
     , CONSTRAINT FK_lams_cr_node_version_property_1 FOREIGN KEY (nv_id)
                  REFERENCES DEFAULT_SCHEMA.lams_cr_node_version (nv_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_log_event (
     ...
     , CONSTRAINT FK_lams_event_log_1 FOREIGN KEY (log_event_type_id)
                  REFERENCES DEFAULT_SCHEMA.lams_log_event_type (log_event_type_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_workspace_folder_content (
     ...
     , CONSTRAINT FK_lams_workspace_folder_content_2 FOREIGN KEY (content_type_id)
                  REFERENCES DEFAULT_SCHEMA.lams_wkspc_fld_content_type (content_type_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_css_property (
     ...
     , CONSTRAINT FK_lams_css_property_1 FOREIGN KEY (style_id)
                  REFERENCES DEFAULT_SCHEMA.lams_css_style (style_id) ON DELETE NO ACTION ON UPDATE NO ACTION
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_role_privilege (
     ...
     , CONSTRAINT FK_lams_role_privilege_1 FOREIGN KEY (privilege_id)
                  REFERENCES DEFAULT_SCHEMA.lams_privilege (privilege_id)
     , INDEX (role_id)
     , CONSTRAINT FK_lams_role_privilege_2 FOREIGN KEY (role_id)
                  REFERENCES DEFAULT_SCHEMA.lams_role (role_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_wkspc_wkspc_folder (
       id BIGINT(20) NOT NULL AUTO_INCREMENT
     , workspace_id BIGINT(20)
     , workspace_folder_id BIGINT(20)
     , PRIMARY KEY (id)
     ...
     , CONSTRAINT FK_lams_ww_folder_1 FOREIGN KEY (workspace_id)
                  REFERENCES DEFAULT_SCHEMA.lams_workspace (workspace_id)
)TYPE=InnoDB;

CREATE TABLE DEFAULT_SCHEMA.lams_learning_transition (
