...
insert into lams_configuration (config_key, config_value, description_key, header_name, format, required) 
values ('Version','2.1 RC1', 'config.version', 'config.header.system', 'STRING', 1);
...
insert into lams_configuration (config_key, config_value, description_key, header_name, format, required) 
values ('AuthoringClientVersion','2.0.100.@datetimestamp@', 'config.authoring.client.version', 'config.header.versions', 'STRING', 1);

insert into lams_configuration (config_key, config_value, description_key, header_name, format, required) 
values ('MonitorClientVersion','2.0.100.@datetimestamp@', 'config.monitor.client.version', 'config.header.versions', 'STRING', 1);

insert into lams_configuration (config_key, config_value, description_key, header_name, format, required) 
values ('LearnerClientVersion','2.0.100.@datetimestamp@', 'config.learner.client.version', 'config.header.versions', 'STRING', 1);

insert into lams_configuration (config_key, config_value, description_key, header_name, format, required) 
values ('ServerVersionNumber','2.0.100.@datetimestamp@', 'config.server.version.number', 'config.header.versions', 'STRING', 1);
...
insert into lams_configuration (config_key, config_value, description_key, header_name, format, required) 
values ('DictionaryDateCreated','2008-03-12', 'config.dictionary.date.created', 'config.header.versions', 'STRING', 1);
