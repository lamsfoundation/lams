...
function deSelectTab(tabId){
	...
	tl.src="author_page/images/"+themeName+"_tab_left.gif";
	tl.height = 22;
	var tr = document.getElementById("tab_right_"+tabId);
	tr.src="author_page/images/"+themeName+"_tab_right.gif";
	tr.height = 22;
...
function selectTab(tabId){
	//swap images of side parts
	var tl = document.getElementById("tab_left_"+tabId);
	tl.src="author_page/images/"+themeName+"_tab_s_left.gif";
	tl.height = 25;
	var tr = document.getElementById("tab_right_"+tabId);
	tr.src="author_page/images/"+themeName+"_tab_s_right.gif";
	tr.height = 25;
	//swap css of centre class
	var tc = document.getElementById("tab_tbl_centre_"+tabId);
