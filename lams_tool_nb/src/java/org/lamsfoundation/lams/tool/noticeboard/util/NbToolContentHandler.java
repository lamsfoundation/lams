...
public class NbToolContentHandler extends ToolContentHandler {
    ...
    private static String repositoryWorkspaceName = "nbworkspace";
    private static String repositoryUser = "noticeboard";
    private static char[] repositoryId = { 'l', 'a', 'm', 's', '-', 'n', 'b' };

    /**
     *
     */
    public NbToolContentHandler() {
	super();
    }
