...
public class AssessmentServiceProxy {
	...
	return (IAssessmentService) AssessmentServiceProxy.getAssessmentDomainService(servletContext);
    }

    public static final ToolSessionManager getSessionManager(ServletContext servletContext) {
	return (ToolSessionManager) AssessmentServiceProxy.getAssessmentDomainService(servletContext);
    }

    public static final ToolContentManager getContentManager(ServletContext servletContext) {
	return (ToolContentManager) AssessmentServiceProxy.getAssessmentDomainService(servletContext);
    }
