...
function drawActivityCompletionChart(data, animate){
	...
	chartPlaceholder.data('tooltip-input', [startedNotCompletedLearners, data.completedLearners, notStartedLearners]);
	...
	activityCompletionChart = new Chart(ctx, {
		...
		data : {
			...
			labels : [ LABELS.ACTIVITY_COMPLETION_CHART_STARTED_LEARNERS,
