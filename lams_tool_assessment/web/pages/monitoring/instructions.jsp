...
<table cellspacing="0">
	...
	<tr>
		<td colspan="3">
			...
			<div style="padding-left: 20px;">
				<c:out value="${assessment.onlineInstructions}" escapeXml="false" />
			</div>
		</td>
	</tr>
	
	<c:if test="${not empty assessment.onlineFileList}">
		<tr>
	...
	<c:forEach var="file" items="${assessment.onlineFileList}">
		<tr >
	...
	<tr>
		<td colspan="3">
			...
			<div style="padding-left: 20px;">
				<c:out value="${assessment.offlineInstructions}" escapeXml="false" />
			</div>
		</td>
	</tr>
	
	<c:if test="${not empty assessment.offlineFileList}">
		<tr>
			<td  colspan="3" class="field-name-alternative-color">
				<fmt:message key="monitoring.label.attachments" />
			</td>
	...
	<c:forEach var="file" items="${assessment.offlineFileList}">
		<tr >
			<td width="7%" style="padding-left: 30px;">			
				<c:out value="${file.fileName}" />
			</td>
