...
<lams:html>
	...
	<body>
		<html:form action="/learning/saveOrUpdateQuestion" method="post"
			styleId="assessmentQuestionForm" enctype="multipart/form-data">
			<html:hidden property="questionType" styleId="questionType" value="2" />
			...
			<div class="space-bottom-top">
				<a href="#"
					onclick="document.getElementById('assessmentQuestionForm').submit()"
