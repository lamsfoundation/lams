	...
	<div class="panel panel-default add-file">
		...
		<div class="panel-body">
			...
			<html:form action="/authoring/saveOrUpdateQuestion" method="post" styleId="assessmentQuestionForm">
				...
				<a data-toggle="collapse" data-target="#feedback" href="#feedback"><i class="fa fa-xs fa-plus-square-o roffset5" aria-hidden="true"></i><fmt:message key="label.authoring.basic.option.feedback"></fmt:message></a>
