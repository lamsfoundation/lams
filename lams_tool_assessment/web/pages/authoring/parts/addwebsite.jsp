...
<lams:html>
	<lams:head>
	   ...
	   <%-- user for  assessmentassessmentitem.js --%>
       ...
       var removeItemAttachmentUrl = "<c:url value='/authoring/removeItemAttachment.do'/>";
		...
		<script type="text/javascript"
			src="<html:rewrite page='/includes/javascript/assessmentassessmentitem.js'/>"></script>
	...
	<body class="tabpart">
		...
		<html:form action="/authoring/saveOrUpdateItem" method="post"
			styleId="assessmentItemForm" enctype="multipart/form-data">
		...
		<lams:ImgButtonWrapper>
			<a href="#" onclick="submitAssessmentItem()" class="button-add-item"><fmt:message
					key="label.authoring.basic.add.website" /> </a>
			<a href="javascript:;" onclick="cancelAssessmentItem()" class="button space-left"><fmt:message
					key="label.cancel" /> </a>
		</lams:ImgButtonWrapper>
		<br />
