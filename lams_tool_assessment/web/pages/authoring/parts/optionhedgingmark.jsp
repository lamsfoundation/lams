...
<div class="option-settings-hidden" style="display: none;">
	...
	<div class="voffset10-bottom" style="margin-top: 5px;">
		<input type="checkbox" name="optionCorrect" value="${option.displayOrder}" id="option-correct-${status.index}" 
	...
	<!--<div class="radio">
		<label for="option-correct-${status.index}">
			 <input type="radio" alt="${status.index}" name="optionCorrect" value="${option.displayOrder}" id="option-correct"
					<c:if test="${option.correct}">checked="checked"</c:if> > 
