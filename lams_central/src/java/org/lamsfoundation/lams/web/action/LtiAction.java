 ...
 * @author Andrey Balan
 *
 * @struts:action path="/lti" scope="request"
 *                parameter="method" validate="false"
 *
 * @struts:action-forward name="addLesson" path="/lti/addLesson.jsp"
 * @struts:action-forward name="learnerMonitor" path="/lti/learnerMonitor.jsp"
 * @struts:action-forward name ="learnerMonitorRedirect" path="/lti.do?method=learnerMonitor" redirect="true"
...
public class LtiAction extends LamsDispatchAction {
	...
	Lesson lesson = monitoringService.initializeLesson(title, desc, new Long(ldIdStr),
		organisation.getOrganisationId(), user.getUserId(), null, false, enableLessonIntro, false, false, false,
