...
public class AssessMCAnswer {
	...
	return new JSONObject().put("displayOrder", displayOrder).put("grade", grade).putOpt("correct", correct)
		.putOpt("acceptedError", acceptedError).putOpt("feedback", feedback).putOpt("answerText", answerText)
		.putOpt("answerFloat", answerFloat);
    }
