...
public class SurveyQuestion {
	...
	return new JSONObject().put("type", type).put(RestTags.QUESTION_TEXT, questionText)
		.put("allowOtherTextEntry", allowOtherTextEntry).put("required", required)
		.put(RestTags.ANSWERS, new JSONArray(answers.values()));
    }
