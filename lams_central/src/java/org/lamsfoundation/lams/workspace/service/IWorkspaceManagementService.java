...
public interface IWorkspaceManagementService {
     ...
     * 
     * <p>
     * <b>Note: </b>It only returns the top level contents. To navigate to
     * the contents of the sub-folders of the given <code>WorkspaceFolder</code>
     * we have to call this method again with there <code>workspaceFolderID</code>
     * </p>
     * 
     * <p>
     * <b>For Example:</b>
    ...
    /**
     * Returns Folder Contents in JSON format, restricted by designType (used for Integrations)
     * If folderID == null, returns the top level folders available to the user.
     * If folderID == -1, return only the learning designs in the root of the user's folder
     * Otherwise returns the learning designs and subfolders of the given folder.
     * Sample output:
     ...
     *            The <code>parent_folder_id</code> of the <code>WorkspaceFolder</code>
     ...
     * 
     * @param parentFolderID
     *            The parent_folder_id under which the new folder
     *            has to be created
     * @param name
     *            The name of the new folder
     * @param userID
     *            The user_id of the user for whom the folder is being created
     ...
     * 
     * @param resourceID
     *            The <code>id</code> to be deleted. May be a learning design id
     *            or a folder id.
     * @param resourceType
     ...
     * @throws IOException
     */
    String deleteResource(Long resourceID, String resourceType, Integer userID) throws IOException;
     ...
     *            The parent <code>WorkspaceFolder</code> under
     ...
     * @throws IOException
     */
    String copyResource(Long resourceID, String resourceType, Integer copyType, Integer targetFolderID, Integer userID)
	    throws IOException;
     ...
     * 
     * @param resourceID
     *            The <code>id</code> to be moved. May be a learning design id
     *            or a folder id.
     * @param resourceType
     *            The resource type sent to the client in the FolderContentDTO.
     * @param targetFolderID
     ...
     * 
     * @param contentTypeID
     *            The type of content being added.(FILE/PACKAGE)
     * @param name
     *            The name of the file
     * @param description
     *            The description of the file
     * @param workspaceFolderID
     *            The container(<code>workspaceFolder</code>)which
     *            holds this content
     * @param mimeType
     *            The MIME type of the file
     * @param path
     *            The physical location of the file from where it has to be read
     * @return String The acknowledgement/error message in WDDX format for the
     *         FLASH client.
     * @throws Exception
     */
    String createWorkspaceFolderContent(Integer contentTypeID, String name, String description,
     ...
     *            The <code>folder_content_id</code> of the file
     *            to be updated
     * @param path
     *            The physical location of the file from where it has to be read
     * @return String The acknowledgement/error message in WDDX format for FLASH
     ...
     * 
     * @param uuid
     *            The uuid of the <code>workspaceFolderContent</code>
     * @param versionToBeDeleted
     *            The versionID of the <code>workspaceFolderContent</code>
     * @param folderContentID
     *            The <code>folder_content_id</code> of the content to be deleted
     ...
     * 
     * @param userID
     *            The <code>user_id</code> of the user for whom the
     ...
     */
    String getOrganisationsByUserRole(Integer userID, List<String> roleNames, Integer courseId,
