...
* CanvasActivity - 
*/  
class org.lamsfoundation.lams.learner.LearnerActivity extends MovieClip {  
//class org.lamsfoundation.lams.authoring.cv.CanvasActivity extends MovieClip{  
			...
			if((now - _dcStartTime) <= Config.DOUBLE_CLICK_DELAY){
				//if (app.controlKeyPressed != "transition"){
					_doubleClicking = true;
						_lessonController.activityDoubleClick(this);
	...
	private function onRelease():Void{
		if(!_doubleClicking){
			Debugger.log('Releasing:'+this,Debugger.GEN,'onRelease','LearnerActivity');
				...
				_lessonController.activityRelease(this);
		}
	...
	private function onReleaseOutside():Void{
		...
		_lessonController.activityReleaseOutside(this);
	}
