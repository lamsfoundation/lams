...
*/
class LearnerOptionalActivity extends MovieClip implements ICanvasActivity
{
	...
	function LearnerOptionalActivity ()
	{
	...
	public function init () : Void
	{
		...
		for (var i = 0; i < _children.length; i ++)
		{
			...
			children_mc [i] = childHolder_mc.attachMovie("LearnerActivityVertical_forOptional", "LearnerActivityVertical_forOptional"+i, childHolder_mc.getNextHighestDepth(), {_activity:_children[i], _lessonController:_lessonController, _lessonView:_lessonView, learner:learner, actStatus:progStatus});
