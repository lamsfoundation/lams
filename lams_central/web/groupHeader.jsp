...
<c:if test="${not empty org.moreLinks}">
	...
	<div class="btn-group">
		<button type="button" class="btn btn-primary btn-sm dropdown-toggle ${addTourClass?'tour-more-options':''}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="<fmt:message key="index.moreActions" />"><i class="fa fa-fw fa-ellipsis-v"></i></button>
