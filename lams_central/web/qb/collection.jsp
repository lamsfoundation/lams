	...
	<lams:Page title="Collection" type="admin">
		...
		<div id="collection-name-row" class="row h4">
			...
			<div class=" col-xs-12 col-sm-8">
				<button onclick="javascript:showQuestionsPrintPage()" type="button"
						class="btn btn-default btn-xs loffset10 pull-right">
		...
		<c:if test="${(isAppadmin or (userId eq collection.userId)) and not collection.personal
