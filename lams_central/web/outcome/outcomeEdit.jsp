					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label><fmt:message key="outcome.manage.add.name" />:
								<form:text path="name" size="50" maxlength="255" cssClass="form-control" disabled="${formDisabled}" />
							</label>
						</div>
						<div class="form-group">
							<label><fmt:message key="outcome.manage.add.code" />:
								<form:text path="code" size="50" maxlength="50" cssClass="form-control" disabled="${formDisabled}" />
							</label>
						</div>
						<div class="form-group">
