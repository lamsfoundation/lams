...
<lams:html>
	...
	<body>
		...
		<a target="_top" href="importToolContent.do?method=importLC" class="button"><fmt:message key="button.select.another.importfile" /></a>
		&nbsp;<a href="javascript:closeWin();" class="button"><fmt:message key="button.close" /></a>
