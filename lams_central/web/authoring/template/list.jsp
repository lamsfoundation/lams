...
<tr><td><a href="${lams}authoring/template/tbl.do?method=init"><fmt:message key="authoring.tbl.template.title"/></a> - <fmt:message key="authoring.tbl.template.description"/></td></tr>
</table>
