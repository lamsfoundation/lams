				...
				<span class="field-name">
					<label for="sequenceTitle" class="input"><fmt:message key="authoring.label.sequence.title" /></label>
						...
						<div class="panel panel-default">
							<div class="panel-heading collapsable-icon-left" id="qb-collection-heading">
	        	<span class="panel-title">
			    	<a role="button" data-toggle="collapse" href="#qb-collection-collapse" class="collapsed"
					   aria-expanded="false" aria-controls="qb-collection-collapse">
