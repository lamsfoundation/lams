<%@ include file="/common/taglibs.jsp"%>
 ...
 <table id="lessons-table-${org.id}" class="lessons-table table cards <c:if test="${isUserMonitor}">user-monitor</c:if>" style="width:100%" 
 		data-orgid="${org.id}"
				...
				<div class="dropdown auxiliary-links-menu">
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						<c:forEach var="lessonlink" items="${lesson.auxiliaryLinks}">
							<a href="<c:out value='${lessonlink.url}'/>" style="padding-left: 10px; padding-right:10px;" class="dropdown-item"
