...
<table id="formulaButtonsTable">
	<tr>
		<th><fmt:message key="ckeditor.math.greek"/></th>
		<td>
	...
	<tr>
		<th><fmt:message key="ckeditor.math.uppercase"/></th>
		<td>
			<button onclick="javascript:insertFormula('\\Alpha ')"   title="Alpha">Α</button>
			<button onclick="javascript:insertFormula('\\Beta ')"    title="Beta">Β</button>
			<button onclick="javascript:insertFormula('\\Gamma ')" 	 title="Gamma">Γ</button>
	...
	<tr>
		<th><fmt:message key="ckeditor.math.misc"/></th>
		<td>
	...
	<tr>
		<th><fmt:message key="ckeditor.math.large"/></th>
		<td>
	...
	<tr>
		<th><fmt:message key="ckeditor.math.binary"/></th>
		<td>
	...
	<tr>
		<th><fmt:message key="ckeditor.math.relations"/></th>
		<td>
	...
	<tr>
		<th><fmt:message key="ckeditor.math.negatedrelations"/></th>
		<td>
	...
	<tr>
		<th><fmt:message key="ckeditor.math.arrows"/></th>
		<td>
	...
	<tr>
		<th><fmt:message key="ckeditor.math.combining"/></th>
		<td>
