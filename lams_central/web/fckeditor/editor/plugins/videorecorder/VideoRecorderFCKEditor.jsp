...
var languageXML = '';
 ...
 // Look for fckeditor
if(oEditor && typeof(oEditor.FCKVideoRecorder)!='undefined')
{
    FCKVideoRecorder = oEditor.FCKVideoRecorder;
...
function getLanguageXML(){
	...
	for(var i = 0; i < languageCollection.length; i++){
		...
		languageOutput += "<entry key='" + keyForXML + "'><name>" + FCKLang[key] + "</name></entry>";
	}
...
function saveToFCKEditor(eventObj) {
	...
	<!-- 
	innerHTML +=	'<OBJECT id="VideoRecorderFCKEditor"'
	innerHTML +=	'        width="361" height="331" >';
	innerHTML +=	'<param name="movie" value="' + FCKConfig.PluginsPath + 'videorecorder/VideoRecorderFCKEditor.swf" />';
	...
	innerHTML +=	'<embed src="' + FCKConfig.PluginsPath + 'videorecorder/VideoRecorderFCKEditor.swf" quality="high" bgcolor="#869ca7"';
	innerHTML +=	'width="361" height="331" name="VideoRecorderFCKEditor" align="middle"';
	innerHTML +=	'play="true"';
	...
	FCKVideoRecorder.Add(innerHTML);
	window.close();
}
</script>
<table>
		...
		<td>
			...
			<noscript>
			  	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
						...
						<embed src="VideoRecorderFCKEditor.swf" quality="high" bgcolor="#869ca7"
