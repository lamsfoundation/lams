...
// CKeditor_OnComplete is a special function that is called when an editor
// instance is loaded ad available to the API.
...
function doWYSWYGEdit(index, size){
    ...
    var oEditor;
    try {
        oEditor =  CKEDITOR.instances['FCKeditor1'] ;
    }
    catch(error) {
        //browsers like opera can't resolve the CKeditorAPI classes
    ...
    if (size == "small") {
        ...
        wyswygEditorScreenElement.style.height = "100px";
    } else {
