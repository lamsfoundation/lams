...
/** Before upgrading watch out for "customized by LAMS" notes **/
...
(function($) {
	$.fn.jRating = function(op) {
		var defaults = {
			/** String vars **/
			/** customized by LAMS **/
			bigStarsPath : pathToImageFolder + '/jquery.jRating-stars.png', // path of the icon stars.png. 
			/** customized by LAMS **/
			smallStarsPath : pathToImageFolder + '/jquery.jRating-small.png', // path of the icon small.png
