...
const getParameters = [
  ...
  },
  {
    ...
    checkVal: null,
    callback: (val) => {
      settings.LineNumbersDisabled = val == 'false';
    },
  },
  {
  ...
  socket.on('message', (obj) => {
    ...
    if (obj.accessStatus) {
      ...
      // If the LineNumbersDisabled value is set to true then we need to hide the Line Numbers
	    //*LAMS* modified the following line. As otherwise once stored cookie will affect all other pads ignoring showLineNumbers URL parameter
      pad.changeViewOption('showLineNumbers', settings.LineNumbersDisabled !== true);
