...
public class NodeFactory implements INodeFactory, BeanFactoryAware {
	...
	private SimpleVersionedNode copy( SimpleVersionedNode originalNode, CrNodeVersion parentNodeVersion ) throws FileException, ValueFormatException, InvalidParameterException {
		...
		if ( originalNode.isNodeType(NodeType.FILENODE) ) {
			...
			newNode.setFile(istream, 
				filenameProperty != null ? filenameProperty.getString() : null, 
	...
	/* (non-Javadoc)
	 * @see org.lamsfoundation.lams.contentrepository.service.INodeFactory#setNodeDAO(org.lamsfoundation.lams.contentrepository.dao.INodeDAO)
	 */
	...
	/* (non-Javadoc)
	 * @see org.lamsfoundation.lams.contentrepository.service.INodeFactory#setBeanFactory(org.springframework.beans.factory.BeanFactory)
	 */
