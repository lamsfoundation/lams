...
public class AddFileContentForm extends ActionForm {
	...
	if (isEmpty(method)) {
	    errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("errors.mandatory", "Method"));
	}

	if (isEmpty(description)) {
	    errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("errors.mandatory", "Description"));
	}
	if ("uploadFile".equals(method) && theFile == null) {
	    errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("errors.mandatory", "File"));
	}

	if ("uploadPackage".equals(method) && isEmpty(dirName)) {
	    errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("errors.mandatory", "Directory Name"));
	}
