...
public class LoginRepositoryAction extends RepositoryDispatchAction {
     ...
     */
    public ActionForward loginToWorkspace(ActionMapping mapping, ActionForm form, HttpServletRequest request,
     ...
     * @return ActionForward
     */
    public ActionForward createNewWorkspace(ActionMapping mapping, ActionForm form, HttpServletRequest request,
	    HttpServletResponse response) throws RepositoryCheckedException {
     ...
     */
    private ActionForward process(ActionMapping mapping, ActionForm form, HttpServletRequest request,
	    HttpServletResponse response, boolean createWorkspaceFirst) throws RepositoryCheckedException {
	...
	RepositoryDispatchAction.setTicket(request, ticket);
