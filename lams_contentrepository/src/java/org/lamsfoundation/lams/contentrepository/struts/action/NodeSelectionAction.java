...
public class NodeSelectionAction extends RepositoryDispatchAction {
     ...
     * @throws FileException
     */
    public ActionForward viewPackage(ActionMapping mapping, ActionForm form, HttpServletRequest request,
	    HttpServletResponse response) throws AccessDeniedException, ItemNotFoundException, FileException {
	...
	Long uuid = RepositoryDispatchAction.getLong(request.getParameter(UUID_NAME));
	Long version = RepositoryDispatchAction.getLong(request.getParameter(VERSION_NAME));
    ...
    public ActionForward deleteNode(ActionMapping mapping, ActionForm form, HttpServletRequest request,
	    ...
	    throws ItemNotFoundException, InvalidParameterException, AccessDeniedException, FileException {
	...
	try {
		...
		log.info("Deleted node, " + (problemFiles == null || problemFiles.length == 0 ? 0 : problemFiles.length)
     ...
     * @throws Exception
     */
    public ActionForward copyNode(ActionMapping mapping, ActionForm form, HttpServletRequest request,
	    HttpServletResponse response)
