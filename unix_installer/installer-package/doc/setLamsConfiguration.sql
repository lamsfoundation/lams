...
update lams_configuration set config_value='@LANG_VERSION@' where config_key='DictionaryDateCreated';
...
update lams_user set password=sha1('@LAMS_PASS@') where user_id>1;
