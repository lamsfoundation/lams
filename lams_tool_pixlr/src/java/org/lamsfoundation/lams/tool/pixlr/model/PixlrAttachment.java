 ...
 * 
 * @hibernate.class table="tl_lapixl10_attachment"
 * 
 */

public class PixlrAttachment implements java.io.Serializable, Cloneable {
    ...
    private static final Logger log = Logger.getLogger(PixlrAttachment.class);
    ...
    /** default constructor */
    public PixlrAttachment() {
    }

    /** Constructor setting up all the properties except for pixlr one */
    public PixlrAttachment(Long fileVersionId, String fileType, String fileName, Long fileUuid, Date createDate) {
     ...
     * @hibernate.column name="pixlr_uid"
     * 
     */
	...
	if (this == o)
	    return true;
	if (!(o instanceof PixlrAttachment))
	    return false;

	final PixlrAttachment genericEntity = (PixlrAttachment) o;
	...
	try {
	    obj = super.clone();
	    ((PixlrAttachment) obj).setUid(null);
	} catch (CloneNotSupportedException e) {
	    log.error("Failed to clone " + PixlrAttachment.class);
	}
