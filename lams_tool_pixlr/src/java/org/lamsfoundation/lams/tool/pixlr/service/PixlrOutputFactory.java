...
/**
 * Output factory for Pixlr tool. Currently it provides only one type of output - the entry that user provided.
 * 
 * @author lfoxton
 */
public class PixlrOutputFactory extends OutputFactory {
    ...
    public ToolOutput getToolOutput(String name, IPixlrService chatService, Long toolSessionId, Long learnerId) {
	return null;
    }
