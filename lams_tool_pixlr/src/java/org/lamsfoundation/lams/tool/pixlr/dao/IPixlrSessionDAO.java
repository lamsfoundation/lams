...
/**
 * DAO for accessing the PixlrSession objects - interface defining
 * methods to be implemented by the Hibernate or other implementation.
 */
public interface IPixlrSessionDAO extends IBaseDAO {

    void saveOrUpdate(PixlrSession session);

    PixlrSession getBySessionId(Long toolSessionId);
