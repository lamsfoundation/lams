...
public class PixlrServiceProxy {
	...
	return (IPixlrService) PixlrServiceProxy.getPixlrDomainService(servletContext);
    }

    private static Object getPixlrDomainService(ServletContext servletContext) {
	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(servletContext);
	return wac.getBean("pixlrService");
    }

    /*
     * Return the pixlr tool version of tool session manager implementation.
	...
	return (ToolSessionManager) PixlrServiceProxy.getPixlrDomainService(servletContext);
    }

    /*
     * Return the pixlr tool version of tool content manager implementation.
     * It will delegate to the Spring helper method to retrieve the proper
     * bean from Spring bean factory.
     * 
     * @param servletContext the servletContext for current application
	...
	return (ToolContentManager) PixlrServiceProxy.getPixlrDomainService(servletContext);
    }
