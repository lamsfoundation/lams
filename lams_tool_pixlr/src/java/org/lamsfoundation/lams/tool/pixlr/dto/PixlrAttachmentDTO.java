...
public class PixlrAttachmentDTO implements Comparable<Object> {
	...
	public PixlrAttachmentDTO(PixlrAttachment att) {
	...
	public int compareTo(Object o) {
		PixlrAttachmentDTO toAttachment = (PixlrAttachmentDTO) o;
		int returnValue = this.createDate.compareTo(((PixlrAttachmentDTO) o)
				.getCreateDate());
