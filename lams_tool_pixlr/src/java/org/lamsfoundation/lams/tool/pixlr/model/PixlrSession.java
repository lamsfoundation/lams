 ...
 * 
 * @hibernate.class table="tl_lapixl10_session"
 */
...
public class PixlrSession implements java.io.Serializable {
	...
	/** full constructor */
	public PixlrSession(Date sessionEndDate, Date sessionStartDate,
			Integer status, Long sessionId, String sessionName, Pixlr pixlr,
			Set<PixlrUser> pixlrUsers) {
	 ...
	 * @hibernate.collection-key column="pixlr_session_uid"
	 * @hibernate.collection-one-to-many class="org.lamsfoundation.lams.tool.pixlr.model.PixlrUser"
	 * 
	 */
