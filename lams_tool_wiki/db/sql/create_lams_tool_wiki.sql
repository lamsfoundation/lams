...
create table tl_lawiki10_session (uid bigint not null auto_increment, session_end_date datetime, session_start_date datetime, status integer, session_id bigint, session_name varchar(250), wiki_uid bigint, wiki_main_page_uid bigint, primary key (uid));
...
alter table tl_lawiki10_wiki_page add index FK961AFFEA3233D952 (added_by), add constraint FK961AFFEA3233D952 foreign key (added_by) references tl_lawiki10_user (uid);
