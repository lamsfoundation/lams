...
public class WikiAttachment implements java.io.Serializable, Cloneable {
    ...
    /** Constructor setting up all the properties except for wiki one */
    public WikiAttachment(Long fileVersionId, String fileType, String fileName, Long fileUuid, Date createDate) {
	...
	if (this == o)
	    return true;
	if (!(o instanceof WikiAttachment))
	    return false;

	final WikiAttachment genericEntity = (WikiAttachment) o;
