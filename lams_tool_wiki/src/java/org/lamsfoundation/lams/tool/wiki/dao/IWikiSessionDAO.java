...
/**
 * DAO for accessing the WikiSession objects - interface defining methods to be
 * implemented by the Hibernate or other implementation.
 */
public interface IWikiSessionDAO extends IBaseDAO {

    void saveOrUpdate(WikiSession session);

    WikiSession getBySessionId(Long toolSessionId);
