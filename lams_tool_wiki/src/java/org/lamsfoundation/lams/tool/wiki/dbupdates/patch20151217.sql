...
ALTER IGNORE TABLE tl_lawiki10_session DROP FOREIGN KEY FKF01D63C260B3B03B;
...
ALTER IGNORE TABLE tl_lawiki10_session DROP FOREIGN KEY FKF01D63C2A3FF7EC0;
...
ALTER IGNORE TABLE tl_lawiki10_user DROP FOREIGN KEY FKED5D7A1FD8004954;
...
ALTER IGNORE TABLE tl_lawiki10_wiki DROP FOREIGN KEY FKED5E3E04A3FF7EC0;
ALTER TABLE tl_lawiki10_wiki ADD CONSTRAINT FKED5E3E04A3FF7EC0 FOREIGN KEY (`wiki_main_page_uid`)
REFERENCES `tl_lawiki10_wiki_page` (`uid`) ON DELETE SET NULL ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_lawiki10_wiki_page DROP FOREIGN KEY wiki_page_fk_1;
ALTER TABLE tl_lawiki10_wiki_page ADD CONSTRAINT wiki_page_fk_1 FOREIGN KEY (`wiki_session_uid`)
REFERENCES `tl_lawiki10_session` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_lawiki10_wiki_page DROP FOREIGN KEY wiki_page_fk_2;
ALTER TABLE tl_lawiki10_wiki_page ADD CONSTRAINT wiki_page_fk_2 FOREIGN KEY (`wiki_uid`)
REFERENCES `tl_lawiki10_wiki` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_lawiki10_wiki_page DROP FOREIGN KEY wiki_page_fk_3;
...
ALTER IGNORE TABLE tl_lawiki10_wiki_page DROP FOREIGN KEY wiki_page_fk_4;
...
ALTER IGNORE TABLE tl_lawiki10_wiki_page_content DROP FOREIGN KEY FK528051242D44CCF8;
...
ALTER IGNORE TABLE tl_lawiki10_wiki_page_content DROP FOREIGN KEY FK528051243233D952;
