...
public class WikiAttachmentDTO implements Comparable {
    ...
    public WikiAttachmentDTO(WikiAttachment att) {
	...
	WikiAttachmentDTO toAttachment = (WikiAttachmentDTO) o;
	int returnValue = this.createDate.compareTo(((WikiAttachmentDTO) o).getCreateDate());
