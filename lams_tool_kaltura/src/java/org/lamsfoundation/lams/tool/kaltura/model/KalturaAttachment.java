 ...
 * 
 * @hibernate.class table="tl_lakalt11_attachment"
 * 
 */

public class KalturaAttachment implements java.io.Serializable, Cloneable {
    ...
    private static final Logger log = Logger.getLogger(KalturaAttachment.class);
    ...
    /** default constructor */
    public KalturaAttachment() {
    }

    /** Constructor setting up all the properties except for kaltura one */
    public KalturaAttachment(Long fileVersionId, String fileType, String fileName, Long fileUuid, Date createDate) {
	...
	if (this == o)
	    return true;
	if (!(o instanceof KalturaAttachment))
	    return false;

	final KalturaAttachment genericEntity = (KalturaAttachment) o;
	...
	return new EqualsBuilder().append(this.uid, genericEntity.uid)
		...
		.append(this.fileType, genericEntity.fileType).append(this.createDate, genericEntity.createDate)
		.isEquals();
    }
	...
	try {
	    obj = super.clone();
	    ((KalturaAttachment) obj).setUid(null);
	} catch (CloneNotSupportedException e) {
	    log.error("Failed to clone " + KalturaAttachment.class);
	}
