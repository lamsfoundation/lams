 ...
 */
public class KalturaToolContentHandler extends ToolContentHandler {
    ...
    public static String repositoryWorkspaceName = "kalturaworkspace";

    public static String repositoryUser = "kaltura";
     ...
     * 
     */
    public KalturaToolContentHandler() {
	super();
    }
