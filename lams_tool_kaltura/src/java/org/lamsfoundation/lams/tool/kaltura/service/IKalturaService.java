...
public interface IKalturaService {
     ...
     * @param toolSessionId
     * @param useId
     * @param isMonitoring if true show all items from the group regardless of hidden and isAllowSeeingOtherUsersRecordings parameters.
     * @return
     */
     ...
     * 
     * @param itemUid
     * @param isHiding true if item needs to be hidden, false - otherwise
     */
