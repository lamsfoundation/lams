...
<lams:html>
	...
	<body class="stripes" onload="init();">
		<lams:Page title='<fmt:message key="pageTitle.monitoring"/>' type="navbar">
			...
			<lams:Tabs control="true" title="${title}" helpToolSignature="<%= KalturaConstants.TOOL_SIGNATURE %>" helpModule="monitoring" refreshOnClickAction="javascript:location.reload();">
