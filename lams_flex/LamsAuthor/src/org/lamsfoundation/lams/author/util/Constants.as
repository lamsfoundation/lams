package org.lamsfoundation.lams.author.util
{
	public class Constants
	{
	    ...
	    public static const SYSTEM_ACTIVITY_TYPE_OPTIONAL:int = 1;
	    public static const SYSTEM_ACTIVITY_TYPE_OPTIONAL_SEQUENCE:int = 2;
	    public static const SYSTEM_ACTIVITY_TYPE_SUPPORT:int = 3;
	    public static const SYSTEM_ACTIVITY_TYPE_GATE:int = 4;
	    public static const SYSTEM_ACTIVITY_TYPE_BRANCH:int = 5;
	    public static const SYSTEM_ACTIVITY_TYPE_CONVERGE:int = 6;
	    public static const SYSTEM_ACTIVITY_TYPE_GROUP_RANDOM:int = 7;
	    public static const SYSTEM_ACTIVITY_TYPE_GROUP_MONITOR:int = 8;
	    public static const SYSTEM_ACTIVITY_TYPE_GROUP_LEARNER:int = 9;
