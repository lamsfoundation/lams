 ...
 * 
 *  THIS IS A MONKEY-PATCH HACK
 *  
 *  This file has been Monkey-Patched to override the animation 
 *  that occurs when you drop a draggable item.
 *  
 *  At runtime this class will override the Flex SDK version of
 *  DragProxy, it is identical to the 3.5.0 version of this class
 *  apart from the fact that it ovverides the drop animation
 *  
 */
