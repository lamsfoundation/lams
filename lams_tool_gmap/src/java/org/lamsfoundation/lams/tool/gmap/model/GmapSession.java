 ...
 *
 * @hibernate.class table="tl_lagmap10_session"
 */
...
public class GmapSession implements java.io.Serializable {
     ...
     * @hibernate.collection-key column="gmap_session_uid"
     * @hibernate.collection-one-to-many class="org.lamsfoundation.lams.tool.gmap.model.GmapUser"
     * 
     */
