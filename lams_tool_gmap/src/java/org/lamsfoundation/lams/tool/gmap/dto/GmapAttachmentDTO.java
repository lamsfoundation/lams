...
public class GmapAttachmentDTO implements Comparable {

	public GmapAttachmentDTO(GmapAttachment att) {
	...
	public int compareTo(Object o) {
		GmapAttachmentDTO toAttachment = (GmapAttachmentDTO) o;
		int returnValue = this.createDate.compareTo(((GmapAttachmentDTO) o)
				.getCreateDate());
