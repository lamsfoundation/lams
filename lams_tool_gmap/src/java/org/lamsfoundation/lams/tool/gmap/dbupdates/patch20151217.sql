...
ALTER IGNORE TABLE tl_lagmap10_marker DROP FOREIGN KEY FK10F22749529F7FD3;
...
ALTER IGNORE TABLE tl_lagmap10_marker DROP FOREIGN KEY FK10F2274974028C80;
...
ALTER IGNORE TABLE tl_lagmap10_marker DROP FOREIGN KEY FK10F22749C5F056D9;
...
ALTER IGNORE TABLE tl_lagmap10_marker DROP FOREIGN KEY FK10F22749EF5F6920;
ALTER TABLE tl_lagmap10_marker ADD CONSTRAINT FK10F22749EF5F6920 FOREIGN KEY (`updated_by`)
REFERENCES `tl_lagmap10_user` (`uid`) ON DELETE SET NULL ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_lagmap10_session DROP FOREIGN KEY FK519D516774028C80;
ALTER TABLE tl_lagmap10_session ADD CONSTRAINT FK519D516774028C80 FOREIGN KEY (`gmap_uid`)
REFERENCES `tl_lagmap10_gmap` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_lagmap10_user DROP FOREIGN KEY FK7CB3F69AC5F056D9;
