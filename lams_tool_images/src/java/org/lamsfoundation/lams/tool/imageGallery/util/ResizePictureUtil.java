...
public class ResizePictureUtil {
    ...
    /**
     * Reads the original image, creates a thumbnail and returns its input stream.
     * largestDimension is the largest dimension of the thumbnail, the other dimension is scaled accordingly. Utilises
	...
	try {
	    ...
	    ResizePictureUtil.log.error(e.getStackTrace());
	    return null;
	}
