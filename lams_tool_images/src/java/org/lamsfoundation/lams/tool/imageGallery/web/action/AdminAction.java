...
public class AdminAction extends Action {
	...
	if ((adminForm.getMediumImageDimensions() != null) && !adminForm.getMediumImageDimensions().equals("")) {
		...
		errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage(ImageGalleryConstants.ERROR_MSG_ENTERED_VALUES_NOT_INTEGERS));
	    }
	} else {
	    errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage(ImageGalleryConstants.ERROR_MSG_REQUIRED_FIELDS_MISSING));
	}
