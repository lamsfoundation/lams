...
ALTER IGNORE TABLE tl_laimag10_image_vote DROP FOREIGN KEY FK_tl_laimag10_image_vote_2;
...
ALTER IGNORE TABLE tl_laimag10_image_vote DROP FOREIGN KEY FK_tl_laimag10_image_vote_3;
...
ALTER IGNORE TABLE tl_laimag10_imagegallery_item DROP FOREIGN KEY FK_NEW_1821149711_F52D1F9330E79035;
...
ALTER IGNORE TABLE tl_laimag10_imagegallery_item DROP FOREIGN KEY FK_NEW_1821149711_F52D1F93758092FB;
ALTER TABLE tl_laimag10_imagegallery_item ADD CONSTRAINT FK_NEW_1821149711_F52D1F93758092FB FOREIGN KEY (`create_by`)
REFERENCES `tl_laimag10_user` (`uid`) ON DELETE SET NULL ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_laimag10_item_log DROP FOREIGN KEY FK_NEW_1821149711_693580A438BF8DFE;
ALTER TABLE tl_laimag10_item_log ADD CONSTRAINT FK_NEW_1821149711_693580A438BF8DFE FOREIGN KEY (`imageGallery_item_uid`)
REFERENCES `tl_laimag10_imagegallery_item` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER IGNORE TABLE tl_laimag10_item_log DROP FOREIGN KEY FK_NEW_1821149711_693580A441F9365D;
...
ALTER IGNORE TABLE tl_laimag10_session DROP FOREIGN KEY FK_NEW_1821149711_24AA78C530E79035;
ALTER TABLE tl_laimag10_session ADD CONSTRAINT FK_NEW_1821149711_24AA78C530E79035 FOREIGN KEY (`imageGallery_uid`)
REFERENCES `tl_laimag10_imagegallery` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_laimag10_user DROP FOREIGN KEY FK_NEW_1821149711_30113BFCEC0D3147;
...
ALTER IGNORE TABLE tl_laimag10_user DROP FOREIGN KEY FK_NEW_1821149711_30113BFC309ED320;
ALTER TABLE tl_laimag10_user ADD CONSTRAINT FK_NEW_1821149711_30113BFC309ED320 FOREIGN KEY (`imageGallery_uid`)
REFERENCES `tl_laimag10_imagegallery` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;
							  

ALTER IGNORE TABLE tl_laimag10_imagegallery DROP FOREIGN KEY FK_NEW_1821149711_89093BF758092FB;
