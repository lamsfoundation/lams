...
<body class="stripes">
	...
	<div id="content">
		...
		<table cellspacing="0" class="alternative-color">
			...
			<c:forEach var="item" items="${sessionMap.imageGalleryList}">
				<tr>
					<td>
			...
			<c:if test="${imageGallery.miniViewImageGalleryNumber > 0}">
				<tr>
					<td colspan="3" align="left">
						<b>${imageGallery.miniViewNumberStr}</b>
					</td>
				</tr>
			</c:if>
		</table>
		...
		<c:if test="${mode != 'teacher' && (not finishedLock)}">
			<c:if test="${imageGallery.allowAddFiles || imageGallery.allowAddUrls}">
				...
				<div class="small-space-top">
					<c:choose>
						<c:when test="${imageGallery.allowAddFiles && imageGallery.allowAddUrls}">
