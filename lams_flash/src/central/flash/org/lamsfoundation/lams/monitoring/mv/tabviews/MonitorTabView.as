    ...
    */
	...
	private function drawActivity(a:Activity, mm:MonitorModel):Boolean{
		...
		if(a.activityTypeID==Activity.TOOL_ACTIVITY_TYPE || a.isGroupActivity() ){
			...
			a.branchView = null;
			newActivity_mc = activityLayer.createChildAtDepth("CanvasBranchingActivity", DepthManager.kBottom, {_activity:a,_monitorController:mc, _monitorView:mtv, _module:"monitoring", learnerContainer:_learnerContainer_mc, setupBranchView:false});
		} else {
