...
ALTER IGNORE TABLE tl_lachat11_message DROP FOREIGN KEY FKCC08C1DC2AF61E05;
...
ALTER IGNORE TABLE tl_lachat11_message DROP FOREIGN KEY FKCC08C1DC9C8469FC;
...
ALTER IGNORE TABLE tl_lachat11_message DROP FOREIGN KEY FKCC08C1DCCF3BF9B6;
ALTER TABLE tl_lachat11_message ADD CONSTRAINT FKCC08C1DCCF3BF9B6 FOREIGN KEY (`from_user_uid`)
REFERENCES `tl_lachat11_user` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER IGNORE TABLE tl_lachat11_session DROP FOREIGN KEY FK96E446B1A3926E3;
...
ALTER IGNORE TABLE tl_lachat11_user DROP FOREIGN KEY FK4EB82169C8469FC;
