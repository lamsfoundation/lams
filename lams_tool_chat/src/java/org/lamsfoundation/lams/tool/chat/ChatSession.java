...
public class ChatSession  implements java.io.Serializable {
    ...
    /** full constructor */
    public ChatSession(Date sessionEndDate, Date sessionStartDate, Integer status, Long sessionId, String sessionName, Chat chat, Set chatUsers) {
     ...
     *             class="org.lamsfoundation.lams.tool.chat.ChatUser"
     *         
     */
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ChatSession) ) return false;
